package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener, IUpdateReceiver
   {
      ...
      private var var_1355:IRoomSession;
      ...
      private var var_1087:IAvatarRenderManager;
      ...
      private var var_263:ICatalogNavigator;
      
      private var var_114:Purse;
      ...
      private var var_232:ChargeConfirmationDialog;
      ...
      private var var_2904:Boolean = true;
      
      private var var_2121:Boolean = false;
      
      private var var_2906:GiftWrappingConfiguration;
      
      private var var_1356:ClubGiftController;
      
      private var var_586:ClubBuyController;
      
      private var var_717:ClubExtendController;
      
      private var var_901:Map;
      
      private var var_1354:Boolean = false;
      
      private var var_902:IPurchasableOffer;
      
      private var var_1648:IDragAndDropDoneReceiver;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1087)
         {
            this.var_1087.release(new IIDAvatarRenderManager());
            this.var_1087 = null;
         }
         if(this.var_161)
         {
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1929);
               return;
            }
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NOT_READY));
            _loc2_ = this.var_416.loadProductData(this);
            if(_loc2_)
            {
               this.init();
            }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         if(param1.priceInCredits > 0 && param1.priceInCredits > this.var_114.credits)
         {
            this.showNotEnoughCreditsAlert();
            return;
         }
         if(param1.priceInActivityPoints > 0 && param1.priceInActivityPoints > this.var_114.getActivityPointsForType(param1.activityPointType))
         {
         ...
         {
            this.var_586.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2903 = this.isNewItemsNotificationEnabled();
      ...
      private function sessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_416.loadProductData(this);
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1087 = param2 as IAvatarRenderManager;
      }
      
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this._roomEngine = param2 as IRoomEngine;
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_146,this.onObjectPlaced);
         this.initializeRoomPreviewer();
      }
      ...
      {
         if(this._roomEngine != null && this.var_161 != null && this.var_161.getKey("catalog.furniture.animation","false") == "true")
         {
            if(this.var_716 == null)
            {
               this.var_716 = new RoomPreviewer(this._roomEngine);
            }
         }
      }
      ...
      {
         return this.var_161.getBoolean("toolbar.new_additions.notification.enabled",false);
      }
      ...
      public function openCatalogPage(param1:String, param2:Boolean = false) : void
      {
         ...
         if(!this.var_761 || !this.var_263 || !this.var_263.isInitialized())
         {
            this.toggleCatalog(true);
            this.var_1092 = -1;
            this.var_903 = param1;
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_263.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_161.getKey("client.credits.embed.enabled","false") == "true";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = this.var_161.getKey("link.format.credits","/credits");
      ...
      {
         return this.var_416.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_416.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_62)
         {
            _loc3_ = this.var_416.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_901.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.creditbalance","balance",String(this.var_114.credits));
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_114.getActivityPointsForType(ActivityPointTypeEnum.PIXEL)));
         var _loc1_:int = 0;
         if(!this.var_114.hasClubLeft)
         {
            _loc2_ = "catalog.purse.club.join";
         }
         else
         {
            if(this.var_114.isVIP)
            {
            ...
            this._localization.registerParameter(_loc2_,"days",String(this.var_114.clubDays));
            this._localization.registerParameter(_loc2_,"months",String(this.var_114.clubPeriods));
         }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_263 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createMainWindow() : void
      {
         ...
         this._mainContainer = this._windowManager.buildFromXML(_loc1_.content as XML,const_720) as IWindowContainer;
         this._mainContainer.tags.push("habbo_catalog");
         this._mainContainer.position = this.const_2087;
         this.hideMainWindow();
         ...
         _loc3_.setParamFlag(WindowParam.const_289,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_71:
               this.var_2121 = param1.session.isPrivateRoom;
               this.var_1355 = param1.session;
               if(this.var_105 != null)
               {
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1356 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_586 == null)
         {
            this.var_586 = new ClubBuyController(this);
         }
      }
      ...
      private function createClubExtendController() : void
      {
         if(this.var_717 == null)
         {
            this.var_717 = new ClubExtendController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_1647 = (param1 as CatalogIndexMessageEvent).newAdditionsAvailable;
         this.var_263.buildCatalogIndex(_loc2_);
         if(this.var_903 && this.var_903 != "")
         {
            this.var_263.openPage(this.var_903);
            this.var_903 = "";
            this.var_1092 = -1;
         }
         else if(this.var_1092 > -1)
         {
            this.var_263.openPageById(this.var_1092,this.var_2120);
            this.var_1092 = -1;
            this.var_2120 = -1;
            this.var_903 = "";
         }
         else if(this.var_1647 && this.var_2903)
         {
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NEW_ITEMS_SHOW));
            this.var_263.loadNewAdditionsPage(this.getLocalizedPageName(CatalogPageName.const_1975));
         }
         else
         {
            this.var_263.loadFrontPage();
         }
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.var_114.credits = _loc3_.balance;
         this.updatePurse();
         if(!this.var_2905 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1206);
         }
         this.var_2905 = false;
         if(this.var_232 != null && !this.var_232.disposed)
         {
            this.var_232.refresh();
         }
         events.dispatchEvent(new PurseEvent(PurseEvent.const_132,this.var_114.credits));
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.var_114.activityPoints[_loc2_.type] = _loc2_.amount;
         this.updatePurse();
         if(!this.var_2904 && this._soundManager != null)
         {
         ...
         if(_loc2_.type == ActivityPointTypeEnum.const_909)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_347,_loc2_.amount));
         }
         events.dispatchEvent(new PurseUpdateEvent());
      }
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         this.var_114.activityPoints = _loc2_.points;
         this.updatePurse();
         ...
         if(_loc2_.points["null"] != null)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_347,_loc2_.points["null"]));
         }
         events.dispatchEvent(new PurseUpdateEvent());
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_114.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         this.var_114.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         this.var_114.isVIP = _loc2_.isVIP;
         this.var_114.pastClubDays = _loc2_.pastClubDays;
         this.var_114.pastVipDays = _loc2_.pastVipDays;
         this.var_114.isExpiring = _loc2_.responseType == ScrSendUserInfoMessageParser.const_1364 ? true : false;
         this.updatePurse();
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.RESPONSE_TYPE_PURCHASE)
         {
            this.reset();
            this.openCatalogPage(CatalogPageName.const_124,true);
         }
      }
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1356.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2906 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onHabboClubOffers(param1:HabboClubOffersMessageEvent) : void
      {
         if(this.var_586 != null)
         {
            this.var_586.onOffers(param1);
         }
      }
      
      private function onHabboClubExtendOffer(param1:HabboClubExtendOfferMessageEvent) : void
      {
         if(this.var_717 != null && this.var_161.getBoolean("club.membership.extend.promotion.enabled",false))
         {
            this.var_717.onOffer(param1);
         }
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_232 == null || this.var_232.disposed)
         {
            this.var_232 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_232.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_901.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_901.add(_loc2_.productCode,_loc3_.slice());
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            if(false && "true" == this.var_161.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = this.var_161.getKey("link.format.credits");
               if(_loc3_ != "")
               {
                  this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         if(param2.type == WindowEvent.const_167)
         {
            _loc3_ = this.var_161.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      {
         if(!this.var_161.keyExists("catalog.drag_and_drop") || this.var_161.getKey("catalog.drag_and_drop") != "true")
         {
            return false;
         }
         if(!this.var_1355 || !this.var_1355.isRoomOwner)
         {
            return false;
         }
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1354 && param1.type == RoomEngineObjectEvent.const_146)
         {
            this.resetPlacedOfferData(true);
            if(this.var_902 == null || this.var_902.disposed)
            {
               this.resetObjectMover();
               return;
            }
            _loc2_ = param1.category;
            _loc3_ = this.var_902.productContainer.firstProduct;
            _loc4_ = false;
            if(_loc2_ == RoomObjectCategoryEnum.const_25)
            {
            ...
            this.var_66 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_902);
            _loc5_ = this.var_1648;
            if(_loc5_ != null)
            {
            ...
            else if(_loc2_ == RoomObjectCategoryEnum.const_25)
            {
               switch(_loc3_.furnitureData.name)
               {
                  case "floor":
      ...
      public function resetPlacedOfferData(param1:Boolean = false) : void
      {
         ...
         if(this.var_66 != null)
         {
            if(this.var_66.category == RoomObjectCategoryEnum.const_26)
            {
               this._roomEngine.disposeObjectFurniture(this.var_66.roomId,this.var_66.roomCategory,this.var_66.objectId);
            }
            else if(this.var_66.category == RoomObjectCategoryEnum.const_25)
            {
            ...
            if(this.var_66.roomCategory == this._roomEngine.activeRoomCategory && this.var_66.roomId == this._roomEngine.activeRoomId)
            {
               ...
               switch(param1.category)
               {
                  ...
                  case FurniCategory.const_360:
                     _loc9_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_209);
      ...
      private function retrievePreviewAsset(param1:String, param2:Function) : void
      {
         ...
         var _loc3_:String = this.var_161.getKey("image.library.catalogue.url");
      ...
      public function update(param1:uint) : void
      {
         if(this.var_716 != null)
         {
            this.var_716.updatePreviewRoomView();
         }
      }
   }
}
