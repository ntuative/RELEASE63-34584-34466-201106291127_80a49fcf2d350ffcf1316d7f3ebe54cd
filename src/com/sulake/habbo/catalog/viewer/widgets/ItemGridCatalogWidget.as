package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      protected var var_511:IItemGridWindow;
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer, param2:ISessionDataManager)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_733,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_290,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_856,this.deActivateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_280,this.deActivateScrollbar);
         }
         this.var_33 = param2;
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_511 = _window.findChildByName("itemGrid") as IItemGridWindow;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc2_.productContainer.firstProduct.productType == ProductTypeEnum.const_62)
            {
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         if(_loc2_ > 0)
         {
            ...
            while(_loc3_ < 3)
            {
               if(this.var_848 >= 0 && this.var_848 < _loc2_)
               {
      ...
      {
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_2185) as IWindowContainer;
         this.var_511.addGridItem(_loc2_);
         ...
         if(param1.pricingModel == Offer.const_492)
         {
            ++this.var_1967;
