package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      public static const const_1732:int = -1;
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:ISessionDataManager)
      {
         ...
         this.var_416 = param5;
         this.var_416.events.addEventListener(BadgeImageReadyEvent.const_208,this.onBadgeImageReady);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_416.events.removeEventListener(BadgeImageReadyEvent.const_208,this.onBadgeImageReady);
            this.var_416 = null;
         }
      }
      ...
      public function updateBadge(param1:String, param2:Boolean, param3:int = 0) : void
      {
         ...
         if(param3 > 0)
         {
            this.var_1258.add(param1,param3);
         }
         ...
         else
         {
            ...
            _loc10_ = this.var_670.indexOf(param3) != -1;
            _loc11_ = new Badge(param1,_loc7_,_loc10_);
            _loc11_.iconImage = this.var_416.getBadgeImage(param1);
            if(_loc10_)
            {
               this.var_252.unshift(_loc11_);
            }
            else
            {
               this.var_252.push(_loc11_);
            }
            if(param2)
            {
      ...
      public function saveBadgeSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_357);
         var _loc3_:int = 0;
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         while(_loc2_ < this.var_252.length)
         {
            _loc3_ = this.var_252[_loc2_] as Badge;
            if(_loc3_ != null)
            {
      ...
      public function forceSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_593);
         ...
         var _loc3_:Array = this.getBadges(const_357);
      ...
      {
         return this.getItemInIndex(param1,const_357);
      }
      
      public function getBadgeFromInactive(param1:int) : Badge
      {
         return this.getItemInIndex(param1,const_593);
      }
      ...
      {
         if(param1 == InventoryCategory.const_228 && this.var_27.isVisible)
         {
      ...
      public function addUnseenBadges(param1:Array) : void
      {
         ...
         {
            if(this.var_670.indexOf(_loc2_) == -1)
            {
               this.var_670.push(_loc2_);
            }
         }
      }
      ...
      public function resetUnseenItems() : void
      {
         ...
         if(this.var_670 && this.var_670.length > 0)
         {
            _loc1_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_1181));
            this.var_670 = [];
