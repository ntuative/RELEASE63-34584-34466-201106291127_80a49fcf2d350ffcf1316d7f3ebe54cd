package com.sulake.habbo.quest
{
   ...
   public class Twinkle implements AnimationObject, IDisposable
   {
      ...
      private static const const_1052:Array = [1,2,3,4,5,6,5,4,3,2,1];
      
      private static const const_1466:int = -1;
      ...
      {
         return this.getFrame(param1) == const_1051;
      }
      
      public function getBitmap(param1:int) : BitmapData
      {
         var _loc2_:int = this.getFrame(param1);
         return this._twinkleImages.getImage(const_1052[_loc2_]);
      }
      
      private function getFrame(param1:int) : int
      {
         var _loc2_:int = param1 - this.var_2404;
         if(_loc2_ < 0)
         {
            return const_1466;
         }
         var _loc3_:int = Math.floor(_loc2_ / const_1467);
         if(_loc3_ >= const_1052.length)
         {
            return const_1051;
         }
         return _loc3_;
