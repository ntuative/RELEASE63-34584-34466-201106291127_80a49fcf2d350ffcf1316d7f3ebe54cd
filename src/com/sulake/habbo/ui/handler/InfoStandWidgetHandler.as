package com.sulake.habbo.ui.handler
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_246.events.addEventListener(NowPlayingEvent.const_102,this.onNowPlayingChanged);
            this.var_246.events.addEventListener(SongInfoReceivedEvent.const_97,this.onSongInfoReceivedEvent);
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_198,this.onUserTags);
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_208,this.onBadgeImage);
            }
            if(this._container.roomSessionManager != null)
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_195,this.onFigureUpdate);
               this._container.roomSessionManager.events.removeEventListener(RoomSessionPetInfoUpdateEvent.const_116,this.onPetInfo);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_198,this.onUserTags);
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_208,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_195,this.onFigureUpdate);
            this._container.roomSessionManager.events.addEventListener(RoomSessionPetInfoUpdateEvent.const_116,this.onPetInfo);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_733.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_733.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_246 != null)
         {
            this.var_246.events.removeEventListener(NowPlayingEvent.const_102,this.onNowPlayingChanged);
            this.var_246.events.removeEventListener(SongInfoReceivedEvent.const_97,this.onSongInfoReceivedEvent);
            this.var_246 = null;
         }
         this.var_1154 = true;
         this.container = null;
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_530);
         _loc1_.push(RoomWidgetRoomObjectMessage.const_890);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_973);
         _loc1_.push(RoomWidgetFurniActionMessage.const_248);
         _loc1_.push(RoomWidgetFurniActionMessage.const_738);
         _loc1_.push(RoomWidgetFurniActionMessage.const_734);
         _loc1_.push(RoomWidgetFurniActionMessage.const_783);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1198);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_835);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_743);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_820);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1926);
         _loc1_.push(RoomWidgetPetCommandMessage.const_672);
         _loc1_.push(RoomWidgetPetCommandMessage.const_814);
         _loc1_.push(RoomWidgetUserActionMessage.const_608);
         _loc1_.push(RoomWidgetUserActionMessage.const_275);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_1019);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_635)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_275 || param1.type == RoomWidgetUserActionMessage.const_608 || param1.type == RoomWidgetUserActionMessage.const_647)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_530:
               return this.handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetRoomObjectMessage.const_890:
            ...
            case RoomWidgetUserActionMessage.const_534:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1190,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_526:
               ...
               break;
            case RoomWidgetUserActionMessage.const_973:
            ...
            case RoomWidgetFurniActionMessage.const_1198:
               ...
               break;
            case RoomWidgetUserActionMessage.const_275:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_835:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_743:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_820:
            ...
            case RoomWidgetUserActionMessage.const_537:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_814:
            ...
            case RoomWidgetPetCommandMessage.const_672:
               ...
               break;
            case RoomWidgetChangeMottoMessage.const_1019:
      ...
      private function handleGetObjectNameMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_25:
               ...
               {
                  _loc11_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_268);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_25:
               ...
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_460) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_460);
               }
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_785) == 1)
               {
                  _loc6_.extraParam = RoomWidgetInfostandExtraParamEnum.const_1241;
               }
               ...
               {
                  _loc24_ = _loc8_.getNumber(RoomObjectVariableEnum.const_268);
                  if(param1.category == RoomObjectCategoryEnum.const_26)
                  {
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1196);
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1267);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_649)
                  {
                     _loc30_ = this.var_246.getRoomItemPlaylist();
                     if(_loc30_ != null)
                     {
                  ...
                  if(_loc26_ != -1)
                  {
                     _loc32_ = this.var_246.getSongInfo(_loc26_);
                     if(_loc32_ != null)
                     {
            ...
            case RoomObjectCategoryEnum.const_28:
               ...
               if(_loc12_.type == RoomObjectTypeEnum.const_219)
               {
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_592)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_345);
               }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_154)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_961);
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_769;
                  }
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_887;
                  }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1857);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_733.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_733.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               _loc14_ = this._container.roomEngine.getRoomObject(_loc11_,_loc12_,_loc13_.id,RoomObjectCategoryEnum.const_28);
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_961);
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_246 != null)
         {
            ...
            if(_loc2_ != -1)
            {
               _loc5_ = this.var_246.getSongInfo(_loc2_);
               if(_loc5_ != null)
               {
                  _loc3_ = _loc5_.name;
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_246 != null)
         {
            _loc2_ = this.var_246.getSongInfo(param1.id);
            if(_loc2_ != null)
            {
