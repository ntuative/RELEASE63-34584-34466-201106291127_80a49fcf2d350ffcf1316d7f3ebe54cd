package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1699:uint = 500;
      ...
      {
         this.var_1410 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1253,var_10);
         }
         return var_21;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_761 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_462,e);
         }
      }
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_18 = _field.text;
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_320,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_995,false,PropertyStruct.const_38,true) : PropertyDefaults.const_1760);
         _loc1_.push(this.var_1427 != PropertyDefaults.const_1396 ? new PropertyStruct(PropertyDefaults.const_843,this.var_1427,PropertyStruct.const_38,true) : PropertyDefaults.const_1844);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1258 ? new PropertyStruct(PropertyDefaults.const_875,_field.selectable,PropertyStruct.const_38,true) : PropertyDefaults.const_1875);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1187 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_38,true) : PropertyDefaults.const_2008);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_843:
                  this.var_1427 = _loc2_.value as Boolean;
                  if(this.var_1427)
                  {
               ...
               case PropertyDefaults.const_875:
                  ...
                  break;
               case PropertyDefaults.const_995:
