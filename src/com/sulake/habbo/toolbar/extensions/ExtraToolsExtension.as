package com.sulake.habbo.toolbar.extensions
{
   ...
   public class ExtraToolsExtension
   {
      ...
      private static const const_1458:uint = 16777215;
      
      private static const const_1460:uint = 12247545;
      
      private static const const_1459:String = "HELP";
      ...
      public function ExtraToolsExtension(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_420 = this._window.findChildByName("roominfo_region");
         ...
         for each(_loc8_ in _loc7_)
         {
            ...
            _loc8_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT,this.onMouseOut);
         }
         this.hideRoomInfo();
      }
      ...
      {
         this.var_64.removeListItem(this.var_420);
      }
      
      public function showRoomInfo() : void
      {
         this.var_64.addListItemAt(this.var_420,0);
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "logout_region":
               ...
               break;
            case "help_region":
               this._toolbar.toggleWindowVisibility(const_1459);
               break;
