package com.sulake.habbo.quest
{
   ...
   public class FriendlyTime
   {
      ...
      private static const const_1094:int = 60;
      
      private static const const_1093:int = 3600;
      
      private static const const_1592:int = 3 * const_1094;
      
      private static const const_1593:int = 3 * const_1093;
      ...
      {
         if(param2 > const_1593)
         {
            return getLocalization(param1,"friendlytime.hours",Math.round(param2 / const_1093));
         }
         if(param2 > const_1592)
         {
            return getLocalization(param1,"friendlytime.minutes",Math.round(param2 / const_1094));
         }
