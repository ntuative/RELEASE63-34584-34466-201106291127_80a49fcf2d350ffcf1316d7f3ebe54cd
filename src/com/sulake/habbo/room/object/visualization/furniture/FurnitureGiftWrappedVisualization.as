   ...
   public class FurnitureGiftWrappedVisualization extends FurnitureVisualization
   {
      ...
      private function updateTypes() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            {
               _loc3_ = 1000;
               _loc4_ = _loc2_.getString(RoomObjectVariableEnum.const_380);
               _loc5_ = parseInt(_loc4_);
               this.var_2367 = Math.floor(_loc5_ / _loc3_);
               this.var_2366 = _loc5_ % _loc3_;
            }
         }
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         var _loc6_:int = this.method_5(param1,param2);
