package com.sulake.habbo.quest
{
   ...
   public class QuestsList implements IDisposable
   {
      ...
      private static const const_1656:int = 5;
      
      private static const const_1654:int = 10;
      
      private static const const_1653:int = 10;
      
      private static const const_1655:int = 30;
      ...
      private var var_605:IScrollbarWindow;
      ...
      public function onToolbarClick() : void
      {
         ...
         {
            this.var_893 = new WindowToggle(this._window,this._window.desktop,this.requestQuests,this.close);
         }
         this.var_893.toggle();
         this.var_2087 = false;
      }
      ...
      private function refresh(param1:Boolean) : void
      {
         ...
         while(true)
         {
            if(_loc2_ < this.var_1622.length)
            {
               this.refreshEntry(true,_loc2_,this.var_1622[_loc2_],param1);
            }
            else
            {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_605 = IScrollbarWindow(this._window.findChildByName("scroller"));
         this._window.center();
         this.var_64.spacing = const_1654;
      }
      ...
      public function createListEntry() : IWindowContainer
      {
         ...
         _loc6_.x = _loc3_.width - _loc6_.width - const_1653;
         ...
         _loc3_.x = _loc2_.x + _loc2_.width + const_1656;
      ...
      public function setEntryHeight(param1:IWindowContainer) : void
      {
         ...
         _loc2_.findChildByName("completion_txt").y = _loc2_.height - const_1655;
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:QuestMessageData) : void
      {
         ...
         this.method_2(param1,"bg",param2.accepted,4290944315,4284769380);
         this.method_2(param1,"bg_top",param2.accepted,4294956936,4290427578);
         this.method_2(param1,"bg_bottom",param2.accepted,4294952792,4289440683);
      ...
      private function refreshEntryQuestDetails(param1:IWindowContainer, param2:QuestMessageData) : void
      {
         ...
         this.method_2(param1,null,param2.accepted,15982264,13158600);
         this.method_2(param1,"quest_header",param2.accepted,15577658,9276813);
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(_loc3_ && this.var_2087 && !this.var_2088)
            {
               this.var_2087 = false;
      ...
      private function method_2(param1:IWindowContainer, param2:String, param3:Boolean, param4:uint, param5:uint) : void
      {
      ...
      public function update(param1:uint) : void
      {
         ...
         this.var_1507 = NextQuestTimer.const_739;
         this.refresh(true);
      }
   }
}
