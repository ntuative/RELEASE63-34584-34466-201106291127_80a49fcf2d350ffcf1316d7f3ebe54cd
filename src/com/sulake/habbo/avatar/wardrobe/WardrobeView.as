package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements ISideContentView
   {
      ...
      public function WardrobeView(param1:WardrobeModel)
      {
         ...
         this.var_985 = this._window.findChildByName("hc_slots") as IItemListWindow;
         this.var_1216 = this._window.findChildByName("vip_slots") as IItemListWindow;
      ...
      public function update() : void
      {
         ...
         while(_loc3_ < _loc1_.length)
         {
            ...
            else if(this.var_1216)
            {
               this.var_1216.addListItem(_loc2_.view);
               _loc2_.view.visible = true;
            }
            _loc3_++;
         }
