package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      protected function getAnimationId(param1:AnimationStateData) : int
      {
         ...
         if(_loc2_ != const_1265 && this._animationData.hasAnimation(this.var_459,_loc2_))
         {
            return _loc2_;
         }
         return const_1265;
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            if(_loc4_ != this._state)
            {
               ...
               if(_loc5_ != null)
               {
                  _loc6_ = _loc5_.getNumber(RoomObjectVariableEnum.const_732);
                  this.var_1877 = _loc6_;
               }
            }
            return true;
         }
         ...
         if(super.updateModel(param1))
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc5_ = _loc3_.getNumber(RoomObjectVariableEnum.const_732);
                  ...
                  _loc4_ = _loc3_.getNumber(RoomObjectVariableEnum.const_915);
                  if(!isNaN(_loc4_))
                  {
      ...
      protected function resetAllAnimationFrames() : void
      {
         if(this.var_130 != null)
         {
            this.var_130.setLayerCount(this.var_726);
         }
      }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         {
            this.var_459 = param1;
            this.var_726 = this._animationData.getLayerCount(param1);
      ...
      {
         var _loc2_:int = 0;
         if(!this.var_130.animationOver || this.var_1006)
         {
      ...
      protected function updateFramesForAnimation(param1:AnimationStateData, param2:Number) : int
      {
         ...
         var _loc11_:* = null;
         var _loc12_:int = 0;
         if(param1.animationOver && !this.var_1006)
         {
            return 0;
         }
         ...
         var _loc7_:* = 1 << this.var_726 - 1;
         var _loc8_:int = this.var_726 - 1;
         while(_loc8_ >= 0)
         {
            _loc9_ = param1.method_11(_loc8_);
            if(!_loc9_ || this.var_1006)
            {
               ...
               if(this.var_1006 || _loc11_ == null || _loc11_.remainingFrameRepeats >= 0 && _loc13_ <= 0)
               {
                  _loc12_ = 0;
                  if(_loc11_ != null)
                  {
                  ...
                  if(_loc12_ == AnimationFrame.const_1189)
                  {
