   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_245)
         {
            ...
            {
               _loc1_ = this.var_245.getKey(0) as String;
               _loc2_ = this.var_245.remove(_loc1_) as RoomSession;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         {
            _loc3_ = 0;
            while(_loc3_ < this.var_84.length)
            {
               _loc4_ = this.var_84[_loc3_] as IDisposable;
               if(_loc4_)
               {
                  _loc4_.dispose();
               }
      ...
      private function createHandlers() : void
      {
         ...
         this.var_84.push(new RoomSessionHandler(this._connection,this));
         this.var_84.push(new RoomChatHandler(this._connection,this));
         this.var_84.push(new RoomUsersHandler(this._connection,this));
         this.var_84.push(new RoomPermissionsHandler(this._connection,this));
         this.var_84.push(new AvatarEffectsHandler(this._connection,this));
         this.var_84.push(new RoomDataHandler(this._connection,this));
         this.var_84.push(new PresentHandler(this._connection,this));
         this.var_84.push(new PlaceObjectErrorHandler(this._connection,this));
         this.var_84.push(new TeleportErrorHandler(this._connection,this));
         this.var_84.push(new GenericErrorHandler(this._connection,this));
         this.var_84.push(new PollHandler(this._connection,this));
         this.var_84.push(new VoteHandler(this._connection,this));
         this.var_84.push(new LidoHandler(this._connection,this));
         this.var_84.push(new RoomDimmerPresetsHandler(this._connection,this));
         this.var_84.push(new ViralFurniHandler(this._connection,this));
         this.var_84.push(new UserNotificationHandler(this._connection,this));
         this.var_84.push(new PetPackageHandler(this._connection,this));
      }
      ...
      private function initializeManager() : void
      {
         ...
         if(this.initialized && this.var_1863)
         {
            this.gotoRoom(this.var_2550,this.var_2551,this.var_1862);
            this.var_1863 = false;
            this.var_1862 = "";
         }
      }
      ...
      public function gotoRoom(param1:Boolean, param2:int, param3:String = "", param4:String = "") : Boolean
      {
         ...
         this.var_1497 = true;
         if(this.var_245.getValue(_loc6_) != null)
         {
         ...
         this.var_245.add(_loc6_,_loc7_);
         events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_260,_loc7_));
         return true;
      }
      ...
      public function sessionReinitialize(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         var _loc6_:RoomSession = this.var_245.remove(_loc5_) as RoomSession;
         if(_loc6_ != null)
         {
            param4 = param2;
            _loc6_.reset(param3,param4);
            _loc5_ = this.getRoomIdentifier(param3,param4);
            _loc7_ = this.var_245.remove(_loc5_);
            if(_loc7_ != null)
            {
            }
            this.var_245.add(_loc5_,_loc6_);
      ...
      public function getSession(param1:int, param2:int) : IRoomSession
      {
         ...
         return this.var_245.getValue(_loc3_) as IRoomSession;
      }
      
      public function disposeSession(param1:int, param2:int) : void
      {
         var _loc3_:String = this.getRoomIdentifier(param1,param2);
         var _loc4_:RoomSession = this.var_245.remove(_loc3_) as RoomSession;
         if(_loc4_ != null)
         {
      ...
      private function updateHandlers(param1:IRoomSession) : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(param1 != null && this.var_84 != null)
         {
            _loc2_ = 0;
            while(_loc2_ < this.var_84.length)
            {
               _loc3_ = this.var_84[_loc2_] as BaseHandler;
               if(_loc3_ != null)
               {
