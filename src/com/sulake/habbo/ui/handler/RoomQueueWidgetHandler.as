package com.sulake.habbo.ui.handler
{
   ...
   public class RoomQueueWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetRoomQueueMessage.const_809);
         _loc1_.push(RoomWidgetRoomQueueMessage.const_917);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomQueueMessage.CHANGE_TO_SPECTATOR_QUEUE:
               ...
               break;
            case RoomWidgetRoomQueueMessage.const_809:
               this._container.roomSession.changeQueue(RoomSessionQueueEvent.const_1261);
               break;
            case RoomWidgetRoomQueueMessage.const_917:
               if(this._container.catalog != null)
               {
                  this._container.catalog.openCatalogPage(CatalogPageName.const_124,true);
               }
         }
         return null;
      }
      ...
      {
         return [RoomSessionQueueEvent.const_668];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionQueueEvent.const_668:
               ...
               {
                  case RoomSessionQueueEvent.const_1261:
                     _loc3_ = "null";
                     break;
               ...
               if(_loc5_.length > 1)
               {
                  if(_loc4_ && _loc2_.queueTypes.indexOf(RoomSessionQueueEvent.const_1173) != -1)
                  {
                     _loc6_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_1173) + 1;
                     _loc7_ = true;
                  }
                  else
                  {
                     _loc6_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_1880) + 1;
                  }
               }
               else
               {
