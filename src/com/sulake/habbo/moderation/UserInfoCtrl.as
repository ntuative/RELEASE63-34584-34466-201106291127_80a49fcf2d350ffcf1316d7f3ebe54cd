package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_1145:int = 60;
      
      private static const const_1146:int = 3600;
      
      private static const const_1144:int = 86400;
      
      private static const const_1143:int = 31536000;
      ...
      {
         if(param1 < 2 * const_1145)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_1146)
         {
            return Math.round(param1 / const_1145) + " mins ago";
         }
         if(param1 < 2 * const_1144)
         {
            return Math.round(param1 / const_1146) + " hours ago";
         }
         if(param1 < 2 * const_1143)
         {
            return Math.round(param1 / const_1144) + " days ago";
         }
         return Math.round(param1 / const_1143) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1372.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_35.getXmlWindow("user_info"));
            this.var_1372.addChild(_loc1_);
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_35,WindowTracker.const_1216,this._data.userId),this._callerFrame,this.var_1373,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new RoomVisitsCtrl(this.var_35,this._data.userId),this._callerFrame,this.var_1373,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new SendMsgsCtrl(this.var_35,this._data.userId,this._data.userName,this.var_1685),this._callerFrame,this.var_1373,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ModActionCtrl(this.var_35,this._data.userId,this._data.userName,this.var_1685),this._callerFrame,this.var_1373,false,true);
      }
