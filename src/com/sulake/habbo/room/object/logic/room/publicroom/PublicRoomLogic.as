package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectRoomAdEvent.const_211,RoomObjectRoomAdEvent.const_356,RoomObjectRoomAdEvent.const_350];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_447,"");
         _loc2_.setString(RoomObjectVariableEnum.const_908,"");
         _loc2_.setNumber(RoomObjectVariableEnum.const_539,Number(false));
         this.var_761 = true;
      }
      ...
      {
         super.update(param1);
         if(this.var_1666 > 0 && param1 > this.var_1666)
         {
            this.adDelayTimeout();
            this.var_1666 = 0;
         }
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_1227:
                  _loc2_.setString(RoomObjectVariableEnum.const_447,_loc3_.asset);
                  _loc2_.setString(RoomObjectVariableEnum.const_908,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_539,Number(true));
                  this.var_1666 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_1326);
            }
         }
      }
      ...
      public function adDelayTimeout() : void
      {
         ...
         _loc1_.setNumber(RoomObjectVariableEnum.const_539,Number(false));
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_658)
               {
                  _loc7_ = _loc4_.getString(RoomObjectVariableEnum.const_908);
