package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1226:String = "AssetLibraryReady";
      
      public static const const_770:String = "AssetLibraryLoaded";
      
      public static const const_2027:String = "AssetLibraryUnloaded";
      
      public static const const_1927:String = "AssetLibraryLoadError";
      
      private static const const_687:String = "name";
      
      private static const const_1128:String = "asset";
      ...
      private static var var_352:Dictionary;
      
      private static var var_2081:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_584:uint = 0;
      
      private static var var_1079:Array = new Array();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         this.var_583 = new Dictionary(false);
         this.var_1082 = new Dictionary(false);
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_704 + " doesn\'t contain valid resource class!");
         }
         var _loc5_:XMLList = param2.child(const_1129);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1128);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_704 + "!");
               }
               _loc15_++;
            }
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_1079.splice(var_1079.indexOf(this),1);
            --var_584;
            this.var_583 = null;
            this.var_1082 = null;
            this.var_184 = null;
      ...
      {
         if(this.var_704 == param1.url && this.var_1081)
         {
            if(!this.var_1080 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_705);
            }
            this.var_1080 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1226));
         }
         else
         {
      ...
      public function unload() : void
      {
         ...
         this.var_1081 = false;
         this.var_704 = null;
         dispatchEvent(new Event(AssetLibrary.const_2027));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_1082[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_583[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1384,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1167,this.assetLoadEventHandler);
         ...
         this.var_583[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_583[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_489;
                     this.var_491.push(struct.assetName);
                  }
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_583[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         return param1 < this.var_491.length ? this.getAssetByName(this.var_491[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_184)
         {
            ...
            {
               return this.var_491.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_184[param1] != null || (this.var_705 != null ? this.var_705[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_2081.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_184)
            {
               if(this.var_184[_loc2_] == param1)
               {
                  this.var_491.splice(this.var_491.indexOf(_loc2_),1);
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_352.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_352[param1.mimeType] = param1;
         }
         else
         {
            if(this.var_490.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_490[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_352[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
         }
         return AssetTypeDeclaration(this.var_490[param1]);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_352)
            {
               _loc3_ = AssetTypeDeclaration(var_352[_loc4_]);
               if(_loc3_ != null)
               {
         ...
         for(_loc4_ in this.var_490)
         {
            _loc3_ = AssetTypeDeclaration(this.var_490[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_352)
            {
               _loc4_ = AssetTypeDeclaration(var_352[_loc5_]);
               if(_loc4_ != null)
               {
         ...
         for(_loc5_ in this.var_490)
         {
            _loc4_ = AssetTypeDeclaration(this.var_490[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_705 = _loc2_.resource;
         this.var_704 = _loc2_.url;
         if(this.var_1080)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_705);
         }
         this.var_1081 = true;
         dispatchEvent(new Event(AssetLibrary.const_770));
         dispatchEvent(new Event(AssetLibrary.const_1226));
         if(this.var_1080)
         {
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1129);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1128);
            if(_loc2_ != null)
            {
               _loc5_ = null;
               ...
               while(_loc8_ < _loc7_)
               {
                  ...
                  if(_loc3_.attribute(const_687) && _loc3_.attribute(const_687).toString() == param1)
                  {
                     _loc4_ = this.getAssetTypeDeclarationByMimeType(_loc3_.attribute(TYPE));
                     if(_loc4_ == null)
                     {
                        throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_704 + "!");
                     }
                     _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                     _loc5_.setUnknownContent(this.var_705[param1]);
