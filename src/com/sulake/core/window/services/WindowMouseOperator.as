package com.sulake.core.window.services
{
   ...
   public class WindowMouseOperator implements IDisposable
   {
      ...
      protected var var_753:Point;
      
      protected var var_1538:uint;
      ...
      public function begin(param1:IWindow, param2:uint = 0) : IWindow
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            this._window.addEventListener(WindowEvent.const_361,this.clientWindowDestroyed);
            this._working = true;
         }
         return _loc3_;
      }
      ...
      public function end(param1:IWindow) : IWindow
      {
         ...
         if(this._working)
         {
            if(this._window == param1)
            {
               ...
               {
                  this._window.removeEventListener(WindowEvent.const_361,this.clientWindowDestroyed);
               }
               this._window = null;
               this._working = false;
            }
      ...
      public function operate(param1:int, param2:int) : void
      {
         ...
         this.getMousePositionRelativeTo(this._window,this._mouse,this.var_753);
         this._window.offset(this.var_753.x - this._offset.x,this.var_753.y - this._offset.y);
      }
