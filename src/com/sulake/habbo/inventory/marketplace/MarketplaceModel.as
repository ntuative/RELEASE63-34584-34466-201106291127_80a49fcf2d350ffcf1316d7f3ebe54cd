package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      {
         if(this.var_27 != null && this.var_27.furniModel != null && this.var_262 != null)
         {
            this.var_27.furniModel.removeLockFrom(this.var_262.id);
            this.var_262 = null;
         }
      }
      ...
      public function makeOffer(param1:int) : void
      {
         ...
         var _loc3_:int = this.var_262 is FloorItem ? 1 : 2;
         _loc2_.send(new MakeOfferMessageComposer(param1,_loc3_,this.var_262.ref));
         this.releaseItem();
      }
      ...
      public function getItemStats() : void
      {
         ...
         var _loc2_:int = this.var_262 is FloorItem ? 1 : 2;
         this.var_2387 = _loc2_;
         this.var_2379 = this.var_262.type;
         _loc1_.send(new GetMarketplaceItemStatsComposer(_loc2_,this.var_262.type));
      }
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         {
            case 1:
               this._view.showMakeOffer(this.var_262);
               break;
            case 2:
            ...
            case 3:
               ...
               break;
            case 4:
               this._view.showBuyTokens(this.var_1809,this.var_1808);
         }
      }
      ...
      {
         if(param1 != this.var_2387 || param2 != this.var_2379)
         {
            return;
         }
         if(!this._view)
         ...
         this._view.updateAveragePrice(param3,this.var_2382);
      }
