package com.sulake.habbo.room
{
   ...
   public class RoomObjectEventHandler implements IRoomRenderingCanvasMouseListener
   {
      ...
      private function resetSelectedObjectData(param1:int, param2:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(_loc3_.operation == RoomObjectOperationEnum.OBJECT_MOVE)
            {
               ...
               if(_loc3_.category == RoomObjectCategoryEnum.const_25)
               {
      ...
      public function setSelectedObject(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         switch(param4)
         {
            ...
            case RoomObjectCategoryEnum.const_25:
               ...
               _loc5_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_969,param1,param2,param3,param4));
         }
      }
      ...
      public function handleRoomObjectEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectStateChangeEvent.const_66:
               ...
               break;
            case RoomObjectStateChangeEvent.const_791:
            ...
            case RoomObjectMoveEvent.const_403:
               ...
               break;
            case RoomObjectMoveEvent.const_968:
            ...
            case RoomObjectFurnitureActionEvent.const_638:
            ...
            case RoomObjectFurnitureActionEvent.const_559:
      ...
      private function handleRoomObjectMouseEvent(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         switch(param1.type)
         {
            case RoomObjectMouseEvent.const_159:
               this.handleRoomObjectMouseClick(param1,param2,param3);
               break;
            case RoomObjectMouseEvent.const_641:
               this.handleRoomObjectMouseMove(param1,param2,param3);
               break;
            case RoomObjectMouseEvent.const_525:
            ...
            case RoomObjectMouseEvent.const_196:
               ...
               break;
            case RoomObjectMouseEvent.const_187:
      ...
      private function handleRoomObjectMouseClick(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         switch(_loc4_)
         {
            ...
            case RoomObjectOperationEnum.OBJECT_UNDEFINED:
               ...
               else
               {
                  ...
                  else if(_loc8_ == RoomObjectCategoryEnum.const_26 || _loc8_ == RoomObjectCategoryEnum.const_25)
                  {
                     if(param1.ctrlKey || param1.shiftKey)
                     {
                        if(param1.shiftKey)
                        {
                           if(_loc8_ == RoomObjectCategoryEnum.const_26)
                           {
         ...
         if(_loc8_ == RoomObjectCategoryEnum.const_85)
         {
            ...
            _loc16_ = this.getMouseEventId(RoomObjectCategoryEnum.const_28,MouseEvent.CLICK);
            if(_loc15_ != _loc10_ && _loc16_ != _loc10_)
            {
               _loc17_ = this._roomEngine.events;
               if(_loc17_ != null)
               {
                  _loc17_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_511,param2,param3,-1,RoomObjectCategoryEnum.const_153));
               }
      ...
      private function handleRoomObjectMouseLeave(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_187,param2,param3,param1.objectId,this._roomEngine.getRoomObjectCategory(param1.objectType)));
         }
      }
      ...
      private function handleRoomObjectMouseDown(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         {
            case RoomObjectOperationEnum.OBJECT_UNDEFINED:
               if(_loc8_ == RoomObjectCategoryEnum.const_26 || _loc8_ == RoomObjectCategoryEnum.const_25)
               {
                  if(param1.altKey)
                  {
                     ...
                     if(_loc10_ != null)
                     {
                        _loc10_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_750,param2,param3,_loc6_,_loc8_));
                     }
                  }
               }
         }
      ...
      private function handleObjectMove(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         {
            _loc7_ = true;
            if(_loc5_.category == RoomObjectCategoryEnum.const_26)
            {
      ...
      private function handleObjectPlace(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         if(_loc6_ == null)
         {
            if(_loc5_.category == RoomObjectCategoryEnum.const_26 && _loc7_ != null)
            {
            ...
            else if(_loc5_.category == RoomObjectCategoryEnum.const_28 && _loc7_ != null)
            {
            ...
            if(_loc6_ != null)
            {
               if(_loc5_.category == RoomObjectCategoryEnum.const_26)
               {
                  ...
                  {
                     _loc9_ = _loc6_.getModel().getNumberArray(RoomObjectVariableEnum.const_745);
      ...
      private function handleObjectSoundMachineEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomObjectFurnitureActionEvent.const_576:
               ...
               break;
            case RoomObjectFurnitureActionEvent.const_545:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_1025,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_605:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_853,param2,param3,param1.objectId,_loc4_));
         }
      }
      ...
      private function handleObjectJukeboxEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         {
            case RoomObjectFurnitureActionEvent.const_560:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_967,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_559:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_1876,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_628:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_1928,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_519:
      ...
      private function validateFurnitureDirection(param1:IRoomObject, param2:IVector3d, param3:TileHeightMap) : Boolean
      {
         ...
         var _loc6_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_304);
      ...
      private function validateFurnitureLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:TileHeightMap) : Vector3d
      {
         ...
         var _loc7_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_304);
         var _loc8_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_326);
         if(_loc7_ < 1)
         {
            _loc7_ = 1;
         }
      ...
      private function validateWallItemLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Number, param6:Number, param7:SelectedRoomObjectData) : Vector3d
      {
         ...
         var _loc8_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_304);
         var _loc9_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_588);
         var _loc10_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_811);
      ...
      public function setSelectedAvatar(param1:int, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var category:int = 0;
         var object:IRoomObjectController = this._roomEngine.getRoomObject(roomId,roomCategory,this.var_1676,category) as IRoomObjectController;
      ...
      private function getValidFurnitureDirection(param1:IRoomObjectController, param2:Boolean) : int
      {
         ...
         {
            _loc3_ = param1.getModel().getNumberArray(RoomObjectVariableEnum.const_745);
         }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:int, param4:int, param5:String) : Boolean
      {
         ...
         switch(param5)
         {
            ...
            case RoomObjectOperationEnum.OBJECT_MOVE_TO:
               ...
               if(this._roomEngine.connection)
               {
                  if(param4 == RoomObjectCategoryEnum.const_26)
                  {
                  ...
                  else if(param4 == RoomObjectCategoryEnum.const_25)
                  {
                     ...
                     if(this._roomEngine.connection && _loc11_)
                     {
                        ...
                        if(_loc12_ != null)
                        {
                           this._roomEngine.connection.send(new MoveWallItemMessageComposer(param3,RoomObjectCategoryEnum.const_25,_loc12_));
                        }
                     }
                  }
               }
      ...
      private function placeObject(param1:int, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(this._roomEngine != null && this._roomEngine.connection != null)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc7_ == RoomObjectCategoryEnum.const_26 || _loc7_ == RoomObjectCategoryEnum.const_28)
               {
               ...
               if(_loc7_ == RoomObjectCategoryEnum.const_28 && _loc5_.typeId == RoomObjectTypeEnum.const_219)
               {
                  this._roomEngine.connection.send(new PlacePetMessageComposer(_loc6_,int(_loc10_),int(_loc11_)));
               }
               else if(_loc8_.getModelController().getString(RoomObjectVariableEnum.const_1233) != null)
               {
         ...
         if(this._roomEngine && this._roomEngine.events)
         {
            ...
            this._roomEngine.events.dispatchEvent(new RoomEngineObjectPlacedEvent(RoomEngineObjectEvent.const_146,param1,param2,_loc6_,_loc7_,_loc9_,_loc10_,_loc11_,_loc12_,_loc13_,_loc17_,param3,param4,_loc5_.instanceData));
         }
      }
