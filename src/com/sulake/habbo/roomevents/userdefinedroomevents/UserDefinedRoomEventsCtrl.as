package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      public static var var_354:int = 3;
      
      private static var var_1496:int = 2;
      ...
      private var var_1859:TriggerConfs;
      
      private var var_1860:ActionTypes;
      
      private var var_1861:ConditionTypes;
      
      private var var_278:Dictionary;
      
      private var var_37:Triggerable;
      
      private var var_799:RoomObjectHightLighter;
      
      private var var_206:UserDefinedRoomEventsHelp;
      
      private var var_1225:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1859 = new TriggerConfs();
         this.var_1860 = new ActionTypes();
         this.var_1861 = new ConditionTypes();
         this.var_278 = new Dictionary();
         super();
         this.var_92 = param1;
         this.var_799 = new RoomObjectHightLighter(param1);
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         {
            delete this.var_278[param1];
            this.var_799.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_37.furniLimit)
         {
            this.var_278[param1] = param2;
            this.var_799.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1225 = new SliderWindowController(this.var_92,IWindowContainer(this.find(this.var_57,"delay_slider_container")),this.var_92.assets,0,20,1);
         this.var_1225.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1225.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_799.hideAll(this.var_278);
         }
      }
      ...
      private function prepareStuffSelectionForUpdate() : void
      {
         ...
         if(this.var_37.stuffTypeSelectionEnabled)
         {
            ...
            else if(_loc2_.requiresFurni == var_354)
            {
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1225.getValue()) : 0;
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = this.var_37.stuffTypeSelectionCode < 1 ? int(var_1496) : int(this.var_37.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = (this.var_37.stuffTypeSelectionCode + 1) % (var_1496 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function resolveStuffSelectionType() : int
      {
         ...
         if(_loc1_.requiresFurni == var_354)
         {
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1859);
         this.refreshConfigureElement(this.var_1860);
         this.refreshConfigureElement(this.var_1861);
