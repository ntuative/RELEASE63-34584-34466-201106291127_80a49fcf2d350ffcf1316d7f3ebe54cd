package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_1209:Number = 32;
      ...
      private var var_1363:Vector3d;
      
      private var var_498:Vector3d;
      
      private var _direction:Vector3d;
      
      private var var_1362:Vector3d;
      ...
      private var var_3086:Number = -500.0;
      
      private var var_3087:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1363 = new Vector3d();
         this.var_498 = new Vector3d();
         this._direction = new Vector3d();
         this.var_1362 = new Vector3d();
         this.var_2138 = 1;
         this.var_2140 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_2139 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_498.assign(this.var_106);
         this.var_498.x *= this.var_497;
         this.var_498.y *= this.var_499;
         this.var_498.z *= this.var_496;
         return this.var_498;
      }
      ...
      {
         if(this.var_497 != param1 * this.var_2138)
         {
            this.var_497 = param1 * this.var_2138;
            ++this.var_186;
         }
      }
      ...
      {
         if(this.var_499 != param1 * this.var_2140)
         {
            this.var_499 = param1 * this.var_2140;
            ++this.var_186;
         }
      }
      ...
      {
         if(this.var_496 != param1 * this.var_2139)
         {
            this.var_496 = param1 * this.var_2139;
            ++this.var_186;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_106.x /= this.var_497;
         this.var_106.y /= this.var_499;
         this.var_106.z /= this.var_496;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_182.assign(_loc25_);
            this.var_1363.assign(this.var_182);
         }
         else
         {
            this._x.assign(_loc18_);
            this.var_183.assign(_loc19_);
            this.var_182.assign(_loc20_);
            this.var_1363.assign(this.var_182);
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1362.assign(_loc22_);
         }
         else
         {
            this.var_1362.assign(_loc17_);
         }
         ++this.var_186;
      }
      ...
      {
         if(param1 == null || this.var_182 == null)
         {
            return;
         }
         var _loc3_:Vector3d = Vector3d.product(this.var_182,-param2);
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc4_:Number = Vector3d.scalarProjection(param1,this.var_182);
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_497;
         _loc2_.y *= this.var_499;
         _loc2_.z *= this.var_496;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1362);
         if(_loc3_ < this.var_3086 || _loc3_ > this.var_3087)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_499;
            _loc2_.z *= this.var_496;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1362);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_106.x * this.var_497,this.var_106.y * this.var_499,this.var_106.z * this.var_496);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_182;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_497,param2.y * this.var_499,param2.z * this.var_496);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_497,param3.y * this.var_499,param3.z * this.var_496);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_497,param4.y * this.var_499,param4.z * this.var_496);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1209;
         }
         else
         {
            this.scale = const_579;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_579;
      }
