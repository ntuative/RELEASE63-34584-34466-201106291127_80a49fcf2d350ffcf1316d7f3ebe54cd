package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_1085:IDesktopWindow;
      
      private var _disposed:Boolean = false;
      
      private var var_1239:Function;
      
      private var var_1237:Function;
      
      private var var_810:IAssetLibrary;
      ...
      public function HabboHotelView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher, param4:Boolean = true)
      {
         ...
         this.var_810 = param2;
         this._events = param3;
         this.var_1085 = param1.getDesktop(0);
         this.var_2598 = param4;
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_810.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
      ...
      private function hotelViewLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = this.var_810.getAssetByName(_loc2_.assetName);
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_810.loadAssetFromFile("hotel_view_banner_" + this.var_1238,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
         ...
         else
         {
            if(this._events != null)
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.const_753));
            }
      ...
      public function show() : void
      {
         if(this._window && !this._window.disposed)
         {
            this.var_1085.addChildAt(this._window,0);
         }
      }
      ...
      public function hide() : void
      {
         if(this._window && !this._window.disposed)
         {
            this.var_1085.removeChild(this._window);
         }
      }
   }
}
