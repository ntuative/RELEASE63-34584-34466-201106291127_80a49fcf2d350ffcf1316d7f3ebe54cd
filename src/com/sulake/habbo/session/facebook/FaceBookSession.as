package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1079:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1544:String = "sendAccessTokenToServer";
      
      private static const const_1543:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1544,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1543,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1079);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1079);
         }
      }
