package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1733:uint = 0;
      
      public static const const_790:uint = 1;
      
      public static const const_1253:uint = 2;
      
      public static const const_833:uint = 4;
      
      public static const const_1922:uint = 8;
      
      public static const const_1749:uint = 16;
      
      public static const const_2306:uint = 64;
      
      public static const const_2321:uint = 128;
      
      public static const const_1369:uint = 256;
      
      protected static var var_612:uint = 0;
      
      protected static var var_362:uint = 0;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1253:
               ...
               break;
            case GraphicContext.const_1922:
               this.setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1749:
               this.setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_833:
               this.setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_1369:
               break;
            case GraphicContext.const_1733:
               break;
            default:
         ...
         if(this.var_939)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_362 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2262,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2262,16777215);
                  }
                  var_362 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_939)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_362 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
