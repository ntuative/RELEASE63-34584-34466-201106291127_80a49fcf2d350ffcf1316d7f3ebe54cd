package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_467:int = 2;
      
      private static const const_1040:int = 15;
      
      private static const const_1041:int = 31;
      
      private static const const_1429:int = 2;
      
      private static const const_1428:int = 1;
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            this.var_764[0] = this.getNewPoint(param1,0);
         }
         _loc2_ = getSprite(3);
         if(_loc2_ != null)
         {
            this.var_764[1] = this.getNewPoint(param1,1);
         }
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         {
            if(this.var_764.length == 2)
            {
               return this.var_764[param3 - 2].x;
            }
         }
      ...
      override protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         if(param3 == 2 || param3 == 3)
         {
            if(this.var_764.length == 2)
            {
               return this.var_764[param3 - 2].y;
            }
         }
      ...
      {
         var _loc7_:int = 0;
         var _loc3_:Number = this.var_1175[param2];
         var _loc4_:int = this.var_1172[param2];
         var _loc5_:int = this.var_1174[param2];
         var _loc6_:Number = this.var_1173[param2];
         if(param1 == 32)
         {
            _loc7_ = const_1040;
         }
         ...
         this.var_1175[param2] = _loc3_;
         if(int(_loc9_) == 0)
         {
            this.var_1173[param2] = this.getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         this.var_1175.push(Math.random() * _loc2_ * 1.5);
         this.var_1175.push(Math.random() * _loc2_ * 1.5);
         this.var_1172 = new Array();
         this.var_1172.push(1);
         this.var_1172.push(-1);
         this.var_1174 = new Array();
         this.var_1174.push(const_1429);
         this.var_1174.push(const_1428);
         this.var_1173 = new Array();
         this.var_1173.push(this.getRandomAmplitudeFactor());
         this.var_1173.push(this.getRandomAmplitudeFactor());
      }
