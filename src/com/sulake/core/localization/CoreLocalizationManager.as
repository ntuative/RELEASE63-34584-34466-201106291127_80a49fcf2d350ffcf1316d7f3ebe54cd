package com.sulake.core.localization
{
   ...
   public class CoreLocalizationManager extends Component implements ICoreLocalizationManager
   {
      ...
      {
         return this.var_1029[param1] as ILocalizationDefinition;
      }
      ...
      protected function onLocalizationFailed(param1:AssetLoaderEvent) : void
      {
         ...
         Core.error("Failed to download localization",true,Core.const_1787);
      }
      
      public function hasKey(param1:String) : Boolean
      {
         var _loc2_:Localization = this.var_74[param1] as Localization;
         return _loc2_ != null;
      }
      
      public function getKey(param1:String, param2:String = "") : String
      {
         var _loc3_:Localization = this.var_74[param1] as Localization;
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:Localization = this.var_74[param1];
         if(_loc3_ == null)
         {
            _loc3_ = new Localization(param1,param2);
            this.var_74[param1] = _loc3_;
         }
         else
         {
         ...
         {
            _loc3_.registerParameter("predefined",this.var_1929);
         }
      }
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_74)
         {
      ...
      {
         var _loc5_:Localization = this.var_74[param1];
         if(_loc5_ == null)
         {
            _loc5_ = new Localization(param1);
            this.var_74[param1] = _loc5_;
         }
      ...
      {
         return this.var_74[param1] as ILocalization;
      }
      ...
      public function printNonExistingKeys() : void
      {
         var _loc2_:* = null;
         var _loc1_:String = "";
         for each(_loc2_ in this.var_1248)
         {
            _loc1_ += _loc2_ + "\n";
         }
         Logger.log(_loc1_);
      ...
      protected function setPredefinedUrl(param1:String) : void
      {
         ...
         for each(_loc2_ in this.var_74)
         {
            ...
            {
               _loc2_.registerParameter("predefined",this.var_1929);
            }
         }
      }
   }
