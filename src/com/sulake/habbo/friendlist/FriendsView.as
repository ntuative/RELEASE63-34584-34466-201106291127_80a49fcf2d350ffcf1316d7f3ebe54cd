package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_2124:String = "bg";
      ...
      private var var_2360:IContainerButtonWindow;
      
      private var var_2359:IContainerButtonWindow;
      
      private var var_64:IItemListWindow;
      
      private var var_668:AvatarPopupCtrl;
      ...
      public function init(param1:HabboFriendList) : void
      {
         ...
         this.var_668 = new AvatarPopupCtrl(this._friendList);
      }
      ...
      {
         this.var_2361 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2362 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2360 = this.initButton("room_invite",this.onInviteButtonClick,param1);
         this.var_2359 = this.initButton("remove_friend",this.onRemoveButtonClick,param1);
         this.refreshButtons();
      }
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2361,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2362,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2360,this.isEnableInviteButton(_loc1_));
         this.setEnabled(this.var_2359,this.isEnableRemoveButton(_loc1_));
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_668.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess);
            this.var_668.showPopup(this._friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT)
         {
            this.var_668.closePopup();
         }
