package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      private static const const_554:int = 1;
      ...
      private var var_262:HabboNotificationItem;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:HabboNotificationItem)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_2180 = this._window.height - _loc7_.rectangle.bottom;
         }
         else
         {
            this.var_2180 = 15;
         }
         this.var_2178 = this._window.height;
         this.var_1679 = 4;
         this._blend = 0;
         this._state = name_4;
      ...
      {
         if(param1.badgeId != this.var_262.style.iconSrc)
         {
            return;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_554:
               ...
               _loc2_ = Number(this.var_1386) / Number(this.var_1126["time_fade_in"]);
               if(this.var_1386 > int(this.var_1126["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_1150:
               ...
               if(this.var_1680 > int(this.var_1126["time_display"]) && !this.var_2179)
               {
                  this.startFadeOut();
               }
               break;
            case const_1151:
               ...
               _loc3_ = 1 - Number(this.var_1387) / Number(this.var_1126["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1387 > int(this.var_1126["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_2180;
         if(this._window.height < this.var_2178)
         {
            this._window.height = this.var_2178;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         this._window.x = _loc2_.width - this._window.width - const_1836;
         this._window.y = this.var_1679;
      }
