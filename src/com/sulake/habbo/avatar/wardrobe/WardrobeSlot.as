package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      private function createView() : void
      {
         ...
         this.var_396 = this._view.findChildByName("image") as IBitmapWrapperWindow;
      }
      ...
      public function updateView() : void
      {
         ...
         if(this._figure && this.var_1537)
         {
            _loc5_ = this.var_27.manager.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_107,this.var_1031,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_42,parseInt(FigureData.const_912));
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "set_button":
               ...
               this.var_1031 = this.var_27.gender;
               this.var_27.handler.saveWardrobeOutfit(this.var_1930,this);
               this.updateView();
               break;
            case "get_button":
               if(this._figure)
               {
                  this.var_27.loadAvatarInEditor(this._figure,this.var_1031,this.var_27.clubMemberLevel);
               }
         }
      }
