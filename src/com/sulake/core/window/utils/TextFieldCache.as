package com.sulake.core.window.utils
{
   ...
   public class TextFieldCache implements IDisposable
   {
      ...
      private static var var_1033:Map = new Map();
      ...
      {
         var _loc2_:TextField = var_1033[param1.name];
         if(_loc2_)
         {
            return _loc2_;
         }
         ...
         if(!param1)
         {
            param1 = TextStyleManager.getStyle(TextStyleManager.const_229);
         }
         ...
         _loc3_.underline = param1.textDecoration == TextStyle.const_742 ? true : null;
