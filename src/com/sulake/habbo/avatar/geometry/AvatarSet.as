package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarSet
   {
      ...
      public function AvatarSet(param1:XML)
      {
         ...
         this.var_2508 = _loc2_ == null ? false : Boolean(Boolean(parseInt(_loc2_)));
         this.var_1369 = new Dictionary();
         this.var_2148 = new Array();
         for each(_loc4_ in param1.avatarset)
         {
            _loc3_ = new AvatarSet(_loc4_);
            this.var_1369[String(_loc4_.@id)] = _loc3_;
         }
         for each(_loc5_ in param1.bodypart)
         {
            this.var_2148.push(String(_loc5_.@id));
         }
         _loc6_ = this.var_2148.concat();
         for each(_loc3_ in this.var_1369)
         {
            _loc6_ = _loc6_.concat(_loc3_.getBodyParts());
         }
         this.var_2954 = _loc6_;
      }
      ...
      public function get isMain() : Boolean
      {
         ...
         for each(_loc1_ in this.var_1369)
         {
            if(_loc1_.isMain)
            {
               return true;
