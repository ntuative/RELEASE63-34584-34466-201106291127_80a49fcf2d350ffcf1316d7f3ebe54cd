package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryGridView
   {
      ...
      private var var_719:IItemGridWindow;
      ...
      public function destroy() : void
      {
         ...
         {
            this.var_719.destroyGridItems();
            this.var_719 = null;
         }
         if(this.var_246 != null)
         {
            if(this.var_246.events != null)
            {
      ...
      public function refresh() : void
      {
         ...
         this.var_719.removeGridItems();
         var _loc1_:Map = this._items;
         var _loc2_:Map = new Map();
         var _loc3_:Array = _loc1_.getKeys();
         this._items = new Map();
         var _loc4_:int = this.var_246.getSongDiskInventorySize();
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_)
         {
            _loc7_ = this.var_246.getSongDiskInventoryDiskId(_loc5_);
            _loc8_ = this.var_246.getSongDiskInventorySongId(_loc5_);
            _loc9_ = this.var_246.getSongInfo(_loc8_);
            _loc10_ = null;
            _loc11_ = null;
            if(_loc9_ != null)
            {
            ...
            this.var_719.addGridItem(_loc12_.window);
      ...
      public function setPreviewIconToPause() : void
      {
         ...
         {
            this.var_115.playButtonState = MusicInventoryGridItem.const_1252;
         }
      }
      ...
      public function setPreviewIconToPlay() : void
      {
         if(this.var_115 != null)
         {
            this.var_115.playButtonState = MusicInventoryGridItem.const_562;
         }
      }
      ...
      private function gridItemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            ...
            {
               if(this.var_115.playButtonState == MusicInventoryGridItem.const_562)
               {
                  this.var_115.playButtonState = MusicInventoryGridItem.const_1323;
            ...
            {
               _loc4_ = this.var_719.getGridItemIndex(param1.window);
               if(_loc4_ != -1)
               {
