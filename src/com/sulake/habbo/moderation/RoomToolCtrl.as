package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1196:IDropMenuWindow;
      ...
      private var var_1572:ICheckBoxWindow;
      
      private var var_1571:ICheckBoxWindow;
      ...
      public function populate() : void
      {
         ...
         this.var_1196 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1196);
         this.var_1196.procedure = this.onSelectTemplate;
         this.var_1052 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1572 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1571 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_35,WindowTracker.const_784,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.determineAction(param1,this.var_1052.isSelected);
         this.var_35.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1862,_loc2_,this.var_595.text,"",""));
         if(this.var_1572.isSelected || this.var_1571.isSelected || this.var_1052.isSelected)
         {
            this.var_35.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1572.isSelected,this.var_1571.isSelected,this.var_1052.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1742);
         }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_35.initMsg.roomMessageTemplates[this.var_1196.selection];
         if(_loc3_ != null)
         {
            this.var_641 = false;
            this.var_595.text = _loc3_;
         }
      }
   }
}
