package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_273)
         {
            for each(_loc2_ in this.var_273 as Array)
            {
               if(_loc2_)
               {
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(this.var_965 >= 0 && this._parts.length > this.var_965)
         {
            _loc2_ = this._parts[this.var_965];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         if(!this.var_273 || this.var_273.length == 0)
         {
            return null;
         }
         var _loc1_:Array = this.var_273[0] as Array;
      ...
      public function getPalette(param1:int) : Array
      {
         ...
         if(this.var_273.length <= param1)
         {
            return null;
         }
         return this.var_273[param1] as Array;
      }
      
      public function getCurrentPart() : AvatarEditorGridPartItem
      {
         return this._parts[this.var_965] as AvatarEditorGridPartItem;
      }
