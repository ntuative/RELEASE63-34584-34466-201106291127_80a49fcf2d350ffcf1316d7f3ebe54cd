package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetAnimationSizeData extends AnimationSizeData
   {
      ...
      public function definePostures(param1:XML) : Boolean
      {
         ...
         {
            this.var_892 = param1.@defaultPosture;
         }
         else
         {
            this.var_892 = null;
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            this.var_708.add(_loc6_,_loc7_);
         ...
         if(this.var_708.getValue(this.var_892) == null)
         {
            return false;
         }
         return true;
      ...
      {
         if(param1 >= 0 && param1 < this.var_708.length)
         {
            return this.var_708.getKey(param1);
         }
         return this.var_892;
      }
