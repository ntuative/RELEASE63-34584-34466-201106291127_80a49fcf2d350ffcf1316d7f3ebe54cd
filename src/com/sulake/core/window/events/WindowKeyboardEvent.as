package com.sulake.core.window.events
{
   ...
   public class WindowKeyboardEvent extends WindowEvent
   {
      ...
      public static const const_320:String = "WKE_KEY_UP";
      ...
      private var var_905:KeyboardEvent;
      ...
      public static function allocate(param1:String, param2:Event, param3:IWindow, param4:IWindow, param5:Boolean = false) : WindowKeyboardEvent
      {
         ...
         _loc6_._type = param1;
         _loc6_.var_905 = param2 as KeyboardEvent;
         _loc6_._window = param3;
         _loc6_.var_756 = param4;
      ...
      {
         return this.var_905.charCode;
      }
      
      public function get keyCode() : uint
      {
         return this.var_905.keyCode;
      }
      
      public function get keyLocation() : uint
      {
         return this.var_905.keyLocation;
      }
      
      public function get altKey() : Boolean
      {
         return this.var_905.altKey;
      }
      
      public function get shiftKey() : Boolean
      {
         return this.var_905.shiftKey;
      }
      
      override public function clone() : WindowEvent
      {
         return allocate(_type,this.var_905,window,related,cancelable);
      }
