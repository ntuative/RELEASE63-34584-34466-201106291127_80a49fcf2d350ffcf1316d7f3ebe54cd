package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1391:IDropMenuWindow;
      
      private var var_595:ITextFieldWindow;
      
      private var _disposed:Boolean;
      
      private var var_641:Boolean = true;
      
      private var var_1129:OffenceCategoryData;
      
      private var var_1128:OffenceData;
      
      private var var_1393:IButtonWindow;
      
      private var var_1392:IButtonWindow;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1393 = IButtonWindow(this.var_35.getXmlWindow("modact_offence"));
         this.var_1392 = IButtonWindow(this.var_35.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Mod action on: " + this.var_1814;
         ...
         this.var_595 = ITextFieldWindow(this._frame.findChildByName("message_input"));
         this.var_595.procedure = this.onInputClick;
         this.var_1391 = IDropMenuWindow(this._frame.findChildByName("banLengthSelect"));
         this.prepareBanSelect(this.var_1391);
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = this.var_1129 != null;
         ...
         else if(this.var_1129 != null)
         {
            this.refreshButtons("offences_cont",2,this.var_1129.offences,this.var_1393,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_35.initMsg.offenceCategories,this.var_1392,this.onOffenceCtgButton);
      ...
      {
         return WindowTracker.const_1725;
      }
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.connection.send(new ModAlertMessageComposer(this.var_1686,this.var_595.text,this.var_1685));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_1129 = this.var_35.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         this.var_1128 = this.var_1129.offences[_loc3_];
         this.var_595.text = this.var_1128.msg;
         this.var_641 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.connection.send(new ModKickMessageComposer(this.var_1686,this.var_595.text,this.var_1685));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1391.selection < 0)
         {
            this.var_35.windowManager.alert("Alert","You must select ban lenght",0,this.onAlertClose);
            return;
         }
         this.var_35.connection.send(new ModBanMessageComposer(this.var_1686,this.var_595.text,this.getBanLength(),this.var_1685));
         this.dispose();
      }
      
      private function isMsgGiven() : Boolean
      {
         if(this.var_641 || this.var_595.text == "")
         {
      ...
      {
         var _loc1_:int = this.var_1391.selection;
      ...
      {
         if(param1.type != WindowEvent.const_351)
         {
            return;
         }
         if(!this.var_641)
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_1393.destroy();
            this.var_1393 = null;
         }
         if(this.var_1392 != null)
         {
            this.var_1392.destroy();
            this.var_1392 = null;
         }
         this.var_1391 = null;
         this.var_595 = null;
