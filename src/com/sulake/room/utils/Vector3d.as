package com.sulake.room.utils
{
   public class Vector3d implements IVector3d
   {
      ...
      public function get length() : Number
      {
         ...
         {
            this._length = Math.sqrt(this._x * this._x + this.var_183 * this.var_183 + this.var_182 * this.var_182);
         }
         return this._length;
      }
      ...
      {
         return "(" + [this._x,this.var_183,this.var_182].join(",") + ")";
      }
   }
}
