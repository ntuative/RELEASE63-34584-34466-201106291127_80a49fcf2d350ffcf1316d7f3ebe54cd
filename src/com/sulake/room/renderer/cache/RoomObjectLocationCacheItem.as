package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      private var var_2809:int = -1;
      
      private var var_1308:Vector3d;
      ...
      public function getScreenLocation(param1:IRoomObject, param2:IRoomGeometry) : IVector3d
      {
         ...
         if(param2.updateId != this.var_1910 || param1.getUpdateID() != this.var_2809)
         {
            this.var_2809 = param1.getUpdateID();
            if(param2.updateId != this.var_1910 || _loc4_.x != this.var_1308.x || _loc4_.y != this.var_1308.y || _loc4_.z != this.var_1308.z)
            {
               this.var_1910 = param2.updateId;
               this.var_1308.assign(_loc4_);
               _loc3_ = true;
            }
         }
         this.var_2810 = _loc3_;
         if(_loc3_)
         {
            ...
            if(isNaN(_loc6_) || _loc6_ == 0)
            {
               ...
               if(_loc7_.x != _loc4_.x || _loc7_.y != _loc4_.y)
               {
                  ...
                  this.var_409.assign(_loc5_);
                  if(_loc8_ != null)
                  {
                     this.var_409.z = _loc8_.z;
                  }
               }
               else
               {
            ...
            this.var_409.x = Math.round(this.var_409.x);
            this.var_409.y = Math.round(this.var_409.y);
         }
         return this.var_409;
      }
   }
