package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1820:int = 200;
      ...
      {
         this.var_789 = IWindowContainer(this.var_35.getXmlWindow("roomvisits_row"));
         this.var_524 = new Timer(300,1);
         this.var_524.addEventListener(TimerEvent.TIMER,this.onResizeTimer);
         this.var_35.messageHandler.method_12(this);
      ...
      {
         return WindowTracker.const_1879;
      }
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1480)
         {
