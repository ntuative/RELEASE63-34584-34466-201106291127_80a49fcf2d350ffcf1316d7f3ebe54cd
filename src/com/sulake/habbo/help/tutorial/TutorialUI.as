package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_353:String = "TUI_NAME_VIEW";
      
      public static const const_410:String = "TUI_CLOTHES_VIEW";
      
      public static const const_586:String = "TUI_GUIDEBOT_VIEW";
      ...
      private var var_394:NameChangeView;
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_35.events.addEventListener(HabboHelpTutorialEvent.const_657,this.onTaskDoneEvent);
         this.var_35.events.addEventListener(HabboHelpTutorialEvent.const_611,this.onTaskDoneEvent);
         if(this.var_35.sessionDataManager != null)
         {
            this.var_35.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_328,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1246 && this.var_1245 && this.var_1525;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_35)
         {
            ...
            this.var_35.events.removeEventListener(HabboHelpTutorialEvent.const_657,this.onTaskDoneEvent);
            this.var_35.events.removeEventListener(HabboHelpTutorialEvent.const_611,this.onTaskDoneEvent);
            if(this.var_35.sessionDataManager != null)
            {
               this.var_35.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_328,this.onFigureUpdate);
            }
            this.var_35 = null;
         }
      }
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_597:
               this.var_1525 = true;
               if(this.var_53 != null && this.var_53.id == const_586)
               {
                  this.showView(const_98);
               }
               break;
            case HabboHelpTutorialEvent.const_657:
               if(this.var_53 != null && this.var_53.id == const_410)
               {
                  this.var_1917 = true;
                  this.disposeWindow();
               }
               break;
            case HabboHelpTutorialEvent.const_611:
               if(this.var_1917)
               {
                  this.var_1917 = false;
                  this.showView(const_98);
      ...
      public function showView(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case const_353:
               ...
               if(this.var_394 == null)
               {
                  this.var_394 = new NameChangeView(this);
               }
               this.var_394.showMainView();
               this.prepareForTutorial();
               break;
            case const_410:
         ...
         this._window.height = _loc2_.height + this.var_2534;
      ...
      public function prepareForTutorial() : void
      {
         ...
         this.var_35.hideUI();
         this.var_35.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_133));
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_53 != null && (this.var_53.id == const_353 || this.var_53.id == const_98))
         {
            this.showView(const_98);
         }
      }
      ...
      {
         this.var_1246 = true;
         if(this.var_53 != null && (this.var_53.id == const_410 || this.var_53.id == const_98))
         {
            this.showView(const_98);
         }
      }
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         {
            this.var_394.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
         }
      }
      ...
      public function onCheckUserNameResult(param1:CheckUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_502)
         {
            this.var_394.checkedName = _loc2_.name;
         }
         else
         {
            this.var_394.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
