package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor
   {
      ...
      private static const const_1667:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1668:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_591:HabboAvatarEditorManager;
      
      private var var_1107:IFigureData;
      ...
      private var var_1370:IHabboAvatarEditorDataSaver = null;
      ...
      public function HabboAvatarEditor(param1:uint, param2:HabboAvatarEditorManager)
      {
         ...
         this.var_591 = param2;
         this.var_1107 = this.var_591.avatarRenderManager.getFigureData(AvatarType.const_120);
      }
      ...
      private function init(param1:Array = null) : void
      {
         ...
         this.var_724["null"] = new FigureData(this);
         this.var_724["null"] = new FigureData(this);
         var _loc2_:FigureData = this.var_724["null"];
         var _loc3_:FigureData = this.var_724["null"];
         _loc2_.loadAvatarData(const_1667,FigureData.const_88);
         _loc3_.loadAvatarData(const_1668,FigureData.FEMALE);
         this.var_118 = new Map();
         this.var_592 = new Map();
         this.var_118.add(AvatarEditorFigureCategory.const_911,new BodyModel(this));
         this.var_118.add(AvatarEditorFigureCategory.const_54,new HeadModel(this));
         this.var_118.add(AvatarEditorFigureCategory.const_263,new TorsoModel(this));
         this.var_118.add(AvatarEditorFigureCategory.const_768,new LegsModel(this));
         ...
         this.var_592.add(AvatarEditorSideCategory.const_110,new WardrobeModel(this));
         this.var_592.add(AvatarEditorSideCategory.const_507,new ClubPromoModel(this));
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         if(this.var_908 != param3)
         {
            this.var_908 = param3;
            _loc4_ = true;
         }
         var _loc5_:FigureData = this.var_724[param2];
         if(_loc5_ == null)
         {
            return;
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_1107.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_1107.getPalette(param1);
      }
      ...
      private function selectDefaultCategory(param1:Array) : void
      {
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_911);
         }
      }
      ...
      {
         var _loc2_:ISideContentModel = this.var_592.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      {
         return this.var_724[this.var_1031];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         {
            this.var_1370.saveFigure(_loc1_,_loc2_);
         }
         else
         {
            _loc3_ = new UpdateFigureDataMessageComposer(_loc1_,_loc2_);
            this.var_591.communication.getHabboMainConnection(null).send(_loc3_);
            _loc3_.dispose();
            _loc3_ = null;
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_2149;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_908 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < const_721)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1696.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_591.avatarRenderManager.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_591.avatarRenderManager.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            _loc15_ = Boolean(_loc14_.indexOf(param2) == -1);
            if(_loc15_)
            {
               _loc21_ = this.var_591.assets.getAssetByName("removeSelection") as BitmapDataAsset;
               if(_loc21_)
               {
                  _loc22_ = (_loc21_.content as BitmapData).clone();
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1406.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1810)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_908 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1406.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      {
         return this.var_591.configuration.getBoolean("avatareditor.allowclubtryout",false);
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_908 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_592.getValue(AvatarEditorSideCategory.const_110);
      }
