package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_877:IssueMessageData = null;
      
      private var var_876:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2789 = param2.pickerUserId;
         this.var_2819 = param2.pickerUserName;
         this.var_1660 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1314 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1313;
         }
         if(this.var_877 == null || param1.timeStamp < this.var_877.timeStamp)
         {
            this.var_877 = param1;
         }
         if(this.var_876 == null || param1.priority > this.var_876.timeStamp)
         {
            this.var_876 = param1;
         }
      }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1314 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1313;
            }
            if(this.var_877 == _loc2_)
            {
               this.var_877 = null;
            }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_876;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_877;
         if(_loc2_ == null)
         {
