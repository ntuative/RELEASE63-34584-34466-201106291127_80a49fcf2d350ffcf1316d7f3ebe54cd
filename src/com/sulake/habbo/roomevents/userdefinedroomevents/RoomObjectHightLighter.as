package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class RoomObjectHightLighter
   {
      ...
      {
         return this.var_92.roomEngine.getRoomObject(this.var_92.roomId,this.var_92.roomCategory,param1,RoomObjectCategoryEnum.const_26);
      }
