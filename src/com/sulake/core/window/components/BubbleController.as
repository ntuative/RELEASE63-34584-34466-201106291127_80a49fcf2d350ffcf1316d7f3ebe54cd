package com.sulake.core.window.components
{
   ...
   public class BubbleController extends FrameController implements IBubbleWindow
   {
      ...
      private static const const_2078:String = "_POINTER_UP";
      
      private static const const_2076:String = "_POINTER_DOWN";
      
      private static const const_2075:String = "_POINTER_LEFT";
      ...
      public function set direction(param1:String) : void
      {
         ...
         if(param1 != this._direction)
         {
            ...
            this.pointerOffset = this.var_765;
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_906,this._direction,PropertyStruct.const_50,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1815);
         }
         if(this.var_765 != 0)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_902,this.var_765,PropertyStruct.const_36,true));
         }
         else
         {
