package com.sulake.habbo.ui.handler
{
   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IAvatarImageListener
   {
      ...
      public function dispose() : void
      {
         ...
         {
            this._container.avatarEditor.close(AvatarEditorInstanceId.const_226);
         }
         this.var_1154 = true;
         this.container = null;
         this.var_12 = null;
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_328,this.onFigureUpdate);
            }
            if(this.var_12 && !this.var_12.disposed && this.var_12.events)
            {
               this.var_12.events.removeEventListener(HabboInventoryEffectsEvent.const_312,this.onAvatarEffectsChanged);
               this.var_12.events.removeEventListener(HabboInventoryHabboClubEvent.HABBO_CLUB_CHANGED,this.onHabboClubSubscriptionChanged);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_864,this.onHelpTutorialEvent);
            ...
            {
               this._container.catalog.events.removeEventListener(PurseEvent.const_132,this.onCreditBalance);
            }
         }
         ...
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_328,this.onFigureUpdate);
         }
         this.var_12 = this._container.inventory;
         if(this.var_12 != null)
         {
            this.var_12.events.addEventListener(HabboInventoryEffectsEvent.const_312,this.onAvatarEffectsChanged);
            this.var_12.events.addEventListener(HabboInventoryHabboClubEvent.HABBO_CLUB_CHANGED,this.onHabboClubSubscriptionChanged);
         }
         ...
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_864,this.onHelpTutorialEvent);
         ...
         {
            this._container.catalog.events.addEventListener(PurseEvent.const_132,this.onCreditBalance);
         }
      }
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1519)
            {
               ...
               this.var_1519 = _loc3_;
               this.var_1904 = _loc1_;
               this.var_1903 = _loc2_;
            }
            else
            {
               _loc1_ = this.var_1904;
               _loc2_ = this.var_1903;
            }
         }
         if(this._toolbar != null)
         {
            if(_loc1_ != null && _loc2_ != null)
            {
               if(_loc1_.height > const_477)
               {
                  ...
                  if(_loc2_.height > const_477 - const_1074)
                  {
                     _loc8_.offset(0,_loc2_.height - const_477 + const_1074);
                  }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_816);
         _loc1_.push(RoomWidgetDanceMessage.const_788);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_916);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1386);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1240);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1347);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_747);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_779);
         _loc1_.push(RoomWidgetStopEffectMessage.const_806);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1771);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1379);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_633);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1967);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1211);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_855);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_954);
         _loc1_.push(RoomWidgetMeMenuMessage.const_941);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_841);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1887);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_845);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_977);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1243);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_411);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_954:
               ...
               break;
            case RoomWidgetWaveMessage.const_816:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_788:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_916:
               if(this.var_12 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1386:
               if(this.var_12 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1240:
               if(this.var_12 != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_779:
               ...
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1279)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_124,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_747:
               ...
               if(this.var_12 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_1755:
                        this._catalog.openCatalogPage(CatalogPageName.const_1393,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1300:
                        this.var_12.toggleInventoryPage(InventoryCategory.const_228);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1754:
                        this.var_12.toggleInventoryPage(InventoryCategory.const_75);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1957:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1347:
            case RoomWidgetStopEffectMessage.const_806:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_1379:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_855:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetMeMenuMessage.const_941:
               ...
               {
                  this._container.events.dispatchEvent(new RoomWidgetPurseUpdateEvent(RoomWidgetPurseUpdateEvent.const_132,this._catalog.getPurse().credits));
               }
               ...
               break;
            case RoomWidgetAvatarEditorMessage.const_633:
               Logger.log("MeMenuWidgetHandler: Open avatar editor...");
               if(this._container)
               {
                  this._container.avatarEditor.openEditor(AvatarEditorInstanceId.const_226,null,null,true);
                  this._container.avatarEditor.loadOwnAvatarInEditor(AvatarEditorInstanceId.const_226);
                  if(this._container.habboHelp && this._container.habboHelp.events)
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_657));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_841:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_440,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_845:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_440,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_977:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_440,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_1243:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_611));
               }
               break;
            default:
      ...
      private function onCreditBalance(param1:PurseEvent) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetPurseUpdateEvent(RoomWidgetPurseUpdateEvent.const_132,param1.balance));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_133:
               ...
               break;
            case HabboHelpTutorialEvent.const_864:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_542));
         }
      }
