package com.sulake.room.renderer.cache
{
   ...
   public class BitmapDataCache
   {
      ...
      public function BitmapDataCache(param1:int, param2:int, param3:int = 1)
      {
         ...
         this.var_964 = param1 * 1024 * 1024;
         this.var_1781 = param2 * 1024 * 1024;
         this.var_1463 = param3 * 1024 * 1024;
         if(this.var_1463 < 0)
         {
            this.var_1463 = 0;
         }
      ...
      {
         this.var_964 += this.var_1463;
         if(this.var_964 > this.var_1781)
         {
            this.var_964 = this.var_1781;
         }
      }
      
      private function method_4(param1:String) : Boolean
      {
         if(param1 == null)
         {
            return false;
      ...
      public function addBitmapData(param1:String, param2:ExtendedBitmapData) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               this.var_775 -= _loc4_.width * _loc4_.height * 4;
            }
         ...
         this.var_775 += param2.width * param2.height * 4;
      }
   }
}
