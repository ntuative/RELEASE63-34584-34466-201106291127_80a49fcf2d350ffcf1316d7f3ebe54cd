package com.sulake.habbo.room.object.logic
{
   ...
   public class PetLogic extends MovingObjectLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_159,RoomObjectMoveEvent.const_403];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(param1 is RoomObjectAvatarExperienceUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_450,Number(_loc9_.gainedExperience));
            return;
         }
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            _loc10_ = param1 as RoomObjectAvatarFigureUpdateMessage;
            _loc11_ = _loc2_.getString(RoomObjectVariableEnum.const_218);
            _loc2_.setString(RoomObjectVariableEnum.const_218,_loc10_.figure);
            _loc2_.setString(RoomObjectVariableEnum.const_2021,_loc10_.race);
            _loc2_.setNumber(RoomObjectVariableEnum.const_899,this.getPaletteIndex(_loc10_.figure));
            return;
         }
      }
      ...
      private function debugMouseEvent(param1:RoomSpriteMouseEvent) : void
      {
         ...
         if(!param1.altKey && !param1.ctrlKey)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_203,_loc3_ + this.var_945);
         }
         else if(param1.altKey && !param1.ctrlKey)
         {
            ++this.var_1736;
            _loc2_.setNumber(RoomObjectVariableEnum.const_294,this.var_1736);
            _loc2_.setNumber(RoomObjectVariableEnum.const_156,NaN);
         }
         else if(param1.ctrlKey && !param1.altKey)
         {
            ++this.var_1737;
            _loc2_.setNumber(RoomObjectVariableEnum.const_156,this.var_1737);
         }
         else
         {
            this.var_945 += 45;
