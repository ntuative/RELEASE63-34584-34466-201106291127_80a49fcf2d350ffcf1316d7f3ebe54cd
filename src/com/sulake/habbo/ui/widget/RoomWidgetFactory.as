package com.sulake.habbo.ui.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_74)
         {
            this.var_74.release(new IIDHabboLocalizationManager());
            this.var_74 = null;
         }
         if(this.var_151)
         {
      ...
      {
         this.var_74 = param2 as IHabboLocalizationManager;
      }
      ...
      public function createWidget(param1:String, param2:IRoomWidgetHandler) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_438:
               _loc3_ = new RoomChatWidget(param2,this._windowManager,assets,this.var_74,this.var_151,this.var_2931++,this,this.var_49);
               break;
            case RoomWidgetEnum.const_343:
               _loc3_ = new RoomChatInputWidget(param2,this._windowManager,assets,this.var_74,this.var_151,this);
               break;
            case RoomWidgetEnum.const_547:
               _loc3_ = new InfostandWidget(param2,this._windowManager,assets,this.var_74,this.var_151,this._catalog);
               break;
            case RoomWidgetEnum.const_630:
               _loc3_ = new MeMenuWidget(param2,this._windowManager,assets,this.var_74,events,this.var_151);
               break;
            case RoomWidgetEnum.const_760:
               _loc3_ = new PlaceholderWidget(param2,this._windowManager,assets,this.var_74);
               break;
            case RoomWidgetEnum.const_637:
               _loc3_ = new CreditFurniWidget(param2,this._windowManager,assets,this.var_74);
               break;
            ...
            case RoomWidgetEnum.const_513:
               _loc3_ = new TeaserFurniWidget(param2,this._windowManager,assets,this.var_74,this.var_151,this.var_12);
               break;
            ...
            case RoomWidgetEnum.const_569:
               _loc3_ = new PetPackageFurniWidget(param2,this._windowManager,assets,this.var_74);
               break;
            case RoomWidgetEnum.const_125:
               _loc3_ = new DoorbellWidget(param2,this._windowManager,assets,this.var_74);
               break;
            case RoomWidgetEnum.const_552:
               _loc3_ = new LoadingBarWidget(param2,this._windowManager,assets,this.var_74,this.var_151);
               break;
            case RoomWidgetEnum.const_622:
               _loc3_ = new RoomQueueWidget(param2,this._windowManager,assets,this.var_74,this.var_151);
               break;
            case RoomWidgetEnum.const_138:
               _loc3_ = new VoteWidget(param2,this._windowManager,assets,this.var_74,this.var_151);
               break;
            case RoomWidgetEnum.const_408:
               _loc3_ = new PollWidget(param2,this._windowManager,assets,this.var_74);
               break;
            case RoomWidgetEnum.const_377:
               _loc3_ = new UserChooserWidget(param2,this._windowManager,assets,this.var_74);
               break;
            case RoomWidgetEnum.const_674:
               _loc3_ = new FurniChooserWidget(param2,this._windowManager,assets,this.var_74);
               break;
            case RoomWidgetEnum.const_498:
               _loc3_ = new DimmerFurniWidget(param2,this._windowManager,assets,this.var_74);
               break;
            case RoomWidgetEnum.const_149:
               _loc3_ = new FriendRequestWidget(param2,this._windowManager,assets,this.var_74,this);
               break;
            case RoomWidgetEnum.const_496:
               _loc3_ = new ClothingChangeFurnitureWidget(param2,this._windowManager,assets,this.var_74);
               break;
            case RoomWidgetEnum.const_804:
               _loc3_ = new RoomWidgetBase(param2,this._windowManager);
               break;
            case RoomWidgetEnum.const_139:
               _loc3_ = new UserNotificationWidget(param2,this._windowManager,assets,this.var_74);
               break;
            case RoomWidgetEnum.const_134:
               _loc3_ = new AvatarInfoWidget(param2,this._windowManager,assets,this.var_151,this.var_74,this);
               break;
            case RoomWidgetEnum.const_620:
               _loc3_ = new WelcomeGiftWidget(param2,this._windowManager,assets,this.var_74);
               break;
            case RoomWidgetEnum.const_623:
               _loc3_ = new PlayListEditorWidget(param2,this._windowManager,this._soundManager,assets,this.var_74,this.var_151,this._catalog);
               break;
