package com.sulake.habbo.ui.handler
{
   ...
   public class PlayListEditorWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_1526:IMessageEvent;
      
      private var var_1918:IMessageEvent;
      
      private var var_1919:IMessageEvent;
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         ...
         if(this._container.soundManager)
         {
            ...
            this._container.soundManager.events.addEventListener(PlayListStatusEvent.const_172,this.processSoundManagerEvent);
            ...
            this._container.soundManager.events.addEventListener(NowPlayingEvent.const_126,this.processSoundManagerEvent);
         }
      }
      
      public function set connection(param1:IConnection) : void
      {
         this.var_1526 = new FurniListUpdateEvent(this.onFurniListUpdated);
         this.var_1918 = new FurniListRemoveEvent(this.onFurniListUpdated);
         this.var_1919 = new FurniListInsertEvent(this.onFurniListUpdated);
         this._connection = param1;
         this._connection.addMessageEvent(this.var_1526);
         this._connection.addMessageEvent(this.var_1918);
         this._connection.addMessageEvent(this.var_1919);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               this._connection.removeMessageEvent(this.var_1526);
               this._connection.removeMessageEvent(this.var_1918);
               this._connection.removeMessageEvent(this.var_1919);
            }
            ...
            if(this._container)
            {
               if(this._container.soundManager)
               {
                  if(this._container.soundManager.events)
                  {
                     ...
                     this._container.soundManager.events.removeEventListener(PlayListStatusEvent.const_172,this.processSoundManagerEvent);
                     ...
                     this._container.soundManager.events.removeEventListener(NowPlayingEvent.const_126,this.processSoundManagerEvent);
                  }
               }
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_984,RoomWidgetPlayListModificationMessage.const_755,RoomWidgetPlayListModificationMessage.const_893,RoomWidgetPlayListPlayStateMessage.const_881,RoomWidgetPlayListUserActionMessage.const_849];
      }
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_984:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc7_)
                  {
                     _loc8_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_846,_loc2_.id);
                     this._container.events.dispatchEvent(_loc8_);
                  }
               }
               break;
            case RoomWidgetPlayListModificationMessage.const_755:
               ...
               break;
            case RoomWidgetPlayListModificationMessage.const_893:
               ...
               break;
            case RoomWidgetPlayListPlayStateMessage.const_881:
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineSoundMachineEvent.const_256:
               ...
               _loc3_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_1000,_loc2_.objectId);
      ...
      private function onFurniListUpdated(param1:IMessageEvent) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_879,-1));
            }
         }
      }
      ...
      private function processSoundManagerEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case SongDiskInventoryReceivedEvent.SONG_DISK_INVENTORY_RECEIVED:
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_903));
               break;
            case PlayListStatusEvent.const_103:
               ...
               break;
            case PlayListStatusEvent.const_172:
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_172));
               break;
            ...
            case NowPlayingEvent.const_136:
               ...
               break;
            case NowPlayingEvent.const_126:
               _loc2_ = param1 as NowPlayingEvent;
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorNowPlayingEvent(RoomWidgetPlayListEditorNowPlayingEvent.const_126,_loc2_.id,_loc2_.position,_loc2_.priority));
         }
      }
   }
}
