package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      {
         if(param1 != this.var_2104 || param2 != this.var_2103)
         {
      ...
      {
         if(this.var_1630 > 255 || bitmapData == null)
         {
            return false;
         }
