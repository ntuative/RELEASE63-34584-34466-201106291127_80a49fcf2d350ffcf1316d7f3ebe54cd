package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private static const const_695:Number = 0.25;
      
      private static const const_1377:Number = 0.25;
      
      public static const const_72:int = -110;
      ...
      private var var_1530:Number = 0.0;
      
      private var var_1520:Number = 1.0;
      
      private var var_1024:Number = 1.0;
      
      private var var_1049:Number = 0.0;
      ...
      public function initializeTileMap(param1:int, param2:int) : Boolean
      {
         ...
         while(_loc3_ < param2)
         {
            ...
            while(_loc7_ < param1)
            {
               _loc4_[_loc7_] = const_72;
               _loc5_[_loc7_] = const_72;
               _loc6_[_loc7_] = false;
               _loc7_++;
            }
            this.var_121.push(_loc4_);
            this._tileMatrixOriginal.push(_loc5_);
            this.var_550.push(_loc6_);
            _loc3_++;
         }
         this.var_215 = param1;
         this._height = param2;
         this._minX = this.var_215;
         this.var_468 = -1;
         this.var_469 = this._height;
         this.var_470 = -1;
         return true;
      }
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         var _loc8_:int = 0;
         if(param1 >= 0 && param1 < this.var_215 && param2 >= 0 && param2 < this._height)
         {
            ...
            if(param3 >= 0)
            {
               ...
               if(param1 > this.var_468)
               {
                  this.var_468 = param1;
               }
               if(param2 < this.var_469)
               {
                  this.var_469 = param2;
               }
               if(param2 > this.var_470)
               {
                  this.var_470 = param2;
               }
            }
            ...
            {
               if(param1 == this._minX || param1 == this.var_468)
               {
                  _loc5_ = false;
                  _loc6_ = this.var_469;
                  while(_loc6_ < this.var_470)
                  {
               ...
               if(param2 == this.var_469 || param2 == this.var_470)
               {
                  _loc7_ = false;
                  _loc8_ = this._minX;
                  while(_loc8_ < this.var_468)
                  {
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         while(_loc3_ < this._height)
         {
            ...
            while(_loc2_ < this.var_215)
            {
               if(this.var_550[_loc3_][_loc2_])
               {
                  this.var_121[_loc3_][_loc2_] = const_109;
               }
               _loc2_++;
            }
            _loc3_++;
      ...
      private function initialize(param1:Point, param2:Boolean) : Boolean
      {
         ...
         if(param1 != null)
         {
            ...
            this.setTileHeight(param1.x,param1.y,const_72);
         }
         this.var_1049 = getFloorHeight(this.var_121);
         if(!param2)
         {
      ...
      {
         var _loc12_:* = null;
         this.addPlane(RoomPlaneData.const_257,param1,param2,param3,[param4]);
         this.addPlane(RoomPlaneData.const_442,param1,param2,param3,[param4]);
         var _loc8_:Number = const_1377 * this.var_1520;
         var _loc9_:Number = const_695 * this.var_1024;
         ...
         this.addPlane(RoomPlaneData.const_257,Vector3d.sum(param1,param3),param2,_loc11_,[_loc10_,param4]);
         if(param5)
         {
            this.addPlane(RoomPlaneData.const_257,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + _loc9_) / param3.length),_loc11_,[_loc10_,param4]);
         }
         if(param6)
         {
            this.addPlane(RoomPlaneData.const_257,Vector3d.sum(param1,Vector3d.product(param3,-_loc9_ / param3.length)),Vector3d.product(param3,(param3.length + _loc9_) / param3.length),_loc11_,[_loc10_,param4]);
            if(param7)
            {
               _loc12_ = Vector3d.product(param2,_loc8_ / param2.length);
               this.addPlane(RoomPlaneData.const_257,Vector3d.sum(Vector3d.sum(param1,param3),Vector3d.product(_loc12_,-1)),_loc12_,_loc11_,[_loc10_,param2,param4]);
            }
         }
      }
      ...
      private function addFloor(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:Number, param9:Number, param10:Number, param11:Number, param12:Boolean, param13:Boolean) : void
      {
         ...
         var _loc14_:RoomPlaneData = this.addPlane(RoomPlaneData.const_273,param1,param2,param3);
         var _loc15_:IVector3d = param1;
         var _loc16_:* = null;
         var _loc17_:* = null;
         if(_loc14_)
         {
            _loc18_ = const_695 * this.var_1024;
            _loc19_ = _loc18_;
            if(this.var_1024 > 1)
            {
               _loc19_ = const_695;
            ...
            if(param6)
            {
               ...
               _loc16_ = this.addPlane(RoomPlaneData.const_273,_loc15_,new Vector3d(0,0,-_loc20_),param2);
               if(_loc16_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc16_ = this.addPlane(RoomPlaneData.const_273,_loc15_,new Vector3d(0,0,-_loc20_),Vector3d.product(param2,-1));
               if(_loc16_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc17_ = this.addPlane(RoomPlaneData.const_273,_loc15_,new Vector3d(0,0,-_loc20_),Vector3d.product(param3,-1));
               if(_loc17_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc17_ = this.addPlane(RoomPlaneData.const_273,_loc15_,new Vector3d(0,0,-_loc20_),param3);
               if(_loc17_ != null)
               {
                  if(param10 > 0)
                  {
      ...
      public function getXML() : XML
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:* = null;
         var _loc1_:XML = <tileMap width="{this.var_215}" height="{this._height}" wallHeight="{this.var_1530}"/>;
         var _loc2_:int = 0;
      ...
      public function getPlaneType(param1:int) : int
      {
         if(param1 < 0 || param1 >= this.planeCount)
         {
            return RoomPlaneData.const_1315;
         }
         var _loc2_:RoomPlaneData = this.var_155[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
      ...
      private function initializeHoleMap() : void
      {
         ...
         while(_loc2_ < this._height)
         {
            _loc3_ = this.var_550[_loc2_];
            _loc1_ = 0;
            while(_loc1_ < this.var_215)
            {
               _loc3_[_loc1_] = false;
               _loc1_++;
            }
         ...
         while(_loc4_ < this.var_333.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               _loc7_ = _loc7_ >= this.var_215 ? int(this.var_215 - 1) : int(_loc7_);
