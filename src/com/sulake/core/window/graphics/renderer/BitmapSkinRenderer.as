package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      {
         super(param1);
         this.var_929 = new Dictionary(false);
         this.var_930 = new Dictionary(false);
         this.var_272 = new Matrix();
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            this.var_272 = null;
            this.var_774 = null;
            for(_loc1_ in this.var_929)
            {
               _loc2_ = this.var_929[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_929[_loc1_];
            }
            this.var_929 = null;
            for(_loc1_ in this.var_930)
            {
               _loc2_ = this.var_930[_loc1_] as BitmapData;
               _loc2_.dispose();
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         var _loc7_:ISkinLayout = var_508[param4];
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            if(_loc16_)
            {
               this.var_774.redMultiplier = ((param1.color & 16711680) >> 16) / 255;
               this.var_774.greenMultiplier = ((param1.color & 65280) >> 8) / 255;
               this.var_774.blueMultiplier = (param1.color & 255) / 255;
               this.var_774.alphaMultiplier = 1;
            }
            _loc17_ = 0;
            while(_loc17_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc16_ && _loc10_.colorize)
                  {
                     ...
                     _loc18_.colorTransform(_loc18_.rect,this.var_774);
                  }
                  _loc12_ = false;
                  _loc13_ = false;
                  ...
                  if(_loc10_.var_355 == SkinLayoutEntity.const_372)
                  {
                     REGION.x += _loc14_;
                  }
                  else if(_loc10_.var_355 == SkinLayoutEntity.const_587)
                  {
                     _loc12_ = true;
                  ...
                  else if(_loc10_.var_355 == SkinLayoutEntity.const_362)
                  {
                     _loc12_ = true;
                     REGION.right += _loc14_;
                     if(true)
                  ...
                  else if(_loc10_.var_355 == SkinLayoutEntity.const_541)
                  {
                  ...
                  else if(_loc10_.var_357 == SkinLayoutEntity.const_587)
                  {
                     _loc13_ = true;
                  ...
                  else if(_loc10_.var_357 == SkinLayoutEntity.const_362)
                  {
                     _loc13_ = true;
                     REGION.bottom += _loc15_;
                     if(true)
                  ...
                  else if(_loc10_.var_357 == SkinLayoutEntity.const_362 || _loc10_.var_355 == SkinLayoutEntity.const_362)
                  {
                  ...
                  {
                     this.var_272.a = REGION.width;
                     this.var_272.d = REGION.height;
                     this.var_272.tx = REGION.x;
                     this.var_272.ty = REGION.y;
                     ALPHA.alphaMultiplier = (_loc19_.getPixel32(0,0) >>> 24) / 255;
                     _loc6_.draw(_loc18_,this.var_272,ALPHA);
                  }
                  else
                  {
                     this.var_272.a = 0 / _loc18_.width;
                     this.var_272.d = 0 / _loc18_.height;
                     this.var_272.tx = 0;
                     this.var_272.ty = 0;
                     _loc31_ = new BitmapData(REGION.width,REGION.height,_loc18_.transparent);
                     _loc31_.draw(_loc18_,this.var_272);
                     _loc32_ = new BitmapData(REGION.width,REGION.height,true,0);
                     _loc32_.draw(_loc19_,this.var_272,null);
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:SkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.var_355 == SkinLayoutEntity.const_372)
               {
      ...
      private function getBitmapFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc4_:BitmapData = this.var_929[_loc3_];
         if(_loc4_ == null)
         {
      ...
      private function getAlphaFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc3_:String = param2 + "@" + param1.name;
         var _loc4_:BitmapData = this.var_930[_loc3_];
         if(_loc4_ == null)
         {
            _loc5_ = param1.getChildByName(param2) as ISkinTemplateEntity;
            if(_loc5_ == null)
