package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1692:int = 152;
      
      private static const const_1696:int = 16;
      
      private static const const_725:int = 4;
      
      private static const const_1694:uint = 14342874;
      
      private static const const_1697:uint = 3815994;
      
      private static const const_1699:uint = 2085362;
      
      private static const const_1698:uint = 39616;
      
      private static const const_1701:uint = 10513106;
      
      private static const const_1702:uint = 8734654;
      
      private static const const_1691:uint = 9094430;
      
      private static const const_1695:uint = 6200576;
      
      private static const const_1693:String = "happiness";
      
      private static const const_1700:String = "experience";
      
      private static const const_1689:String = "energy";
      
      private static const const_1690:int = 250;
      
      private static const const_1148:int = 25;
      ...
      private var var_234:PetCommandTool;
      ...
      {
         if(this.var_55 == null || this.var_46 == null || this.var_108 == null)
         {
            return;
         }
         ...
         this._window.width = Math.max(this.var_46.width,this.var_108.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_46.width < this.var_108.width)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1693,param1.nutrition,param1.nutritionMax,const_1698,const_1699);
         this.updateStateElement(const_1700,param1.experience,param1.experienceMax,const_1702,const_1701);
         this.updateStateElement(const_1689,param1.energy,param1.energyMax,const_1695,const_1691);
         ...
         this.updateWindow();
         this.var_522 = param1.id;
         this._petData.remove(param1.id);
         this._petData.add(param1.id,param1);
         if(this.var_234 && this.var_234.isVisible() && param1.isOwnPet)
         {
            this.var_234.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:CommandConfiguration) : void
      {
         ...
         this.var_234.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1692,const_1696,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1694);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1697);
         var _loc9_:Rectangle = new Rectangle(1,1 + const_725,_loc7_.width - 2,_loc7_.height - 2 - const_725);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,const_725);
      ...
      private function openTrainView() : void
      {
         if(this.var_234 == null)
         {
            this.var_234 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_522) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_234.showWindow(true);
            this.var_234.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_234 && this.var_234.getPetId() == this.var_522)
               {
                  this.var_234.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1734,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_433,this._widget.petData.ownerId);
      ...
      private function arrangeButtons() : void
      {
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1148 + const_1149;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1149;
            }
         }
         this.var_108.height = _loc4_ + const_1148;
         this.updateWindow();
      }
   }
}
