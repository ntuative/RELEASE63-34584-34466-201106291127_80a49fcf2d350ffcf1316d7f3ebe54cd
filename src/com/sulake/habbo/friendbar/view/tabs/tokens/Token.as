package com.sulake.habbo.friendbar.view.tabs.tokens
{
   ...
   public class Token implements IDisposable
   {
      ...
      protected static var var_1429:IHabboWindowManager;
      
      protected static var var_1430:IAssetLibrary;
      ...
      protected static const const_1409:Rectangle = new Rectangle(0,0,25,25);
      ...
      protected var var_1415:FriendNotification;
      
      protected var var_1146:DropAnimation;
      ...
      {
         return this.var_1415.typeCode;
      }
      
      public function get viewOnce() : Boolean
      {
         return this.var_1415.viewOnce;
      }
      ...
      {
         var _loc7_:* = null;
         this._window = var_1429.buildFromXML(var_1430.getAssetByName(param3).content as XML) as IWindowContainer;
         this._window.findChildByName(const_2045).caption = param1;
         this._window.findChildByName(const_1154).caption = !!param2 ? param2 : "";
         _loc7_ = var_1430.getAssetByName(param5) as BitmapDataAsset;
         if(_loc7_)
         {
            IBitmapWrapperWindow(this._window.findChildByName(ICON)).bitmap = _loc7_.content as BitmapData;
         }
         this._icon = var_1429.create("ICON_" + this.typeCode,WindowType.const_334,WindowStyle.const_100,WindowParam.const_29,Token.const_1409) as IRegionWindow;
         this._icon.mouseThreshold = 0;
         var _loc8_:IBitmapWrapperWindow = var_1429.create("BITMAP_" + this.typeCode,WindowType.const_461,WindowStyle.const_100,WindowParam.const_180,Token.const_1409) as IBitmapWrapperWindow;
         _loc8_.disposesBitmap = false;
         _loc7_ = var_1430.getAssetByName(param4) as BitmapDataAsset;
         if(_loc7_)
         {
         ...
         if(param6)
         {
            this.var_1146 = new DropAnimation(this._icon,600,32);
         }
      }
   }
}
