package com.sulake.habbo.toolbar.extensions.purse.indicators
{
   ...
   public class PixelsIndicator extends CurrencyIndicatorBase
   {
      ...
      private static const const_1440:uint = 4285767869;
      
      private static const const_1442:uint = 4283664040;
      ...
      {
         this._catalog.openCatalogPage(CatalogPageName.const_1902);
      }
      ...
      private function onPixelBalance(param1:PurseEvent) : void
      {
         ...
         if(this.var_2037 != 0)
         {
            if(this.var_2037 > param1.balance)
            {
