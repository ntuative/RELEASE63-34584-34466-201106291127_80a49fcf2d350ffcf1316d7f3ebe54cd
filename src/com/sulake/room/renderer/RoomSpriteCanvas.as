package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1536:int = 50;
      
      private static const const_1067:Number = 60;
      ...
      private var var_1510:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2580:Number = -1.0E7;
      
      private var var_2585:Number = -1.0E7;
      ...
      private var var_3076:Boolean = false;
      
      private var var_2584:Array;
      
      private var var_806:int = 0;
      
      private var var_1887:Number = 0.0;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_280.addChild(this.var_111);
         ...
         this.var_281 = new BitmapDataCache(16,32,1);
         var _loc6_:* = null;
         ...
         this.var_774 = new ColorTransform();
      ...
      {
         this.var_543.x -= param1 - this.var_653;
         this.var_653 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_543.y -= param1 - this.var_654;
         this.var_654 = param1;
      }
      ...
      {
         if(param1 && !this.var_1058)
         {
            this.var_1058 = true;
            if(this.var_153 != null && !this.var_280.contains(this.var_153))
            {
               this.var_280.addChild(this.var_153);
               this.var_111.mask = this.var_153;
            }
         }
         else if(!param1 && this.var_1058)
         {
            this.var_1058 = false;
            if(this.var_153 != null && this.var_280.contains(this.var_153))
            {
               this.var_280.removeChild(this.var_153);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_652.length)
            {
               this.cleanSprite(this.var_652[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_652 = [];
         }
      ...
      {
         this.var_1888 = !this.var_1888;
         if(this._container == null || this._geometry == null)
         {
            return;
         }
         if(param1 == this.var_1511)
         {
            return;
         }
         ...
         if(this.var_544 != this.var_2581 || this.var_541 != this.var_2583)
         {
            _loc8_ = true;
         }
         if(this.var_111.x != this.var_653 || this.var_111.y != this.var_654)
         {
            this.var_111.x = this.var_653;
            this.var_111.y = this.var_654;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_2581 = this.var_544;
         this.var_2583 = this.var_541;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1511 > 0)
         {
            _loc2_ = param1 - this.var_1511;
            if(_loc2_ > const_1067 * 3)
            {
               Logger.log("Really slow frame update " + _loc2_ + "ms");
               this.var_2586 = _loc2_;
            }
            if(_loc2_ <= MAXIMUM_VALID_FRAME_UPDATE_INTERVAL)
            {
               ++this.var_807;
               if(this.var_807 == const_389 + 1)
               {
                  this.var_520 = _loc2_;
                  this.var_1887 = this.var_2582;
               }
               else if(this.var_807 > const_389 + 1)
               {
                  _loc3_ = Number(this.var_807 - const_389);
                  this.var_520 = this.var_520 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_1887 = this.var_1887 * (_loc3_ - 1) / _loc3_ + Number(this.var_2582) / _loc3_;
                  if(this.var_807 > const_389 + const_1536)
                  {
                     this.var_807 = const_389;
                     if(!this.var_1233 && this.var_520 > const_1067)
                     {
                        this.var_1233 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1233 && this.var_520 < const_1535)
                     {
                        this.var_1233 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_1888 && this.var_1233);
         ...
         _loc13_ += int(this.var_544 / 2);
         _loc14_ += int(this.var_541 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  ...
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_654;
                  if(this.rectangleVisible(_loc19_,_loc20_,_loc22_.width,_loc22_.height))
                  {
                     ...
                     _loc17_.y = _loc20_ - this.var_654;
      ...
      {
         if(param1 < this.var_544 && param1 + param3 >= 0 && (param2 < this.var_541 && param2 + param4 >= 0))
         {
            if(!this.var_3076)
            {
               return true;
      ...
      private function rectangleVisibleWithExclusion(param1:int, param2:int, param3:int, param4:int) : Boolean
      {
         ...
         if(param1 + param3 >= this.var_544)
         {
            param3 -= this.var_544 + 1 - (param1 + param3);
         }
         if(param2 + param4 >= this.var_541)
         {
            param4 -= this.var_541 + 1 - (param2 + param4);
         }
         for each(_loc5_ in this.var_2584)
         {
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(this.var_652.length > 0)
         {
            _loc3_ = this.var_652.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         if(param1 < this.var_806 || this.var_806 == 0)
         {
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:Boolean, param5:int) : BitmapData
      {
         ...
         if((param3 || param4) && param5 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc6_ = this.var_281.getBitmapData(_loc7_);
            }
            if(_loc6_ == null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_281.addBitmapData(_loc7_,_loc6_);
                  }
                  return _loc6_;
               }
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            {
               finalData = new ExtendedBitmapData(data.width,data.height,true,16777215);
               finalData.copyPixels(data,data.rect,const_710);
            }
            catch(e:Error)
            {
               finalData = new ExtendedBitmapData(1,1,true,16777215);
            }
            this.var_774.redMultiplier = tR;
            this.var_774.greenMultiplier = tG;
            this.var_774.blueMultiplier = tB;
            finalData.colorTransform(finalData.rect,this.var_774);
            if(name.length > 0)
            {
               this.var_281.addBitmapData(cacheName,finalData);
            }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         ...
         if(this.var_1232 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1885;
         }
         this.var_1885 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1232;
         return this.var_1885;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_544 / 2;
         var _loc12_:Number = param2 - this.var_541 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1886,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2580 || param2 != this.var_2585)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
      ...
      {
         if(this.var_387 != null && param1 != null)
         {
            this.var_387.add(param2,param1);
         }
      }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_387 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = this.var_387.getKey(_loc1_);
            _loc3_ = this.var_387.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1510.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
