package com.sulake.habbo.ui.widget.poll
{
   ...
   public class PollWidget extends RoomWidgetBase
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_269.length;
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
               _loc3_ = this.var_269.getWithIndex(0) as PollSession;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      private function showPollOffer(param1:Event) : void
      {
         ...
         var _loc3_:PollSession = this.var_269.getValue(_loc2_) as PollSession;
      ...
      private function showPollContent(param1:Event) : void
      {
         ...
         {
            _loc3_ = _loc2_.id;
            _loc4_ = this.var_269.getValue(_loc3_) as PollSession;
            if(_loc4_ != null)
            {
      ...
      {
         var _loc2_:PollSession = this.var_269.getValue(param1) as PollSession;
         if(_loc2_ != null)
         {
            _loc2_.showThanks();
            _loc2_.dispose();
            this.var_269.remove(param1);
         }
      }
