package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1740:int = 255;
      
      private var var_1608:uint = 16777215;
      
      private var var_2056:int = 255;
      
      private var var_1325:uint = 16777215;
      
      private var var_2054:int = 255;
      
      private var var_1326:int = 0;
      
      private var var_2055:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_641,RoomObjectMouseEvent.const_159];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_840,param1.toString());
            _loc2_.setNumber(RoomObjectVariableEnum.const_1020,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_775,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_924,1);
         ...
         if(this.var_1609)
         {
            if(object != null)
            {
               ...
               if(_loc2_ != null)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_840,_loc3_.toString());
                  _loc2_.setNumber(RoomObjectVariableEnum.const_1222,param1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1326)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1740;
            if(_loc2_ - this.var_1326 >= this.var_2055)
            {
               _loc3_ = this.var_1325;
               _loc4_ = this.var_2054;
               this.var_1326 = 0;
            }
            else
            {
               _loc7_ = this.var_1608 >> 16 & 255;
               _loc8_ = this.var_1608 >> 8 & 255;
               _loc9_ = this.var_1608 & 255;
               _loc10_ = this.var_1325 >> 16 & 255;
               _loc11_ = this.var_1325 >> 8 & 255;
               _loc12_ = this.var_1325 & 255;
               _loc13_ = (_loc2_ - this.var_1326) / this.var_2055;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_2056 + (this.var_2054 - this.var_2056) * _loc13_;
               this._color = _loc3_;
               this.var_1740 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_1020,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_754:
               param2.setString(RoomObjectVariableEnum.const_220,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_795:
               param2.setString(RoomObjectVariableEnum.const_209,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_1014:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_661:
               _loc5_ = "null";
               ...
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_986:
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1399:
               param2.setNumber(RoomObjectVariableEnum.const_775,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1272:
               param2.setNumber(RoomObjectVariableEnum.const_924,_loc3_);
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_695:
               param2.setNumber(RoomObjectVariableEnum.const_1309,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1377:
      ...
      private function updateFloorHoles(param1:RoomObjectRoomFloorHoleUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomFloorHoleUpdateMessage.const_142:
               this._planeParser.addFloorHole(param1.id,param1.x,param1.y,param1.width,param1.height);
               this.var_1609 = true;
               break;
            case RoomObjectRoomFloorHoleUpdateMessage.const_141:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1203,int(param1.bgOnly));
         this.var_1608 = this._color;
         this.var_2056 = this.var_1740;
         this.var_1325 = _loc3_;
         this.var_2054 = _loc4_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_567,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1740,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_2035,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1874,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_567,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_257 || _loc12_ == RoomPlaneData.const_442)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
