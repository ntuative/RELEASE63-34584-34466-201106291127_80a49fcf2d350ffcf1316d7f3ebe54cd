package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      public static const const_188:String = "face";
      ...
      private var var_162:IHabboMessenger;
      
      private var var_161:IHabboConfigurationManager;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_602:IAvatarRenderManager;
      
      private var var_851:ISessionDataManager;
      
      private var var_2725:FriendListLookAndFeel;
      
      private var var_438:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1976:OpenedToWebPopup;
      ...
      private var var_1975:AvatarSearchResults;
      ...
      {
         this.var_2725 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_118 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1975 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_678.stop();
            this.var_678.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_678 = null;
         }
         ...
         if(this.var_162)
         {
            this.var_162.release(new IIDHabboMessenger());
            this.var_162 = null;
         }
         if(this.var_161)
         {
         ...
         if(this.var_851)
         {
            this.var_851.release(new IIDSessionDataManager());
            this.var_851 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1976 = new OpenedToWebPopup(this);
         }
         this.var_1976.show(x,y);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_449);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_367,HabboWindowStyle.const_46,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_602.createAvatarImage(param1,AvatarScaleType.const_107,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         var _loc1_:String = this.var_161.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_161.getKey(param1,param1,param2);
      }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_162 = param2 as IHabboMessenger;
      ...
      {
         this.var_1132 = param2 as IHabboNotifications;
      ...
      {
         this.var_851 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_118.addCategory(new FriendCategory(FriendCategory.const_1197,this.getText("friendlist.friends")));
         this.var_118.addCategory(new FriendCategory(FriendCategory.const_436,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_118.addFriend(new Friend(_loc4_));
         }
         this.var_438 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_678)
         {
            this.var_678 = new Timer(120000);
            this.var_678.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_678.start();
         }
         ...
         {
            _loc5_ = this.var_118.findCategory(FriendCategory.const_436);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_438.findTab(FriendListTab.const_87).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_438.findTab(FriendListTab.const_87);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1975.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_438.findTab(FriendListTab.const_87);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc1_:FriendListTab = this.var_438.findTab(FriendListTab.const_87);
         if(!_loc1_)
         {
            return;
         }
      ...
      {
         if(!this.var_851 || !this.var_124)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_851.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_41))
         {
            _loc2_ = this.var_124.vipLimit;
         }
         else if(this.var_851.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_34))
         {
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ != null && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     _loc5_ = _loc4_.getChildByName(const_188) as IBitmapWrapperWindow;
