package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_1157:Boolean = false;
      
      private static const const_728:String = "Navigation";
      
      private static const const_727:String = "Friend Bar";
      
      private static const const_1722:String = "go.friendbar";
      
      private static const const_1720:String = "chat_btn_click";
      
      private static const const_1719:String = "find_friends_btn_click";
      
      private static const const_1158:String = "Toolbar";
      
      private static const const_1156:String = "open";
      
      private static const const_1159:String = "close";
      
      private static const const_1723:String = "FRIENDLIST";
      
      private static const const_1721:String = "MESSENGER";
       
      
      private var var_1135:IHabboConfigurationManager;
      ...
      private var var_744:IHabboEventStream;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            if(this.var_1135)
            {
               this.var_1135.release(new IIDHabboConfigurationManager());
               this.var_1135 = null;
            }
            if(this.var_95)
            {
            ...
            if(this.var_90)
            {
               if(!this.var_90.disposed)
               {
                  ...
                  this.var_90.events.removeEventListener(FriendRequestEvent.const_233,this.onFriendRequestEvent);
               }
            ...
            if(this.var_744)
            {
               this.var_744.release(new IIDHabboEventStream());
               this.var_744 = null;
            }
            this.var_117 = null;
      ...
      {
         return this.var_353.getValue(param1);
      }
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_95)
         {
            ...
            this.var_95.getHabboMainConnection(null).send(new EventLogMessageComposer(const_728,const_727,const_1722));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_236)
         {
            ...
            if(this.var_95)
            {
               this.var_95.getHabboMainConnection(null).send(new EventLogMessageComposer(const_728,const_727,const_1720));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_95)
         {
            ...
            this.var_95.getHabboMainConnection(null).send(new EventLogMessageComposer(const_728,const_727,const_1719));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         ...
         if(this.var_90)
         {
            if(!this.var_90.disposed)
            {
               ...
               if(this.var_95)
               {
                  this.var_95.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1158,const_1723,!!this.var_90.isOpen() ? const_1156 : const_1159));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_236)
         {
            if(!this.var_236.disposed)
            {
               ...
               if(this.var_95)
               {
                  this.var_95.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1158,const_1721,!!this.var_236.isOpen() ? const_1156 : const_1159));
               }
            }
         }
      }
      ...
      public function toggleOfflineStream() : void
      {
         if(this.var_744)
         {
            ...
            {
               this.var_744.visible = !this.var_744.visible;
            }
         }
      }
      ...
      {
         this.var_1135 = param2 as IHabboConfigurationManager;
         this.var_3027 = this.var_1135.getBoolean("friendbar.notifications.enabled",false);
         this.var_2196 = this.var_1135.getBoolean("friendbar.requests.enabled",false);
      }
      ...
      {
         this.var_744 = param2 as IHabboEventStream;
      }
      ...
      private function onFriendListComponentAvailable(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_90.events.addEventListener(FriendRequestEvent.const_233,this.onFriendRequestEvent);
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         {
            _loc3_ = this.var_353.getValue(_loc8_);
            if(_loc3_)
            {
               this.var_353.remove(_loc8_);
               this.var_117.splice(this.var_117.indexOf(_loc3_),1);
            }
         }
         for each(_loc4_ in _loc6_)
         {
            _loc3_ = this.var_353.getValue(_loc4_.id);
            if(_loc3_)
            {
            ...
            else if(_loc4_.online || const_319)
            {
               ...
               this.var_353.add(_loc3_.id,_loc3_);
            }
         }
         for each(_loc4_ in _loc7_)
         {
            if(_loc4_.online || const_319)
            {
               if(this.var_353.getValue(_loc4_.id) == null)
               {
                  _loc3_ = new FriendEntity(_loc4_.id,_loc4_.name,_loc4_.realName,_loc4_.motto,_loc4_.gender,_loc4_.online,_loc4_.followingAllowed,_loc4_.figure,_loc4_.categoryId,_loc4_.lastAccess);
         ...
         {
            this.var_117 = !!const_319 ? this.sortByNameAndOnlineStatus(this.var_117) : this.sortByName(this.var_117);
         }
         events.dispatchEvent(new FriendBarUpdateEvent());
      }
      ...
      private function onNewConsoleMessage(param1:NewConsoleMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_921));
            this.makeNotification(String(this.var_921),FriendNotification.const_400,null,false,false);
         }
      }
      ...
      private function onRoomInvite(param1:RoomInviteEvent) : void
      {
         ...
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_921));
            this.makeNotification(String(this.var_921),FriendNotification.const_400,null,true,false);
         }
      }
