package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1807:uint = 9;
      
      public static const const_205:uint = 0;
      
      public static const const_221:uint = 1;
      
      public static const const_396:uint = 2;
      
      public static const const_335:uint = 3;
      
      public static const const_614:uint = 4;
      
      public static const const_311:uint = 5;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_1086 = new Map();
         this.var_1346 = false;
         this.var_1771 = param6;
         this.var_760 = true;
         this.state = const_221;
         this.var_60.setup(param1,param3,param4,param6);
         this.var_60.updateItemList(this.var_897);
         this.var_60.updateItemList(this.var_1629);
      ...
      public function close() : void
      {
         if(this.var_760)
         {
            if(this._state != const_205 && this._state != const_311)
            {
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_896 + " OTHER: " + this.var_1346);
         ...
         {
            case const_205:
               if(param1 == const_221 || param1 == const_311)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         if(this.var_301 == null || this.var_301.disposed)
         {
            return _loc1_;
         }
         var _loc4_:int = 0;
         while(_loc4_ < this.var_301.length)
         {
            _loc2_ = this.var_301.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_60.alertPopup(TradingView.const_1385);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_897)
            {
               this.var_896 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1346 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_60.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_897)
            {
               this.var_60.alertPopup(TradingView.const_1302);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_301.length < const_1807)
         {
