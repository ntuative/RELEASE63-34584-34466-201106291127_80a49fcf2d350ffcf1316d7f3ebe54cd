package com.sulake.habbo.ui.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      private static const const_1054:int = 150;
      
      private static const const_1055:int = 250;
      ...
      private var var_2481:BitmapData;
      ...
      private var var_2482:BitmapData;
      
      private var var_2479:BitmapData;
      
      private var var_2478:int = 30;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_42 = param3;
         this.var_2481 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1827 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2477 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1826 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1825 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2482 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2479 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_83 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_367,HabboWindowStyle.const_30,HabboWindowParam.const_64,new Rectangle(0,0,param3.width,param3.height - const_91),null,0,0) as IBitmapWrapperWindow;
         this.var_42.addChild(this.var_83);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_78,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,this.var_42.height - const_91,param3.width,const_91),null,0) as IWindowContainer;
         this.var_42.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_334,HabboWindowStyle.const_46,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_91),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_554:
               this.var_83.blend += param1 / const_1055;
               this._window.blend += param1 / const_1055;
               ...
               break;
            case const_1151:
               this.var_83.blend -= param1 / const_1054;
               this._window.blend -= param1 / const_1054;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         {
            this._window.x = 0;
            this._window.y = this.var_42.height - const_91;
            this._window.width = this.var_42.width;
         }
         if(this._region != null)
         {
            this._region.x = 0;
            this._region.y = this.var_42.height - const_91;
            this._region.width = this.var_42.width - this.var_2478;
         }
         if(this.var_83 != null)
         {
            this.var_83.rectangle = this.var_42.rectangle;
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2480 == this._window.width)
         {
            return;
         }
         this.var_2480 = this._window.width;
         ...
         {
            barHandle.bitmap = this.var_2477;
            barHandle.disposesBitmap = false;
            barX.bitmap = this.var_1826;
            barX.disposesBitmap = false;
            this.var_2478 = this._window.width - barX.x;
         }
         ...
         if(barBg != null && barGripL != null && barGripR != null)
         {
            try
            {
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_2481,destBgBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_1827,destGripLBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_1827,destGripRBitmap);
         ...
         this.var_83.bitmap = this.var_2479;
