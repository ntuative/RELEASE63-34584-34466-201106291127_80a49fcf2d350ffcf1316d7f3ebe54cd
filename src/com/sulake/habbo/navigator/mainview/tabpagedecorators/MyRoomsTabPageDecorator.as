package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_156 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            this.prepareSubNavi();
      ...
      private function startSearch() : void
      {
         ...
         this._navigator.mainViewCtrl.startSearch(Tabs.const_245,this.getSearchTypeForIndex(_loc1_));
      }
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         if(param1 == 1)
         {
            return Tabs.const_990;
         }
         if(param1 == 2)
         {
            return Tabs.const_959;
         }
         if(param1 == 3)
         {
            return Tabs.const_931;
         }
         if(param1 == 4)
         {
            return Tabs.const_944;
         }
         return Tabs.const_267;
      }
