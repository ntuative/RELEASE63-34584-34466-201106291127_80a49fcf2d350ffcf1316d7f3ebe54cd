package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_477)
         {
            this.var_477.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_477.reset();
            this.var_477 = null;
         }
         if(this.var_403)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_59 == null)
         {
            this.var_59 = IWindowContainer(this._navigator.getXmlWindow(this.var_1153));
         ...
         this.var_59.x = _loc2_.x + this.var_2427 + param1.width;
