package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_2509 = parseInt(param1.@precedence);
         this.var_2512 = String(param1.@activepartset);
         this.var_2511 = String(param1.@assetpartdefinition);
         this.var_2510 = String(param1.@lay);
         this.var_782 = String(param1.@geometrytype);
         this.var_2508 = Boolean(parseInt(param1.@main));
         this.var_2515 = Boolean(parseInt(param1.@UserInfoCtrl));
         this.var_2514 = Boolean(parseInt(param1.@animation));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "UserInfoCtrl")
            {
               this.var_2513 = _loc6_;
            }
            else
            {
               this.var_1839[_loc5_] = _loc6_;
            }
         }
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         if(this.var_790.getValue(param1) == null)
         {
            this.var_790.add(param1,new Map());
         }
         var _loc4_:Map = this.var_790.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = this.var_790.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1839[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2513;
         }
         return _loc2_;
      }
