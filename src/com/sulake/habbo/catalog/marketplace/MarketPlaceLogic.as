package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      private var var_2378:MarketplaceItemStats;
      ...
      {
         this.requestOffers(this.var_2385,this.var_2380,this.var_2383,this.var_2384);
      }
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         this.showConfirmation(this.const_2323,_loc2_);
      }
      ...
      public function redeemSoldOffers() : void
      {
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            if(_loc3_.status == MarketPlaceOfferState.const_578)
            {
      ...
      public function onOffers(param1:IMessageEvent) : void
      {
         ...
         this.var_2386 = _loc3_.totalItemsFound;
         if(this._visualization != null)
         {
            this._visualization.listUpdatedNotify();
         }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         this.var_2381 = _loc3_.creditsWaiting;
         for each(_loc4_ in _loc3_.offers)
         {
      ...
      {
         if(param1.furniCategoryId != this.var_2387 || param1.furniTypeId != this.var_2379)
         {
            return;
         }
      ...
      private function isPosterItem(param1:IMarketPlaceOfferData) : Boolean
      {
         ...
         {
            _loc3_ = this._catalog.getFurnitureData(param1.furniId,ProductTypeEnum.const_62);
            if(_loc3_)
            {
               _loc4_ = _loc3_.name;
               if(_loc4_ != null && _loc4_ == const_1457)
               {
                  _loc2_ = true;
               }
            }
      ...
      public function getNameLocalizationKey(param1:IMarketPlaceOfferData) : String
      {
         ...
         if(param1 != null)
         {
            ...
            else if(param1.furniType == MarketPlaceOfferData.const_117)
            {
