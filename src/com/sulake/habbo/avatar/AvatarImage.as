package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1666:String = "Default";
      
      private static const const_1664:int = 2;
      
      private static const const_1665:String = AvatarSetType.const_42;
      ...
      private var var_1101:IActiveActionData;
      ...
      private var var_3017:String = null;
      
      private var var_3016:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1665,const_1664);
         this.var_360 = new Array();
         this.var_1101 = new ActiveActionData(AvatarAction.const_402);
         this.var_1101.definition = this._structure.getActionDefinition(const_1666);
         this.resetActions();
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_741,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_309.length == 1 && this.var_103 == this.var_2075)
         {
            return this.var_103 + this.var_597 + this.var_741 % 4;
         }
         if(this.var_309.length == 2)
         {
            for each(_loc1_ in this.var_309)
            {
               ...
               {
                  return this.var_103 + this.var_597 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_741 % 11;
                  return this.var_103 + "_" + this.var_2075 + this.var_597 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_3015 || param2 != this.var_3017 || param1 != this.var_3016)
         {
            this.var_3015 = param3;
            this.var_3017 = param2;
            this.var_3016 = param1;
            this.var_2194 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1428 || this.var_47 == null || (this.var_47.width != _loc5_.width || this.var_47.height != _loc5_.height))
         {
            if(this.var_47 != null && !this.var_1428)
            {
               this.var_47.dispose();
            }
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_741);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_741);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_360.push(new ActiveActionData(param1,param2,this.var_741));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_315 = this.var_1101;
         this.var_315.definition = this.var_1101.definition;
         this.resetBodyPartCache(this.var_1101);
         return true;
      }
      ...
      private function isHeadTurnPreventedByAction() : Boolean
      {
         ...
         for each(_loc3_ in this.var_309)
         {
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_597 = "";
         this.var_309 = this._structure.sortActions(this.var_360);
         if(this.var_309 == null)
         {
         ...
         {
            this.var_790 = this._structure.getCanvasOffsets(this.var_309,this._scale,this.var_103);
            for each(_loc4_ in this.var_309)
            {
               this.var_597 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_330)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1689 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1689 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1396 != this.var_597)
            {
               _loc1_ = true;
               this.var_1396 = this.var_597;
            }
         }
         this.var_1651 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_309)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_1028 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_2131 = _loc2_.directionData.offset;
                     }
               ...
               if(_loc1_.actionType == AvatarAction.const_342 || _loc1_.actionType == AvatarAction.const_274 || _loc1_.actionType == AvatarAction.const_445)
               {
                  this.var_1028 = true;
               }
            }
