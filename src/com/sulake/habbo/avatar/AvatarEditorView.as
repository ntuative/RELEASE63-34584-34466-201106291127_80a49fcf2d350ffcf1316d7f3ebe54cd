package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1696:IWindowContainer;
      
      public static var var_2203:int = 6710886;
      
      private static const const_1564:int = 5000;
      
      private static const const_1443:Point = new Point(100,30);
      ...
      private var var_338:IFrameWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:Array)
      {
         ...
         var _loc5_:* = null;
         this.var_1249 = [];
         this.var_1534 = [AvatarEditorFigureCategory.const_911,AvatarEditorFigureCategory.const_54,AvatarEditorFigureCategory.const_263,AvatarEditorFigureCategory.const_768,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_110];
         super();
         this.var_23 = param1;
         if(var_1406 == null)
         {
            _loc4_ = this.var_23.manager.assets.getAssetByName("AvatarEditorThumb") as XmlAsset;
            var_1406 = this.var_23.manager.windowManager.buildFromXML(_loc4_.content as XML) as IWindowContainer;
         }
         if(var_1696 == null)
         {
            _loc5_ = this.var_23.manager.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1696 = this.var_23.manager.windowManager.buildFromXML(_loc5_.content as XML) as IWindowContainer;
         }
         this._saveTimer = new Timer(const_1564,1);
         this._saveTimer.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param2 == null)
         {
            param2 = this.var_1534;
         }
         for each(_loc3_ in param2)
         {
            this.var_1249.push(_loc3_);
         }
         this.createWindow();
      }
      ...
      public function getFrame(param1:Array, param2:String = null) : IFrameWindow
      {
         ...
         this.var_86.position = const_1443;
      ...
      public function embedToContext(param1:IWindowContainer, param2:Array) : Boolean
      {
         ...
         else
         {
            if(this.var_666 == null)
            {
               this.var_666 = this.var_23.manager.windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_78,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_666.addChild(this.var_58);
            }
            _loc3_ = this.var_666.getChildIndex(this.var_58);
            if(_loc3_)
            {
               param1.removeChildAt(_loc3_);
            }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1534);
         }
         if(param1.length != this.var_1249.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1249.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function createWindow() : void
      {
         ...
         this.var_251 = this.var_58.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc1_:int = this.var_251.numSelectables - 1;
         while(_loc1_ >= 0)
         {
            _loc2_ = this.var_251.getSelectableAt(_loc1_);
            if(_loc2_ != null && this.var_1249.indexOf(_loc2_.name) < 0)
            {
      ...
      private function attachImages() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:Array = this.var_1534;
      ...
      public function update() : void
      {
         ...
         if(this.var_23.manager.sessionData && this.var_23.manager.sessionData.clubLevel >= HabboClubLevelEnum.const_34 && (this.var_1533 == AvatarEditorSideCategory.const_110 || this.var_2644))
         {
            _loc4_ = "null";
         }
         ...
         this.setViewToCategory(this.var_378);
      }
      ...
      {
         if(this.var_1533 == AvatarEditorSideCategory.const_110)
         {
            this.var_2644 = false;
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_563:
               break;
            case AvatarEditorSideCategory.const_507:
               _loc3_ = this.var_23.getSideContentWindowContainer(AvatarEditorSideCategory.const_507);
               break;
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_338)
         {
            ...
            this.var_338 = this.var_23.manager.windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_338.procedure = this.stripClubDialogEventProc;
            this.var_338.center();
         }
         else
         {
            this.var_338.visible = true;
            this.var_338.center();
         }
      }
      ...
      private function openCatalogClubPage() : void
      {
         ...
         {
            this.var_23.manager.catalog.openCatalogPage(CatalogPageName.const_124,true);
         }
      }
   }
}
