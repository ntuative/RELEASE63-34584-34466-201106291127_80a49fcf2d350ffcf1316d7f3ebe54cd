package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1495:int = 18;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_529 = this.getPetTypeIndexFromProduct(_loc2_.localizationId);
         if(this.var_529 < 8)
         {
            return false;
         }
         this.var_2529 = _loc2_.localizationId;
         ...
         this._offers.add(this.var_529,_loc2_);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_228 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1495 && _loc2_ < this.var_228.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_529,this.var_228[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_529,this.var_376),this.getRaceLocalizationKey(this.var_529,this.var_376));
            }
         }
         return this.getRaceLocalizationKey(this.var_529,this.var_376);
      }
