package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private static const const_1420:String = "purse";
      
      private static const const_1421:String = "extra_tools";
      ...
      private var var_616:ExtraToolsExtension;
      
      private var _connection:IConnection;
      
      private var _catalog:IHabboCatalog;
      
      private var var_1167:PurseExtension;
      
      private var var_1437:ClubDiscountPromoExtension;
      
      private var _localization:ICoreLocalizationManager;
      
      private var var_12:IHabboInventory;
      
      private var var_617:ExtensionView;
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_617 = new ExtensionView(this._windowManager,this._assetLibrary,this);
            if(this.var_617)
            {
               this.var_1167 = new PurseExtension(this._windowManager,this._assetLibrary,this._config,this._catalog,this.var_12,this._localization);
               this.var_616 = new ExtraToolsExtension(this,this._windowManager,this._assetLibrary,events,this._config);
               if(this._config.getBoolean("club.membership.extend.promotion.enabled",false))
               {
                  this.var_1437 = new ClubDiscountPromoExtension(this,this._windowManager,this._assetLibrary,events,this._config,this._localization,this.var_12,this._catalog,this._connection);
               }
               this.var_617.attachExtension(const_1420,this.var_1167.window,ExtensionFixedSlotsEnum.const_1971);
               this.var_617.attachExtension(const_1421,this.var_616.window,ExtensionFixedSlotsEnum.const_1767);
            }
         }
         if(this._view == null)
         {
      ...
      private function toolbarExtensionVisible(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            this.var_616.showRoomInfo();
         }
         else
         {
            this.var_616.hideRoomInfo();
         }
      }
