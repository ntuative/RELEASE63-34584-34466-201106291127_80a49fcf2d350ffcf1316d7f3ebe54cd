package com.sulake.habbo.ui.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_1601:XML;
      
      private var _widget:DimmerFurniWidget;
      
      private var var_697:DimmerViewColorGrid;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_78,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1444,const_1445,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_697 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
         ...
         this.var_297 = ITabContextWindow(this._window.findChildByName("tab_context"));
         this.selectTab(this._widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < this.var_297.numTabItems)
         {
            _loc6_ = this.var_297.getTabItemAt(_loc2_);
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1600 = _loc2_.light;
         if(this.var_487 != null)
         {
            this.var_487.setValue(this.var_1600);
         }
         this.var_585 = this.colors.indexOf(_loc2_.color);
         if(this.var_697 != null)
         {
            this.var_697.setSelectedColorIndex(this.var_585);
         }
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = this.var_297.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            this.var_297.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = this.var_297.selector.getSelected();
         return this.var_297.selector.getSelectableIndex(_loc1_);
      }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1601 = XML(_loc1_.content);
         return this.var_1601;
      }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_697 != null)
         {
            this.var_697.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }
