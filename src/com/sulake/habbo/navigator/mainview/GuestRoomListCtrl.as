package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_536:RoomPopupCtrl;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         this.var_536 = new RoomPopupCtrl(this._navigator,5,-5);
      ...
      {
         this.var_203 = param1;
         this.var_64 = IItemListWindow(this.var_203.findChildByName("item_list"));
         this.var_605 = IScrollbarWindow(this.var_203.findChildByName("scroller"));
      }
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT,this.onMouseOut);
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1943,true);
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         this.var_1228.refreshUserCount(param2.maxUserCount,param1,param2.userCount,"${navigator.usercounttooltip.users}",233,2);
      }
      ...
      private function onMouseOver(param1:WindowEvent) : void
      {
         ...
         if(this.var_536.visible && this.var_2562)
         {
            return;
         }
         ...
         this.var_536.room = _loc4_;
         this.var_536.showPopup(_loc2_);
      }
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         {
            _loc2_ = this.var_1500.tags[0];
            this.var_1500.color = this.getBgColor(_loc2_);
         }
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2561 - _loc2_.stageX);
         this.var_2561 = _loc2_.stageX;
         this.var_2562 = _loc3_ > 2;
      }
   }
}
