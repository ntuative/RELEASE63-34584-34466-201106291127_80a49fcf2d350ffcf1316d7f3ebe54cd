   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         try
         {
            ...
            {
               Core.error("Could not load avatar structure, got empty data from URL " + loaderStruct.assetLoader.url + " data length = " + data.length + ".",false,Core.const_215);
            }
            this.var_1849 = new XML(data);
         }
         catch(e:Error)
         {
         ...
         this.var_2530.appendXML(this.var_1849);
      ...
      private function onDataFailed(param1:Event) : void
      {
         ...
         Core.error("Could not load avatar structure. Failed to get data from URL " + _loc3_,false,Core.const_215);
      }
   }
}
