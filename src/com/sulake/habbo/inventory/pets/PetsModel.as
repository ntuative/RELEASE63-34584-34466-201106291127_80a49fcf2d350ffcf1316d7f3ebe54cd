package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      {
         if(param1 == InventoryCategory.const_131 && this.var_27.isVisible)
         {
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            this.var_1858 = this._roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_28,RoomObjectTypeEnum.const_219,_loc3_.figureString);
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(this.var_1858 && param1.type == RoomEngineObjectEvent.const_146)
         {
      ...
      public function addUnseenPets(param1:Array) : void
      {
         ...
         {
            if(this.var_532.indexOf(_loc2_) == -1)
            {
               this.var_532.push(_loc2_);
            }
         }
         this._view.update();
      }
      ...
      public function resetUnseenItems() : void
      {
         ...
         var _loc1_:IConnection = this._communication.getHabboMainConnection(null);
         if(this.var_532 && this.var_532.length > 0)
         {
            _loc1_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_56));
            this.var_532 = [];
            this._view.update();
      ...
      {
         return this.var_532.indexOf(param1) > -1;
      }
   }
}
