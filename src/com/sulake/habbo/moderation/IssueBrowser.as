package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2373:String = "open_issues";
      
      private const const_2372:String = "picked_issues";
      ...
      private var var_412:IIssueBrowserView;
      
      private var var_2073:IIssueBrowserView;
      
      private var var_2072:IIssueBrowserView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_297 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_297.numTabItems)
            {
               _loc5_ = this.var_297.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_47,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_297 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_297 == null || this.var_297.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_297.selector.getSelectableByName("open_issues");
         this.var_297.selector.setSelected(_loc1_);
      }
      
      private function selectView(param1:String) : void
      {
         var _loc2_:IIssueBrowserView = this.getView(param1);
         if(this.var_412 == _loc2_)
         {
            return;
         }
         ...
         this.var_412.view.width = this.var_297.container.width;
         this.var_412.view.height = this.var_297.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2374:
               ...
               {
                  this.var_2073 = new MyIssuesView(this.issueManager,this,this.var_297.container);
               }
               return this.var_2073;
            case this.const_2373:
               if(this.var_2072 == null)
               {
                  this.var_2072 = new OpenIssuesView(this.issueManager,this,this.var_297.container);
               }
               return this.var_2072;
            case this.const_2372:
               if(this.var_2074 == null)
               {
                  this.var_2074 = new PickedIssuesView(this.issueManager,this,this.var_297.container);
               }
