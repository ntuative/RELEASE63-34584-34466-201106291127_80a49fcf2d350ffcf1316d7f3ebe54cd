package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_2098:String = "no_reqs_info";
      ...
      private var var_1997:IContainerButtonWindow;
      
      private var var_1998:IContainerButtonWindow;
      ...
      {
         this.var_1997 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1998 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1998.procedure = this.onDismissAllButtonClick;
         this.var_1997.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_399;
      ...
      public function acceptAllRequests() : void
      {
         ...
         for each(_loc2_ in this._friendList.friendRequests.requests)
         {
            if(_loc2_.state != FriendRequest.const_399 && _loc2_.state != FriendRequest.const_413)
            {
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_413;
         ...
         if(this._friendList && this._friendList.events)
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_233,param1));
         }
      }
      ...
      public function declineAllRequests() : void
      {
         ...
         for each(_loc2_ in this._friendList.friendRequests.requests)
         {
            if(_loc2_.state != FriendRequest.const_399 && _loc2_.state != FriendRequest.const_413)
            {
               ...
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_233,_loc2_.requestId));
               }
            }
         }
         this.refresh();
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1997,_loc1_);
         this.setEnabled(this.var_1998,_loc1_);
      }
