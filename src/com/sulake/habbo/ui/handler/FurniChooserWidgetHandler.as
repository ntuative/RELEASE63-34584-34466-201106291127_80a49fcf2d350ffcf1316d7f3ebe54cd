package com.sulake.habbo.ui.handler
{
   ...
   public class FurniChooserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_515);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_515:
            ...
            case RoomWidgetRoomObjectMessage.const_379:
               ...
               if(_loc2_.category == RoomObjectCategoryEnum.const_26 || _loc2_.category == RoomObjectCategoryEnum.const_25)
               {
      ...
      private function handleFurniChooserRequest() : void
      {
         ...
         var _loc3_:* = [];
         var _loc9_:int = this._container.roomEngine.getRoomObjectCount(_loc1_,_loc2_,RoomObjectCategoryEnum.const_26);
         _loc4_ = 0;
         while(_loc4_ < _loc9_)
         {
            ...
            if(_loc8_ != null)
            {
               _loc5_ = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_268);
         ...
         this._container.events.dispatchEvent(new RoomWidgetChooserContentEvent(RoomWidgetChooserContentEvent.const_826,_loc3_,this._container.sessionDataManager.isAnyRoomController));
      }
