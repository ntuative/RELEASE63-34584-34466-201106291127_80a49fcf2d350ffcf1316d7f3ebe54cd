package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_1147:Boolean = true;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_189 = var_506 || !testParamFlag(WindowParam.const_32);
         this._container = _context.create("_CONTAINER","",WindowType.const_394,WindowStyle.const_100,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         ...
         this._container.addEventListener(WindowEvent.const_169,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_206,this.containerEventHandler);
         this._container.clipping = clipping;
         this.resizeOnItemUpdate = this.var_1419;
      }
      ...
      {
         return new Rectangle(this.var_751 * this.maxScrollH,this.var_750 * this.maxScrollV,width,height);
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            if(this._horizontal)
            {
               this._container.setParamFlag(WindowParam.const_650,param1);
            }
            else
            {
               this._container.setParamFlag(WindowParam.const_625,param1);
            }
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_169,this.containerEventHandler);
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_185:
               if(this.var_1417)
               {
                  this.var_1418 = this.var_2252 - _loc3_;
                  this.var_1416 = this.var_2254 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1418 != 0 && this.var_125 != 0)
                     {
                        this.scrollH += this.var_1418 / this.var_125;
                     }
                  }
                  else if(this.var_1416 != 0 && this.var_109 != 0)
                  {
                     this.scrollV += this.var_1416 / this.var_109;
                  }
                  this.var_2252 = _loc3_;
                  this.var_2254 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_262:
               if(this.var_1417)
               {
                  if(this._horizontal)
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1418,0);
                  }
                  else
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1416);
                  }
                  this.var_1417 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1147 && !this.var_606 && this._container)
         {
            this.var_606 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_748)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_418,this._spacing,PropertyStruct.const_36,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1365);
         }
         if(this.var_1147 != PropertyDefaults.const_1175)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_764,this.var_1147,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_2013);
         }
         if(this.var_505 != PropertyDefaults.const_1312)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_729,this.var_505,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1735);
         }
         if(this.var_1419 != PropertyDefaults.const_1244)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_801,this.var_1419,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1920);
         }
         if(this.var_749 != PropertyDefaults.const_1370)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_972,this.var_749,PropertyStruct.const_129,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1766);
         }
         if(this.var_748 != PropertyDefaults.const_1397)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_933,this.var_748,PropertyStruct.const_129,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1994);
         }
         return _loc1_;
      }
