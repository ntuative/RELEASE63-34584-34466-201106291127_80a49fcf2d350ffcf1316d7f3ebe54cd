package com.sulake.core.utils
{
   ...
   public class FontEnum
   {
      ...
      private static const const_683:Map = new Map();
      
      private static const const_387:Map = new Map();
      
      private static var var_1220:Boolean = false;
      ...
      {
         return const_683.getValue(param1) != null;
      }
      ...
      private static function init() : void
      {
         ...
         if(!var_1220)
         {
            ...
            for each(_loc3_ in _loc1_)
            {
               ...
               {
                  const_683.add(_loc3_.fontName,_loc3_);
               }
            }
            var_1220 = true;
         }
