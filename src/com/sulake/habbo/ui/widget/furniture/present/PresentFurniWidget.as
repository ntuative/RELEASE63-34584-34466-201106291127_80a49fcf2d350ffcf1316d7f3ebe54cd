package com.sulake.habbo.ui.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_654,this.onObjectUpdate);
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_655,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_654,this.onObjectUpdate);
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_655,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomWidgetPresentDataUpdateEvent.const_610:
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_655:
               if(!this.var_404)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_654:
               if(!this.var_404)
               {
                  return;
               }
      ...
      {
         var _loc1_:* = null;
         if(this.var_404 || this.var_237 == -1 || !this.var_27)
         {
            return;
         }
         this.var_404 = true;
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_194,this.var_237);
