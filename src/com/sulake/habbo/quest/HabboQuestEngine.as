package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private static const const_1639:int = 5;
      
      private static const const_1638:int = 800;
      
      private static const const_1640:int = 15;
      
      private static const const_1637:int = 300;
      ...
      private var var_1304:QuestController;
      
      private var var_1064:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1304 = new QuestController(this);
         this.var_1064 = new AchievementController(this);
         ...
         registerUpdateReceiver(this,const_1639);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_416.events.removeEventListener(BadgeImageReadyEvent.const_208,this.var_1064.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_416.events.addEventListener(BadgeImageReadyEvent.const_208,this.var_1064.onBadgeImageReady);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_48)
         {
            ...
            {
               this.var_1304.onToolbarClick();
            }
            if(param1.iconId == HabboToolbarIconEnum.ACHIEVEMENTS)
            {
               this.var_1064.onToolbarClick();
            }
         }
      }
      ...
      {
         return this.var_1304.questTracker.isVisible();
      }
