package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1299:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_686 = new Timer(100);
         this.var_686.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
      ...
      public function dispose() : void
      {
         if(this.var_686)
         {
            this.var_686.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_686.reset();
            this.var_686 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1299.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_2018 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_2018 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_1300 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_203.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1300.goBackToInitialState();
         this.var_1300.input.textBackgroundColor = 4294967295;
         this.var_1299 = this.var_45[0];
         this.refreshRoomThumbnails();
      ...
      {
         return Boolean(this.var_1300.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1300.getText();
         var _loc3_:String = "model_" + this.var_1299.name;
