package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1039:uint = 8;
      
      private static const const_1423:String = "skin";
      
      private static const const_1425:String = "bitmap";
      
      private static const const_1426:String = "fill";
      
      private static const const_1424:String = "text";
      
      private static const const_1427:String = "label";
      
      private static const const_1422:String = "shape";
      
      private static const RENDERER_TYPE_UNKNOWN:String = "unknown";
      
      private static const RENDERER_TYPE_NULL:String = "null";
      
      protected static var var_361:Array;
      ...
      private var var_2295:Dictionary;
      
      private var var_2297:Dictionary;
      
      private var var_2296:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_2295 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1738,this.var_2295);
         this.var_2297 = new Dictionary();
         this.var_2296 = new Dictionary();
         StateCodeTable.fillTables(this.var_2297,this.var_2296);
         this.var_439 = new Dictionary();
         this.var_439[const_1423] = BitmapSkinRenderer;
         this.var_439[const_1425] = BitmapDataRenderer;
         this.var_439[const_1426] = FillSkinRenderer;
         this.var_439[const_1424] = TextSkinRenderer;
         this.var_439[const_1427] = LabelRenderer;
         this.var_439[const_1422] = ShapeSkinRenderer;
         this.var_439[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_439[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_361 == null)
         {
            var_361 = new Array();
            var_361.push(WindowState.const_73);
            var_361.push(WindowState.const_90);
            var_361.push(WindowState.const_94);
            var_361.push(WindowState.const_57);
            var_361.push(WindowState.const_92);
            var_361.push(WindowState.const_86);
            var_361.push(WindowState.const_89);
            var_361.push(WindowState.const_101);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_3035 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_1738[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_946[param1] == null)
         {
            this.var_946[param1] = new Array(const_1039);
         }
         this.var_946[param1][param2] = param3;
         if(this.var_947[param1] == null)
         {
            this.var_947[param1] = new Array(const_1039);
         }
         this.var_947[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_946[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_100)
            {
               _loc4_ = _loc3_["null"];
            }
         }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_947[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_100)
