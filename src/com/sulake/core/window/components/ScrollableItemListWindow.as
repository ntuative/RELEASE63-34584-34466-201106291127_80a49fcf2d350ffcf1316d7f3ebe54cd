package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1192:IItemListWindow;
      
      private var var_444:IScrollbarWindow;
      ...
      public function ScrollableItemListWindow(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(this._scrollBar.testStateFlag(WindowState.const_90))
         {
            this.hideScrollBar();
         }
      }
      ...
      override public function dispose() : void
      {
         if(this.var_444)
         {
            this.var_444.removeEventListener(WindowEvent.const_290,this.scrollBarEventProc);
            this.var_444.removeEventListener(WindowEvent.const_280,this.scrollBarEventProc);
            this.var_444 = null;
         }
         if(this.var_1192)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1192)
         {
            this.var_1192 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_444)
         {
            this.var_444 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_444)
            {
               this.var_444.addEventListener(WindowEvent.const_290,this.scrollBarEventProc);
               this.var_444.addEventListener(WindowEvent.const_280,this.scrollBarEventProc);
            }
         }
         return this.var_444;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_280)
         {
            this.hideScrollBar();
         }
      }
