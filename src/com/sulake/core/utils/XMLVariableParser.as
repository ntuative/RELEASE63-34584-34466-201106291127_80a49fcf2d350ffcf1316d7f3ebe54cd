package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_1883:String = "float";
      
      public static const const_38:String = "Boolean";
      
      public static const const_2031:String = "bool";
      ...
      private static const const_2091:String = "false";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         else
         {
            ...
            else if(_loc5_ == const_302 || _loc5_ == const_143)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_175:
               return uint(param1);
            case const_143:
               return param1.split(const_1514);
            default:
