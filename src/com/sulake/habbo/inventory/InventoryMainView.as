package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private static const const_471:int = 3;
      ...
      private var var_2567:IWindowContainer;
      ...
      private const const_2087:Point = new Point(120,150);
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         this.var_27.inventoryViewOpened(this.var_802);
      }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_802);
      }
      ...
      private function resetUnseenCounters(param1:String) : void
      {
         switch(param1)
         {
            ...
            case InventoryCategory.const_131:
               ...
               break;
            case InventoryCategory.const_228:
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(this.var_1874);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_385 == InventoryCategory.const_131)
            {
               this.toggleCategoryView(InventoryCategory.const_131);
            }
            else if(this.var_385 == InventoryCategory.const_75)
            {
      ...
      private function updateUnseenBadgeCount() : void
      {
         if(!this.var_1875)
         {
            this.var_1875 = this.createCounter("badges");
         }
         var _loc1_:int = this.var_27.badgesModel.getUnseenItemCount();
         this.updateCounter(this.var_1875,_loc1_);
      ...
      private function createCounter(param1:String) : IWindowContainer
      {
         ...
         if(_loc4_)
         {
            ...
            _loc3_.x = _loc4_.width - _loc3_.width - const_471;
            _loc3_.y = const_471;
         }
         return _loc3_;
      }
