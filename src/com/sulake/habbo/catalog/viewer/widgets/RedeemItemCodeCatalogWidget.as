package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1007.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_1007 = null;
         }
         if(this.var_1008 != null)
         {
            this.var_1008.removeEventListener(WindowKeyboardEvent.const_189,this.windowKeyEventProcessor);
            this.var_1008 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1007 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_1007 != null)
         {
            this.var_1007.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_1008 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1008 != null)
         {
            this.var_1008.addEventListener(WindowKeyboardEvent.const_189,this.windowKeyEventProcessor);
         }
         return true;
      }
