package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_521:IKeyExchange;
      
      private var var_963:String;
      
      private var _view:HabboLoginDemoView;
      
      private var var_2355:PseudoRandom;
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_623 = param1;
            this.var_62.initConnection(HabboConnectionType.const_292);
         }
      }
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_623 = this.var_151.getKey("sso.ticket",null);
         this.var_1776 = this.var_151.getKey("flash.client.url","");
         this.var_2357 = this.var_151.getKey("external.variables.txt","");
         if(this.var_240 == null)
         {
            this.var_240 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         }
         if(_loc4_)
         {
            this.var_62.mode = HabboConnectionType.const_96;
            if(this.var_623)
            {
               this.var_62.initConnection(HabboConnectionType.const_292);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc5_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_794,this.onInitConnection);
            }
            else
            {
               Core.crash("Login without an SSO ticket is not supported",Core.const_1808);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_62.mode = HabboConnectionType.const_1201;
            }
         }
         this.var_62.initConnection(HabboConnectionType.const_292);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_789);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2355 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_62.mode)
         {
            case HabboConnectionType.const_96:
               ...
               this.var_1459 = _loc4_;
               this.var_240.loadBannerImage(_loc7_ + "?token=" + this.var_1459,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1201:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1985:
               this.var_963 = this.generateRandomHexString(30);
               this.var_521 = new DiffieHellman(new BigInteger(this.var_151.getKey("connection.development.prime"),16),new BigInteger(this.var_151.getKey("connection.development.generator"),16));
               this.var_521.init(this.var_963);
               _loc8_ = this.var_521.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_521.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_521.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2355);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1776,this.var_2357));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_2080,"/");
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_271);
      }
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2356)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1459);
         ...
         this.var_521 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_521.init(_loc14_);
            _loc15_ = this.var_521.getPublicKey(10);
