package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      private var var_132:GuestRoomData;
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2602 = new RoomThumbnailRenderer(param1);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         this.refreshRoomName(this.var_200,this.var_132);
         if(this.var_132.ownerName != "" && this.var_132.ownerName != "-")
         {
         }
         this.refreshOwnerName();
         this.refreshTextWithCaption("roomctg",this.var_200,!!this.var_132.event ? this.getEventCtg(this.var_132.categoryId) : this.getRoomCtg(this.var_132.categoryId));
         this.refreshRoomDesc(this.var_200,this.var_132);
         this.refreshExtraCont();
         this.refreshInfo(this.var_200,"trading_allowed",this.var_132.allowTrading);
         this.refreshInfo(this.var_200,"doormode_doorbell",this.var_132.doorMode == 1);
         this.refreshInfo(this.var_200,"doormode_password",this.var_132.doorMode == 2);
      ...
      {
         this.refreshTextWithCaption("roomowner",this.var_200,this.var_132.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_1120.refreshTags(_loc1_,this.var_132.tags);
         this.refreshTextWithCaption("rating",_loc1_,"" + this.var_132.score);
         if(this.var_132.event)
         {
            this.refreshTextWithCaption("startedat",_loc1_,"" + this.var_132.eventCreationTime);
         }
         this.var_2602.refreshThumbnail(_loc1_,this.var_132.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_258,Tabs.const_458,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
