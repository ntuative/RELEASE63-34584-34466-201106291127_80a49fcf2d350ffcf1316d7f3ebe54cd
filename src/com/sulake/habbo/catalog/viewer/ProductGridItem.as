package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_1117:String = "bg";
       
      
      protected var _view:IWindowContainer;
      
      private var var_223:IItemGrid;
      
      protected var _icon:IBitmapWrapperWindow;
      
      private var _disposed:Boolean = false;
      
      private var var_561:Object;
      ...
      {
         this._view.getChildByName(const_1117).style = HabboWindowStyle.const_30;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_1117).style = 3;
      }
      ...
      public function setDraggable(param1:Boolean) : void
      {
         ...
         {
            (this._view as IInteractiveWindow).setMouseCursorForState(WindowState.const_92,MouseCursorType.const_822);
            (this._view as IInteractiveWindow).setMouseCursorForState(0 | 0,MouseCursorType.const_822);
         }
      }
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_45)
         {
            ...
            this.var_223.select(this);
            this.var_561 = param2;
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT && this.var_561 != null && this.var_561 == param2)
         {
            _loc3_ = this.var_223.startDragAndDrop(this);
            if(_loc3_)
            {
               this.var_561 = null;
            }
