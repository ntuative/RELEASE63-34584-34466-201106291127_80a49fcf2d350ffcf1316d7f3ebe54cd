package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1574:uint = 13232628;
      
      private static var var_2004:uint = 11129827;
      ...
      private var var_1291:NameSuggestionListRenderer;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_2005 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_860)
         {
            this.var_860 = this.var_27.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_860)
            {
               return;
            }
            this._window.content.addChild(this.var_860);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_861)
         {
            this.var_861 = this.var_27.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_861)
            {
               return;
            }
         ...
         var _loc1_:ITextWindow = this.var_861.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1139 || param1 == ChangeUserNameResultMessageEvent.var_1140)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1291 = new NameSuggestionListRenderer(this.var_27);
         var _loc6_:int = this.var_1291.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1574;
