package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniGridView
   {
      ...
      private var var_223:IItemGridWindow;
      
      private var var_561:IWindow;
      ...
      public function FurniGridView(param1:FurniModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         if(this._view != null)
         {
            this.var_223 = this._view.findChildByName("item_grid") as IItemGridWindow;
         }
      }
      ...
      public function clearGrid() : void
      {
         ...
         {
            this.var_223.removeGridItems();
         }
      }
      
      public function updateItem(param1:int, param2:IWindowContainer) : void
      {
         var _loc3_:IWindow = this.var_223.getGridItemAt(param1);
         if(_loc3_)
         {
            _loc3_ = param2;
         }
      ...
      {
         this.var_223.addGridItem(param1);
         param1.procedure = this.itemEventProc;
      }
      
      public function addItemAt(param1:IWindowContainer, param2:int) : void
      {
         this.var_223.addGridItemAt(param1,param2);
         param1.procedure = this.itemEventProc;
      }
      
      public function method_4(param1:int) : IWindow
      {
         return this.var_223.removeGridItemAt(param1);
      }
      
      public function moveItemTo(param1:IWindowContainer, param2:int) : void
      {
         this.var_223.removeGridItem(param1);
         this.var_223.addGridItemAt(param1,param2);
      }
      ...
      public function setLock(param1:Boolean) : void
      {
         if(param1)
         {
            this.var_223.autoArrangeItems = false;
            this.var_223.lock();
         }
         else
         {
            this.var_223.autoArrangeItems = true;
            this.var_223.unlock();
         }
      }
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_45)
         {
            ...
            this.var_78.toggleItemSelection(this._category,this.var_223.getGridItemIndex(param1.window));
            this.var_561 = param2;
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT && this.var_561 != null && this.var_561 == param2 && !this.var_78.isTradingOpen)
         {
