package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureJukeboxLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_559,RoomObjectFurnitureActionEvent.const_628,RoomObjectFurnitureActionEvent.const_519,RoomObjectFurnitureActionEvent.const_560,RoomObjectWidgetRequestEvent.const_164];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(object.getModelController().getNumber(RoomObjectVariableEnum.const_1021) == 1)
         {
            object.getModelController().setString(RoomWidgetInfostandExtraParamEnum.const_460,RoomWidgetInfostandExtraParamEnum.const_649);
