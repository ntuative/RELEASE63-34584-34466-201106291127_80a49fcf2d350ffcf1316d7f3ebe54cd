package com.sulake.habbo.ui.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_698:String = "welcome_gift_email_unverified";
      
      private const const_1084:String = "welcome_gift_email_verified";
      
      private const const_1565:String = "welcome_gift_email_change";
      
      private const const_2367:int = 4;
      ...
      private function createMainView() : void
      {
         ...
         {
            this.setViewState(this.const_698);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_698:
               ...
               this._view.findChildByName("edit_text").visible = this.var_1030;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_29,this.var_1030);
               break;
            ...
            case this.const_1565:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_1030);
               _loc6_ = this._view.findChildByName("email_input") as ITextFieldWindow;
               _loc6_.caption = this.var_1535;
               _loc6_.focus();
      ...
      {
         this.setViewState(this.const_1565);
      }
      
      private function openGift(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_885,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1250 ? this.const_1084 : this.const_698);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1536 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1536));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_751,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_751,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_528:
               this.var_1535 = param1.email;
               this.var_1250 = param1.isVerified;
               this.var_1030 = param1.allowEmailChange;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1535 = this.var_1536;
            this.setViewState(this.const_698);
         }
         else
         {
            if(param1.result == this.const_2367)
            {
               this.var_1030 = false;
            }
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1536);
