package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class Tab implements ITab
   {
      ...
      public static var var_2201:IHabboLocalizationManager;
      
      public static var var_2206:TextCropper;
      ...
      {
         if(this.disposed || this.method_3)
         {
            return;
         }
         if(this.selected)
      ...
      {
         if(this.disposed || this.method_3 || this._window == null)
         {
            return;
         }
         if(!this.selected)
