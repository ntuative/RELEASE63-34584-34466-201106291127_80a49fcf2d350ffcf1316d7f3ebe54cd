package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureRoomBrandingVisualization extends FurnitureVisualization
   {
      ...
      private static const const_1502:String = "branded_image";
      ...
      private static const const_1501:int = 3;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc2_)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  this.var_1702 = _loc4_.getNumber(RoomObjectVariableEnum.const_524);
                  this.var_1701 = _loc4_.getNumber(RoomObjectVariableEnum.const_494);
                  this._paramOffsetZ = _loc4_.getNumber(RoomObjectVariableEnum.const_621);
               }
            }
         }
         if(!this.var_1414)
         {
            this.var_1414 = this.checkIfImageReady();
            if(this.var_1414)
            {
               this.checkAndCreateImageForCurrentState(param1);
               return true;
      ...
      protected function checkIfImageChanged() : Boolean
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               _loc3_ = _loc2_.getString(RoomObjectVariableEnum.const_378);
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc4_ = _loc2_.getNumber(RoomObjectVariableEnum.const_549);
                     if(_loc4_ == 1)
                     {
