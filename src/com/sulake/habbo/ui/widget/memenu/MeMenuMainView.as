package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuMainView implements IMeMenuView
   {
      ...
      public function init(param1:MeMenuWidget, param2:String) : void
      {
         ...
         this.var_185["rooms_icon"] = ["gohome_white","gohome_color"];
         this.var_185["dance_icon"] = ["dance_white","dance_color"];
         this.var_185["clothes_icon"] = ["clothes_white","clothes_color"];
         this.var_185["effects_icon"] = ["effects_white","effects_color"];
         this.var_185["badges_icon"] = ["badges_white","badges_color"];
         this.var_185["wave_icon"] = ["wave_white","wave_color"];
         this.var_185["hc_icon"] = ["_white","_color"];
         this.var_185["settings_icon"] = ["settings_white","settings_color"];
         this.var_185["credits_icon"] = ["credits_white","credits_color"];
         this.var_185["news_icon"] = ["news_white","news_color"];
         this._widget = param1;
      ...
      {
         if(this.var_185[param1] == null)
         {
            return;
         }
         if(param3 != null)
         {
            this.var_185[param1][0] = param3;
         }
         if(param4 != null)
         {
            this.var_185[param1][1] = param4;
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         for(_loc4_ in this.var_185)
         {
            _loc7_ = this.var_185[_loc4_];
         ...
         while(_loc6_ < this._window.numChildren)
         {
            ...
            _loc5_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT,this.onMouseOverOrOut);
            _loc6_++;
         }
      }
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               this._widget.changeView(MeMenuWidget.const_1245);
               break;
            case "wave":
               if(this._widget.hasEffectOn)
               {
               ...
               if(this._widget.isDancing)
               {
                  this._widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_1401));
            ...
            case "effects":
               ...
               this._widget.messageListener.processWidgetMessage(new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_411));
               this._widget.hide();
               break;
            case "rooms":
               ...
               break;
            case "badges":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_1300));
               this._widget.hide();
               break;
            case "clothes":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetAvatarEditorMessage(RoomWidgetAvatarEditorMessage.const_633));
               this._widget.hide();
               break;
            case "hc":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1279));
               this._widget.hide();
               break;
            case "settings":
