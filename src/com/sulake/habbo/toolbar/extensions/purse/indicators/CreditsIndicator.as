package com.sulake.habbo.toolbar.extensions.purse.indicators
{
   ...
   public class CreditsIndicator extends CurrencyIndicatorBase
   {
      ...
      private static const const_1440:uint = 4291993382;
      
      private static const const_1442:uint = 4290807040;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(PurseEvent.const_132,this.onCreditBalance);
      }
      ...
      private function onCreditBalance(param1:PurseEvent) : void
      {
         ...
         if(this.var_2117 != -1)
         {
            if(this.var_2117 > param1.balance)
            {
