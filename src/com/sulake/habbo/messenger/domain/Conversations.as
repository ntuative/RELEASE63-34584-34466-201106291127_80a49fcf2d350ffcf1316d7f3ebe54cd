package com.sulake.habbo.messenger.domain
{
   ...
   public class Conversations
   {
      ...
      private static var var_1305:int = 1;
       
      
      private var var_485:IConversationsDeps;
      ...
      public function setSelected(param1:Conversation) : void
      {
         ...
         while(this._startIndex + this.var_485.getTabCount() <= _loc2_)
         {
            ++this._startIndex;
         }
      }
      ...
      public function addConversation(param1:int) : Conversation
      {
         ...
         if(_loc2_)
         {
            _loc3_.addMessage(new Message(Message.const_900,0,this.var_485.getText("messenger.moderationinfo"),""));
         }
         return _loc3_;
      }
      ...
      public function addMessageAndUpdateView(param1:Message) : void
      {
         ...
         this.var_485.addMsgToView(_loc3_,param1);
         if(_loc2_ != this.var_159.length || _loc4_ != _loc3_.newMessageArrived)
         {
            this.var_485.refresh(false);
         }
      }
      ...
      public function setOnlineStatusAndUpdateView(param1:int, param2:Boolean) : void
      {
         ...
         this.var_485.addMsgToView(_loc3_,_loc4_);
      }
      ...
      private function addConversationInt(param1:int) : Conversation
      {
         ...
         _loc2_ = this.var_485.createConversation(param1);
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      {
         this._startIndex = Math.min(this._startIndex,this.var_159.length - this.var_485.getTabCount());
      ...
      {
         return this.var_485.getText(!!param1 ? "messenger.notification.online" : "messenger.notification.offline");
      }
   }
}
