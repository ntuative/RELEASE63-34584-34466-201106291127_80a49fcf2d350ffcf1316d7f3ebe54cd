package com.sulake.habbo.ui.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_519:Sprite = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_519.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_519 = null;
         }
         if(this.var_47 != null)
         {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetInterstitialUpdateEvent.const_114,this.onShowInterstitial);
         param1.addEventListener(RoomWidgetLoadingBarUpdateEvent.const_114,this.onShowLoadingBar);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetInterstitialUpdateEvent.const_114,this.onShowInterstitial);
         param1.removeEventListener(RoomWidgetLoadingBarUpdateEvent.const_114,this.onShowLoadingBar);
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         if(this.var_519 == null)
         {
            this.var_519 = new Sprite();
            this.var_519.addChild(new Bitmap(this.var_47));
            this.var_519.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_519.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_47;
            }
         }
         _loc2_.setDisplayObject(this.var_519);
      ...
      {
         if(param1 == null || param1.type != RoomWidgetLoadingBarUpdateEvent.const_114)
         {
            return;
         }
         if(!this.createWindow())
      ...
      private function clickHandler(param1:Event) : void
      {
         if(this.var_1263 != "")
         {
            HabboWebTools.openWebPage(this.var_1263);
         }
      }
   }
}
