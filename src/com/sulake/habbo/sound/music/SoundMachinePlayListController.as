package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      private var var_246:HabboMusicController;
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_246 = param2;
         this.var_766 = [];
         this.var_766.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_766.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         ...
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_1025,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_92)
            {
               ...
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_1025,this.onSoundMachineStopEvent);
               this.var_92 = null;
            }
            this._disposed = true;
         }
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         {
            this.playCurrentSongAndNotify(this.var_492);
            _loc2_ = this.getNextEntry();
            if(_loc2_ != null)
            {
               this.var_246.addSongInfoRequest(_loc2_.id);
            }
         }
      }
      ...
      public function stopPlaying() : void
      {
         this.var_492 = -1;
         this.var_710 = false;
         this.var_246.stop(HabboMusicPrioritiesEnum.const_122);
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         while(_loc3_ < this._playListEntries.length)
         {
            ...
            {
               _loc4_ = this.var_246.getSongInfo(param1.id) as SongDataEntry;
               if(_loc4_ != null)
               {
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_246.playSong(param1,HabboMusicPrioritiesEnum.const_122,_loc3_,0,0,0))
         {
