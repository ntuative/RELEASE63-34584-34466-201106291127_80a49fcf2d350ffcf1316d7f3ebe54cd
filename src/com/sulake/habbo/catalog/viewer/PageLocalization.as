package com.sulake.habbo.catalog.viewer
{
   ...
   public class PageLocalization implements IPageLocalization
   {
      ...
      private static const const_1498:Array = ["ctlg_header_text","ctlg_description","ctlg_special_txt","ctlg_text_1","ctlg_text_2"];
      
      private static const const_1497:Array = ["ctlg_header_img","ctlg_teaserimg_1","ctlg_special_img","ctlg_teaserimg_2","ctlg_teaserimg_3"];
      ...
      private static const const_179:Dictionary = new Dictionary();
      
      private static const const_1060:Object = {"frontpage3":[7,8]};
      
      private static const const_1061:Object = {"frontpage3":[["ctlg_txt1","ctlg_txt2"],["ctlg_txt3"]]};
      
      {
         const_179["frontpage3"] = ["ctlg_txt3","ctlg_txt7"];
         const_179["info_pixels"] = ["ctlg_text_5","ctlg_text_7"];
         const_179["info_credits"] = ["ctlg_text_5","ctlg_text_7"];
         const_179["collectibles"] = ["ctlg_collectibles_link"];
         const_179["club1"] = ["ctlg_text_5"];
         const_179["club_buy"] = ["club_link"];
         const_179["mad_money"] = ["ctlg_madmoney_button"];
      }
      ...
      {
         if(param1 < this.var_800.length)
         {
            return this.var_800[param1];
         }
         return "";
      }
      ...
      public function getColorUintFromText(param1:int) : uint
      {
         ...
         if(param1 < this.var_800.length)
         {
            _loc2_ = String(this.var_800[param1]).replace("#","0x");
