package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1652:String = "head";
      
      private static const const_717:int = 1;
      
      private static const const_1125:int = 1000;
      
      private static const const_1649:String = "pet_experience_bubble_png";
      ...
      private var var_413:ExperienceData;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1649) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_413 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_294);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_156);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_294);
            if(!isNaN(_loc6_))
            {
            ...
            _loc7_ = _loc3_.getNumber(RoomObjectVariableEnum.const_156);
            if(!isNaN(_loc7_))
            {
            ...
            this.var_2063 = _loc3_.getNumber(RoomObjectVariableEnum.const_250) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_203);
            if(!isNaN(_loc8_))
            {
               this.var_2075 = _loc8_;
            }
            else
            {
               this.var_2075 = direction;
            }
            this.var_1588 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2465 = _loc3_.getNumber(RoomObjectVariableEnum.const_450);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_899);
            if(_loc9_ != this.var_2076)
            {
               this.var_2076 = _loc9_;
               this.var_2847 = this.var_2076.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         {
            this.var_413.alpha = 0;
            if(this.var_1588 > 0)
            {
               _loc2_ = param1 - this.var_1588;
               if(_loc2_ < const_1125)
               {
                  this.var_413.alpha = int(Math.sin(_loc2_ / const_1125 * 0) * 255);
                  this.var_413.setExperience(this.var_2465);
               }
               else
               {
                  this.var_1588 = 0;
               ...
               if(_loc3_ != null)
               {
                  if(this.var_413.alpha > 0)
                  {
                     _loc3_.asset = this.var_413.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_413.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      {
         return super.getAdditionalSpriteCount() + const_717;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_717)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_717))
            {
               if(param2 >= FurnitureVisualizationData.const_636.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_636[param2];
               if(_loc4_ == 1)
               {
                  return type + "_icon_" + _loc5_;
               }
               return type + "_" + _loc4_ + "_" + _loc5_ + "_" + this.getDirection(param1,param2) + "_" + this.method_5(_loc4_,param2);
            }
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_2075);
         }
         return direction;
      }
      ...
      {
         if(this.var_1078[param1] == null)
         {
            if(this._animationData.getTag(var_102,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1652)
            {
               this.var_1078[param1] = true;
            }
            else
            {
               this.var_1078[param1] = false;
            }
         }
