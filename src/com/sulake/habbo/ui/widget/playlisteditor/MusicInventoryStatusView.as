package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryStatusView
   {
      ...
      public static const const_765:String = "MISV_BUY_MORE";
      ...
      {
         this.blitBackgroundImage(const_765,"get_more_music_background_image",param1);
         if(param2 && param1 != null)
         {
            param1.dispose();
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_478.add(const_825,_loc1_);
            this.var_1884 = _loc1_.getChildByName("preview_play_track_name") as ITextWindow;
            this.var_1883 = _loc1_.getChildByName("preview_play_author_name") as ITextWindow;
            ...
            this.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_600));
         ...
         if(_loc1_ != null)
         {
            this.var_478.add(const_765,_loc1_);
            ...
            this.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_643));
         }
      }
