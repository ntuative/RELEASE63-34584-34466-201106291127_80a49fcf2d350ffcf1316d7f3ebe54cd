package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1022:Array = [];
      
      private static var var_1923:int = 1000;
      
      private static var var_1023:Array = [];
      
      private static var var_1924:int = 200;
      ...
      private var var_1780:IMessageComposer;
      ...
      {
         this.var_820 = IWindowContainer(this.var_35.getXmlWindow("chatlog_roomheader"));
         this.var_819 = IWindowContainer(this.var_35.getXmlWindow("chatlog_chatline"));
         this.var_524 = new Timer(1000,1);
         ...
         this.var_35.connection.send(this.var_1780);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1022.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_819.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_1022.length < var_1923)
         {
            ...
            param1.width = this.var_819.width;
            param1.height = this.var_819.height;
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1023.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_820.clone());
      }
      
      private function storeChatHeaderWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_1023.length < var_1924)
         {
            _loc2_ = ITextWindow(param1.findChildByName("room_name_txt"));
            _loc2_.procedure = null;
            param1.width = this.var_820.width;
            param1.height = this.var_820.height;
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1925[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1527.getValue(param2.chatterName))
            {
               this.var_1527.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1527.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1528)
         {
