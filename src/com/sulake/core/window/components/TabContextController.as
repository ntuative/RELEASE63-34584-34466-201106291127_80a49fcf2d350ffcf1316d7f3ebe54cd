package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1418:String = "_SELECTOR";
      
      private static const const_1419:String = "_CONTENT";
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1141 = findChildByTag(const_1418) as ITabSelectorWindow;
            if(this.var_1141 != null)
            {
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2243 = findChildByTag(const_1419) as IWindowContainer;
         }
      ...
      {
         return !!this.var_761 ? this.selector.iterator : null;
      }
