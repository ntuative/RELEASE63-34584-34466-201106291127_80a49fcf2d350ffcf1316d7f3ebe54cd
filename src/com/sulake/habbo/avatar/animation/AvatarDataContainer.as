package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      {
         super();
         this.var_1936 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2666 = parseInt(_loc2_,16);
         this.var_2665 = parseInt(_loc3_,16);
         ...
         this.var_774 = new ColorTransform(this.var_1979,this.var_1978,this.var_1980,this._alphaMultiplier);
         this.var_1257 = this.generatePaletteMapForGrayscale(this.var_2665,this.var_2666);
      }
      ...
      {
         return this.var_1257.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1257.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1257.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1257.getValue("alphas") as Array;
      }
