package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_735:String = "PLSV_ADD_SONGS";
      
      public static const const_1176:String = "PLSV_START_PLAYBACK";
      
      public static const const_514:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_53 != const_514)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_478[this.var_53];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_478[const_735];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_478.add(const_514,_loc1_);
