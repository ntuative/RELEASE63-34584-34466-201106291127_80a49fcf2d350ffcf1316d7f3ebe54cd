package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_869:String = "RCL_LOADER_READY";
      
      private static const const_390:String = "RCL_PUBLICROOM_";
      
      private static const const_2090:int = 0;
      
      private static const const_1069:int = 1;
      
      private static const name_5:int = 2;
      
      private static const const_476:String = "place_holder";
      
      private static const const_689:String = "wall_place_holder";
      
      private static const const_690:String = "pet_place_holder";
      
      private static const PLACE_HOLDER_DEFAULT:String = const_476;
      
      private static const const_688:String = "room";
      
      private static const TILE_CURSOR:String = "tile_cursor";
      
      private static const const_1070:String = "selection_arrow";
      ...
      private var var_2594:Array;
      
      private var var_2596:Array;
      ...
      public function RoomContentLoader(param1:String)
      {
         ...
         this.var_2594 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         this.var_2596 = ["room_public","room_public_park","room_public_pool"];
         super();
      ...
      {
         if(this._state >= const_1069)
         {
            return;
         }
         this.var_1514 = param1;
         this.var_2595 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2597 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
      ...
      private function initPetData() : void
      {
         ...
         for each(_loc3_ in _loc1_)
         {
            ...
            this.var_1014.add(_loc2_,_loc3_);
            _loc2_++;
         }
      ...
      private function initFurnitureData() : void
      {
         ...
         var _loc1_:Array = this.var_416.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_546.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc4_ = this.var_546.getWithIndex(_loc3_) as AssetLibrary;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
         ...
         {
            for(_loc1_ in this.var_389)
            {
               delete this.var_389[_loc1_];
            }
            this.var_389 = null;
         }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_809.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_462.add(_loc3_,_loc4_);
               if(this.var_389[_loc7_] == null)
               {
                  this.var_389[_loc7_] = 1;
               }
            }
            else if(_loc2_.type == "i")
            {
               ...
               this.var_657.add(_loc3_,_loc4_);
               if(this._wallItems[_loc7_] == null)
               {
                  this._wallItems[_loc7_] = 1;
               }
            }
            _loc8_ = this.var_656.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_656.remove(_loc7_);
               this.var_656.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2593)
         {
            ...
            {
               this.var_1514.dispatchEvent(new Event(const_869));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         ...
         if(this.var_547 != null)
         {
            this.var_547.remove(param2);
            this.var_547.add(param2,param1);
         }
      }
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(this.var_547 != null)
         {
            _loc2_ = this.var_547.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         {
            return RoomObjectCategoryEnum.const_322;
         }
         return RoomObjectCategoryEnum.const_153;
      }
      ...
      {
         return [const_476,const_689,const_690,const_688,TILE_CURSOR,const_1070];
      }
      
      public function getActiveObjectType(param1:int) : String
      {
         var _loc2_:String = this.var_462.getValue(param1) as String;
         return this.getObjectType(_loc2_);
      }
      
      public function getWallItemType(param1:int, param2:String = null) : String
      {
         var _loc3_:String = this.var_657.getValue(param1) as String;
      ...
      {
         return this.var_1014.getValue(param1) as String;
      }
      
      public function getPetColor(param1:int, param2:int) : PetColorResult
      {
         var _loc3_:Map = this.var_1015[param1];
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:String = this.var_657.getValue(param1) as String;
         return this.getObjectColorIndex(_loc2_);
      }
      ...
      public function getRoomObjectAdURL(param1:String) : String
      {
         ...
         {
            return this.var_809.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(this.var_214 != null && this.var_214.hasWorldType(const_390 + param1))
         {
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_265 || param1 == RoomObjectVisualizationEnum.const_56 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_26 || _loc2_ == RoomObjectCategoryEnum.const_25)
         {
            if(param1.indexOf("poster") == 0)
            {
               param1 = "poster";
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_26:
                     if(this.var_389[_loc4_] == null)
                     {
                        this.var_389[_loc4_] = 1;
                     }
                     break;
                  case RoomObjectCategoryEnum.const_25:
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_406,_loc4_);
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1515.getValue(param1) != null)
         {
            this.var_214 = this.var_1515.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_770,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2594.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1845);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(this.var_2596.indexOf(this.getVisualizationType(_loc5_)) >= 0)
            {
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_489,_loc5_);
         }
      ...
      private function extractPetDataFromLoadedContent(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_1015.add(_loc6_,_loc3_);
         }
      }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1515.add(param1,_loc4_);
         this.var_214 = _loc4_;
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_808.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_808.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = this.var_546.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = this.var_808.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = this.getContentType(_loc4_);
               _loc3_ = this.var_546.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function addAssetLibraryCollection(param1:String, param2:IEventDispatcher) : IAssetLibrary
      {
         ...
         this.var_546.add(_loc5_,_loc4_);
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_596.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_214.getWorldHeightScale(const_390 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_214 != null)
         {
            return this.var_214.getWorldScale(const_390 + param1);
         }
         return 32;
      }
      ...
      public function setActiveObjectType(param1:int, param2:String) : void
      {
         ...
         this.var_462.add(param1,param2);
      }
   }
}
