package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_794:String = "InitConnection";
       
      
      private var var_141:HabboCommunicationDemo;
      ...
      private const const_2080:String = "fuselogin";
      ...
      {
         this.var_141.windowManager.removeWindow("habbo_login_window");
      }
      ...
      {
         var _loc1_:XmlAsset = (this.var_141 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         this._window = this.var_141.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_176,HabboWindowStyle.const_46,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = this.var_141.windowManager.buildFromXML(_loc2_) as IWindowContainer;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_2080,"/");
         if(_loc5_ != null)
         {
         ...
         if(_loc8_)
         {
            if(this.var_141.habboConfiguration)
            {
               if(this.var_141.habboConfiguration.getKey("use.sso","false") == "true")
               {
                  _loc8_.select();
               }
            }
         ...
         if(this.var_141.habboConfiguration && this.var_141.habboConfiguration.getKey("try.existing.session","false") == "true")
         {
            this.var_1665 = true;
      ...
      public function populateUserList(param1:Map) : void
      {
         ...
         var _loc3_:XmlAsset = this.var_141.assets.getAssetByName("login_user_list_item") as XmlAsset;
         var _loc4_:IWindow = this.var_141.windowManager.buildFromXML(_loc3_.content as XML);
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_2080,"/");
         ...
         {
            dispatchEvent(new Event(const_794));
         }
      }
      ...
      private function listEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_141.sendTryLogin(this.name,this.password,param2.id);
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_163.removeEventListener(SSOTicket.const_432,this.onParsedTicketSuccess);
            this.var_163.removeEventListener(SSOTicket.const_323,this.onParsedTicketFailure);
            this.var_163 = null;
         }
         var _loc2_:String = "";
         if(this.var_141.habboConfiguration != null)
         {
            _loc2_ = this.var_141.habboConfiguration.getKey("url.prefix",_loc2_);
            _loc2_ = _loc2_.replace("http://","");
            _loc2_ = _loc2_.replace("https://","");
         }
         var _loc3_:IHabboWebLogin = this.var_141.habboCommunication.habboWebLogin(this.name,this.password);
         this.var_163 = new SSOTicket(this.var_141.assets,_loc3_,_loc2_,param1);
         this.var_163.addEventListener(SSOTicket.const_432,this.onParsedTicketSuccess);
         this.var_163.addEventListener(SSOTicket.const_323,this.onParsedTicketFailure);
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         {
            this.var_141.habboConfiguration.setKey("facebook.user","1");
         }
         this.var_141.flashClientUrl = this.var_163.flashClientUrl;
         this.var_141.ssoTicket = this.var_163.ticket;
         this.var_163.removeEventListener(SSOTicket.const_432,this.onParsedTicketSuccess);
         this.var_163.removeEventListener(SSOTicket.const_323,this.onParsedTicketFailure);
         this.var_163 = null;
         dispatchEvent(new Event(const_794));
