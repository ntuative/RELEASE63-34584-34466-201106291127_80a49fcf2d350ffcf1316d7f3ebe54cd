package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2360:String = "hd-99999-99999";
      ...
      private var var_325:PetDataManager;
      
      private var var_785:PaletteManager;
      
      private var var_720:String;
      
      private var var_324:Map;
      
      private var var_242:AvatarAssetDownloadManager;
      
      private var var_1810:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_720 = RenderMode.const_1970;
         ...
         this.var_119.add(AvatarType.const_120,_loc4_);
         ...
         this.var_119.add(AvatarType.const_56,_loc4_);
         this._aliasCollection = new AssetAliasCollection(this,param1.assets as AssetLibraryCollection);
         this.var_325 = new PetDataManager(this,param1.assets as AssetLibraryCollection);
         this.var_785 = new PaletteManager(param1.assets as AssetLibraryCollection);
         var _loc5_:XML = param3.getAssetByName("HabboAvatarPetFigure").content as XML;
         this.var_325.populateFigureData(_loc5_);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_242)
         {
            this.var_242.removeEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_325.init();
         this.var_785.init();
         _loc2_ = this.var_119.getValue(AvatarType.const_120) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_119.getValue(AvatarType.const_56) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_119.getValue(AvatarType.const_120) as AvatarStructure;
            if(_loc3_ != null)
            {
               _loc4_ = this.var_161.getKey("external.figurepartlist.txt","figure.xml");
               ...
               if(this.var_242 == null)
               {
                  ...
                  _loc6_ = this.var_161.getKey("flash.dynamic.avatar.download.configuration","figuremap.xml");
                  _loc7_ = this.var_161.getKey("flash.dynamic.avatar.download.url","");
                  this.var_242 = new AvatarAssetDownloadManager(context.assets,_loc6_,_loc7_,_loc3_);
                  this.var_242.addEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
               }
            }
         }
      }
      ...
      private function checkIfReady() : void
      {
         if(!this.var_1081)
         {
            if(this.var_2440 && this.var_2439 && this.var_2441)
            {
               this.var_1081 = true;
      ...
      public function isFigureReady(param1:IAvatarFigureContainer) : Boolean
      {
         ...
         return this.var_242.isReady(param1);
      }
      ...
      public function downloadFigure(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         this.var_242.loadFigureSetData(param1,param2);
      }
      ...
      {
         var _loc5_:AvatarStructure = this.var_119.getValue(AvatarType.const_120) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(this.var_242.isReady(_loc6_))
         {
            return new AvatarImage(_loc5_,this._aliasCollection,_loc6_,param2);
         }
         if(!this.var_1810)
         {
            this.var_1810 = new AvatarFigureContainer(this.const_2360);
         }
         this.var_242.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1810,param2);
      }
      ...
      public function getPetFigureString(param1:String) : String
      {
         ...
         return this.var_325.createPetFigureString(_loc3_,_loc4_,_loc5_);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_2020)
         {
            _loc6_ = !this.var_325.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_325.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_119.getValue(AvatarType.const_56) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
      ...
      public function resetPetData() : void
      {
         ...
         this.var_325.populateFigureData(_loc1_);
         var _loc2_:AvatarStructure = this.var_119.getValue(AvatarType.const_56);
      ...
      {
         var _loc3_:AvatarStructure = this.var_119.getValue(AvatarType.const_120) as AvatarStructure;
      ...
      {
         return this.var_325 as IPetDataManager;
      }
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_56:
               _loc3_ = this.var_119.getValue(AvatarType.const_56) as AvatarStructure;
               break;
            default:
