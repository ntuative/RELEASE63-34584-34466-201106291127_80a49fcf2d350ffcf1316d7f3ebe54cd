package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_953:MeMenuSoundSettingsSlider;
      
      private var var_951:BitmapData;
      
      private var var_950:BitmapData;
      ...
      {
         this.var_954 = param1.volume;
         if(this.var_953 != null)
         {
            this.var_953.setValue(this.var_954);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_953 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.updateSoundIcons();
      ...
      private function updateSoundIcons() : void
      {
         if(this.var_954 == 0)
         {
            ...
            this.setBitmapWrapperContent("sounds_off_icon",this.var_951);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_952);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_950);
         }
      }
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_977);
         }
