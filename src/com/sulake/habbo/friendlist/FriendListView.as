package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1443:Point = new Point(110,50);
       
      
      private var _friendList:HabboFriendList;
      
      private var var_2169:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_2169 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this.var_16.position = const_1443;
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_1106 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_302 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_2169.prepare(this.var_1106);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_1363,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_1353,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_757,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_886,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_757,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_886,true);
         this.var_16.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1675 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1675.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_2172 == -1 ? 0 : int(this.var_16.height - this.var_2172);
         var _loc4_:int = this.var_2170 == -1 ? 0 : int(this.var_16.width - this.var_2170);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_302.y = Util.getLowestPoint(this.var_16.content);
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1301,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_757,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1363,false);
         ...
         this.var_2172 = this.var_16.height;
         this.var_2170 = this.var_16.width;
