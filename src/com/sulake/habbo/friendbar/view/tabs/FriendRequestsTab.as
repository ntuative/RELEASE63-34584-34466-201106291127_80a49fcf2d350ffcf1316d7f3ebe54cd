package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestsTab extends Tab
   {
      ...
      protected static const const_676:String = "request_entity_list";
      
      protected static const const_687:String = "name";
      
      protected static const const_2053:String = "badge_counter";
      
      protected static const const_2052:String = "button_accept_all";
      
      protected static const const_2051:String = "click_area_discard_all";
      
      protected static const const_1410:String = "button_close";
      
      protected static const const_2047:String = "button_accept";
      
      protected static const const_1034:String = "click_area_discard";
      
      protected static const const_1414:String = "text_discard";
      
      private static var var_1543:FriendRequestsTab;
      
      private static const const_74:uint = 4294625561;
      
      private static const const_1048:uint = 4294957414;
      
      private static const const_1633:uint = 4289431312;
      
      private static const const_1634:uint = 4290616362;
      ...
      {
         var _loc2_:FriendRequestsTab = !!var_1543 ? var_1543 : new FriendRequestsTab();
         _loc2_.var_169 = false;
         _loc2_._requests = param1;
         _loc2_._window.findChildByName(const_2053).caption = String(param1.length);
         return _loc2_;
      }
         ...
         if(!disposed)
         {
            if(!var_169)
            {
               if(_window)
               {
                  ...
                  if(_loc1_)
                  {
                     _loc2_ = _loc1_.content.getChildByName(const_676) as IItemListWindow;
                     if(_loc2_)
                     {
         ...
         if(!selected)
         {
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  if(!this.var_2025)
                  {
                     _loc3_ = _loc2_.content.getChildByName(const_676) as IItemListWindow;
                     if(_loc3_)
                     {
                        _loc7_ = 0;
                        _loc8_ = 0;
                        ...
                        {
                           _loc4_ = this.var_1301.clone() as IWindowContainer;
                           _loc4_.color = _loc8_ % 2 == 0 ? uint(const_1633) : uint(const_1634);
                           _loc5_ = this._requests[_loc8_];
                           _loc4_.id = _loc5_.id;
                           _loc4_.getChildByName(const_687).caption = _loc5_.name;
      ...
      private function allocateRequestsTabWindow() : IWindowContainer
      {
         ...
         var _loc7_:IItemListWindow = _loc4_.content.getChildByName(const_676) as IItemListWindow;
         this.var_1301 = _loc7_.removeListItemAt(0) as IWindowContainer;
         return _loc1_;
      }
      ...
      private function bubbleEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT)
         {
            if(param2.name == const_1034)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(const_1414)).textColor = const_1577;
            }
         }
      }
      ...
      public function avatarImageReady(param1:FriendRequest, param2:BitmapData) : void
      {
         ...
         if(_loc3_)
         {
            _loc4_ = _loc3_.content.getChildByName(const_676) as IItemListWindow;
            if(_loc4_)
            {
               _loc6_ = 0;
