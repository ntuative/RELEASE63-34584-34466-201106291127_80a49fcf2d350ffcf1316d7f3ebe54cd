package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener, IDisposable
   {
      ...
      private const const_2358:int = 10;
      ...
      private const const_2105:uint = 4.293848814E9;
      
      private const const_2106:uint = 4.294967295E9;
      
      private const const_1460:uint = 4.291613146E9;
      ...
      public function onIsOfferGiftable(param1:IsOfferGiftableMessageParser) : void
      {
         ...
         if(this.var_1193 != param1.offerId)
         {
            return;
         }
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc6_ != null)
         {
            ...
            _loc6_.addEventListener(WindowKeyboardEvent.const_320,this.onNameInputKeyUp);
         }
         ...
         if(_loc7_ != null)
         {
            ...
            _loc7_.addEventListener(WindowEvent.const_351,this.onMessageInputFocus);
         }
         this.var_1792 = true;
         this.var_1791 = true;
         if(_loc1_.isEnabled)
         {
            ...
            if(_loc12_ != null)
            {
               _loc12_.addEventListener(WindowEvent.const_348,this.onFreeWrappingSelected);
               _loc12_.addEventListener(WindowEvent.const_642,this.onFreeWrappingUnSelect);
            }
            ...
            this.var_1790 = _loc1_.stuffTypes;
            this.var_780 = _loc1_.boxTypes;
            this.var_781 = _loc1_.ribbonTypes;
            this.var_1194 = this.var_1790[0];
            this.var_368 = this.var_780[0];
            this.var_370 = this.var_781[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         if(this.var_370 < 0)
         {
            this.var_370 = this.var_781.length - 1;
         }
         if(this.var_370 > this.var_781.length - 1)
         {
            this.var_370 = 0;
         }
         if(this.var_368 < 0)
         {
            this.var_368 = this.var_780.length - 1;
         }
         if(this.var_368 > this.var_780.length - 1)
         {
            this.var_368 = 0;
         }
         var _loc1_:int = this.var_780[this.var_368] * 1000 + this.var_781[this.var_370];
         if(this._window == null)
         {
            return;
         }
         ...
         var _loc2_:ImageResult = this._roomEngine.getFurnitureImage(this.var_1194,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc2_ == null)
         {
            return;
         }
         this.var_1469 = _loc2_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         for each(_loc3_ in this.var_1790)
         {
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1194);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_780[this.var_368]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_781[this.var_370]);
         this._catalog.purchaseProductAsGift(this.var_1467,this.var_1193,this.var_1468,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      
      private function onBuyButtonClick(param1:WindowEvent) : void
      {
         this._catalog.purchaseProduct(this.var_1467,this.var_1193,this.var_1468);
         this.dispose();
      }
      ...
      private function onNameInputChange(param1:WindowEvent) : void
      {
         ...
         for each(_loc5_ in this.var_256)
         {
            ...
            if(_loc4_.length >= this.const_2358)
            {
               break;
            }
         }
         this.updateSuggestions(_loc4_);
         this.var_2375 = _loc2_.text;
      }
      ...
      private function onNameInputKeyUp(param1:WindowEvent) : void
      {
         ...
         {
            case Keyboard.UP:
               this.highlightSuggestion(this.var_369 - 1);
               break;
            case Keyboard.DOWN:
               this.highlightSuggestion(this.var_369 + 1);
               break;
      ...
      {
         if(this.var_274 == null || !this.var_274.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_274.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_369) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_274 == null)
         {
            this.var_274 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_779 == null)
         {
            this.var_779 = this.createWindow("suggestion_list_item") as IWindowContainer;
         }
         if(this.var_274 == null || this.var_779 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_274.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_779.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function onSuggestionsMouseOver(param1:WindowEvent) : void
      {
         ...
         var _loc3_:IItemListWindow = this.var_274.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_369) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_369);
         }
         this.var_369 = param1;
         if(this.var_369 < 0)
         {
            this.var_369 = _loc2_.numListItems - 1;
         }
         if(this.var_369 >= _loc2_.numListItems)
         {
            this.var_369 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_369) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1460;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_2105) : uint(this.const_2106);
      }
      ...
      {
         this.var_1194 = param1.target.id;
         this.updateColorGrid();
         this.updatePreview();
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1194;
               }
            }
            _loc4_++;
         }
