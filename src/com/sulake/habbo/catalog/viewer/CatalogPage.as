package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_2037:String = "ctlg_";
       
      
      protected var var_2244:XML;
      ...
      private var var_518:EventDispatcher;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_518 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1169);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1169);
      }
      ...
      {
         var _loc2_:String = const_2037 + param1;
         ...
         this.var_2244 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2244) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1866:
               if(this.var_1168 == null)
               {
                  this.var_1168 = new ItemGridCatalogWidget(param1,this._catalog.sessionDataManager);
                  this.var_38.push(this.var_1168);
               }
               break;
            case CatalogWidgetEnum.const_2030:
            ...
            case CatalogWidgetEnum.const_1961:
               ...
               break;
            case CatalogWidgetEnum.const_1906:
            ...
            case CatalogWidgetEnum.const_1736:
               ...
               break;
            case CatalogWidgetEnum.const_1988:
            ...
            case CatalogWidgetEnum.const_1805:
               ...
               break;
            case CatalogWidgetEnum.const_1859:
               this.var_38.push(new NewPetsCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1911:
            ...
            case CatalogWidgetEnum.const_1935:
               ...
               break;
            case CatalogWidgetEnum.const_1829:
            ...
            case CatalogWidgetEnum.const_1873:
               ...
               break;
            case CatalogWidgetEnum.const_1889:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_518.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_518 != null)
         {
            return this.var_518.dispatchEvent(param1);
         }
         return false;
      }
