package com.sulake.core.window.services
{
   ...
   public class FocusManager extends ChildEntityArrayReader implements IFocusManagerService
   {
      ...
      {
         this.var_157 = param1.stage;
         this.var_157.addEventListener(Event.ACTIVATE,this.onActivateEvent);
         this.var_157.addEventListener(FocusEvent.FOCUS_OUT,this.onFocusEvent);
         this.var_157.addEventListener(FocusEvent.KEY_FOCUS_CHANGE,this.onFocusEvent);
         this.var_157.addEventListener(FocusEvent.MOUSE_FOCUS_CHANGE,this.onFocusEvent);
         super();
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            this.var_157.removeEventListener(Event.ACTIVATE,this.onActivateEvent);
            this.var_157.removeEventListener(FocusEvent.FOCUS_OUT,this.onFocusEvent);
            this.var_157.removeEventListener(FocusEvent.KEY_FOCUS_CHANGE,this.onFocusEvent);
            this.var_157.removeEventListener(FocusEvent.MOUSE_FOCUS_CHANGE,this.onFocusEvent);
            this.var_157 = null;
            this._disposed = true;
            var_34 = null;
         }
