package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      private var var_1796:AssetTypeDeclaration;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_120 is BitmapDataAsset)
         {
            ...
            this.var_1517 = BitmapDataAsset(this.var_120).var_1517;
            this.var_1518 = BitmapDataAsset(this.var_120).var_1518;
            if(this._bitmap != null)
            {
               this.var_120 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1517 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1518 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
