package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      private static const const_1464:int = 100;
      
      private static const const_1463:int = 1000;
      ...
      private var var_1474:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_448 = [];
         this.var_447 = [];
         this.var_629 = new Timer(const_1464,1);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_146,this.onObjectPlaced);
               }
            ...
            {
               this.var_212.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_212.stop();
               this.var_212 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_35)
            {
               ...
               {
                  this.var_1474 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1474;
            }
            else
            {
         ...
         if(this.getSelectedItemIndex(const_35) == -1)
         {
            this.toggleItemSelection(const_35,0);
         }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc12_:* = null;
         var _loc13_:* = null;
         if(param3 == FurniCategory.const_360)
         {
         ...
         if(this.var_784 == null)
         {
            this.var_784 = this._windowManager.buildFromXML(this.var_2403) as IWindowContainer;
            _loc12_ = this._assets.getAssetByName("thumb_selected_outline_png") as BitmapDataAsset;
            _loc13_ = this.var_784.findChildByName("outline") as IBitmapWrapperWindow;
            _loc13_.bitmap = _loc12_.content as BitmapData;
            _loc13_.disposesBitmap = false;
         }
         var _loc11_:IWindowContainer = this.var_784.clone() as IWindowContainer;
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_35,const_43];
         var _loc5_:int = 0;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_212 = new Timer(param1,1);
            this.var_212.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_212.start();
         }
         else
         {
         ...
         if(param1 == InventoryCategory.const_75 && this.var_27.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_43:
                  ...
                  break;
               case const_282:
                  this.var_27.toggleInventoryPage(InventoryCategory.const_131);
            }
         }
      }
      ...
      public function updateItemLocks() : void
      {
         ...
         var _loc7_:Array = [const_35,const_43];
         var _loc8_:int = 0;
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_35,const_43];
         var _loc6_:int = 0;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_628.add(const_35,new Array());
         this.var_628.add(const_43,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         {
            _loc6_ = const_35;
            _loc5_ = this.var_448.indexOf(param1.ref) > -1;
         }
         else
         {
            ...
            _loc6_ = const_43;
            _loc5_ = this.var_447.indexOf(param1.ref) > -1;
         }
         ...
         if(param4)
         {
            if(this._view.visibleCategoryId == const_282)
            {
      ...
      {
         return getTimer() < this.var_2402 + const_1463;
      }
            ...
            if(_loc2_ != null)
            {
               ...
               while(_loc7_ < _loc2_.length)
               {
                  ...
                  if(_loc8_)
                  {
                     ...
                     {
                        this._view.method_4(_loc3_,_loc7_);
      ...
      {
         return this.var_27.getSubCategoryViewId() == InventorySubCategory.const_346;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_354 || _loc3_.category == FurniCategory.const_360 || _loc3_.category == FurniCategory.const_336)
         {
            if(param1)
            {
               return false;
      ...
      {
         return this.var_628.getValue(param1);
      }
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_346:
               this.cancelFurniInMover();
               if(this._view != null)
               {
                  this._view.updateActionView();
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         var _loc3_:Array = this.var_628.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            for each(_loc4_ in _loc3_)
            {
               _loc5_ = _loc4_.getTotalCount();
               if(_loc4_.category == FurniCategory.const_851)
               {
                  _loc5_ = 1;
               }
               _loc6_ = 0;
      ...
      public function updateView() : void
      {
         if(this._view != null)
         {
            this.updateGroupItems(const_35);
      ...
      public function addUnseenFloorItems(param1:Array) : void
      {
         ...
         {
            if(this.var_448.indexOf(_loc2_) == -1)
            {
               this.var_448.push(_loc2_);
            }
         }
      }
      ...
      public function addUnseenWallItems(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            if(this.var_447.indexOf(_loc2_) == -1)
            {
               this.var_447.push(_loc2_);
            }
         }
      }
      ...
      public function getUnseenItemCount(param1:int = 0) : int
      {
         switch(param1)
         {
            case UnseenItemCategoryEnum.const_419:
               return this.var_448.length;
            case UnseenItemCategoryEnum.const_439:
               return this.var_447.length;
            default:
               return this.var_448.length + this.var_447.length;
         }
      }
      ...
      public function resetUnseenItems(param1:String = null) : void
      {
         ...
         {
            case const_43:
               if(this.var_447 && this.var_447.length > 0)
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_439));
                  this.var_447 = [];
                  _loc3_ = this.getCategoryContent(param1);
               }
               break;
            case const_35:
               if(this.var_448 && this.var_448.length > 0)
               {
