package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_343:MainViewCtrl;
      
      private var var_675:RoomInfoViewCtrl;
      
      private var var_1277:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_438:Tabs;
      ...
      private var var_2602:RoomThumbnailRenderer;
      
      private var var_972:GuestRoomPasswordInput;
      
      private var var_319:GuestRoomDoorbell;
      
      private var var_1278:OfficialRoomEntryManager;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_343 = new MainViewCtrl(this);
         this.var_675 = new RoomInfoViewCtrl(this);
         this.var_1277 = new RoomCreateViewCtrl(this);
         this.var_2602 = new RoomThumbnailRenderer(this);
         this.var_972 = new GuestRoomPasswordInput(this);
         this.var_319 = new GuestRoomDoorbell(this);
         this.var_438 = new Tabs(this);
         this.var_1278 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_367,HabboWindowStyle.const_46,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_48)
         {
            ...
            {
               this.var_343.onNavigatorToolBarIconClick();
            }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = this.var_161.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_343.startSearch(Tabs.const_258,Tabs.const_499,param1);
         this.trackNavigationDataPoint("Search","search.tag",param1);
         this.var_343.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_343.startSearch(Tabs.const_245,Tabs.const_267);
         this.var_438.getTab(Tabs.const_245).tabPageDecorator.tabSelected();
      }
