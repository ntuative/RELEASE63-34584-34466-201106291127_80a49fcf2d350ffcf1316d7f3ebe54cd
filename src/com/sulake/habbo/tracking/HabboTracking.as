package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1038:uint = 11;
      ...
      private var var_1160:IHabboWindowManager;
      ...
      private var var_436:FramerateTracker = null;
      
      private var var_270:LatencyTracker = null;
      
      private var var_614:LagWarningLogger = null;
      
      private var var_435:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_436 = new FramerateTracker();
         this.var_270 = new LatencyTracker();
         this.var_614 = new LagWarningLogger();
         this.var_435 = new ToolbarClickTracker(this);
         this.var_1435 = new Array(const_1038);
         var _loc4_:int = 0;
         while(_loc4_ < const_1038)
         {
            this.var_1435[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1978,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1729,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1976,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1024,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1361,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1160)
            {
               this.var_1160.release(new IIDHabboWindowManager());
               this.var_1160 = null;
            }
            if(this.var_346)
            {
            ...
            if(this._navigator)
            {
               if(!this._navigator.disposed)
               {
                  ...
                  this._navigator.events.removeEventListener(HabboNavigatorEvent.const_375,this.onZoomToggle);
               }
            ...
            if(this.var_211)
            {
               if(!this.var_211.disposed)
               {
                  ...
                  Component(this.var_211).events.removeEventListener(HabboFriendListTrackingEvent.const_551,this.onFriendlistTrackingEvent);
               }
            ...
            {
               this.var_317.stop();
               this.var_317.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
               this.var_317 = null;
            }
      ...
      {
         this.var_1435[param2] = param1;
      }
      
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_161 = IHabboConfigurationManager(param2);
         if(this.var_161)
         {
            if(this.var_270 != null)
            {
               this.var_270.configuration = this.var_161;
            }
            if(this.var_271 != null)
            {
               this.var_271.configuration = this.var_161;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1758);
            if(this.var_161)
            {
               if(this.var_614 != null)
               {
                  this.var_614.configure(this.var_161);
               }
               if(this.var_436 != null)
               {
                  this.var_436.configure(this.var_161);
               }
               if(this.var_435 != null)
               {
                  this.var_435.configure(this.var_161);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_789,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_271,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_753,this.onHotelViewEvent);
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_270 != null)
            {
               this.var_270.communication = this._communication;
               this.var_270.connection = param1;
            }
            if(this.var_614 != null)
            {
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_753)
         {
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_789:
               this.trackLoginStep(HabboLoginTrackingStep.const_1912,String(this._communication.port));
               break;
            ...
            case HabboCommunicationEvent.const_216:
               ...
               break;
            case HabboCommunicationEvent.const_271:
               this.setErrorContextFlag(3,0);
               this.trackLoginStep(HabboLoginTrackingStep.const_271);
               if(this.var_270 != null)
               {
                  this.var_270.init();
               }
      ...
      {
         this.var_1160 = IHabboWindowManager(param2);
         if(this.var_1160)
         {
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_161)
            {
               if(this.var_161.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = this.var_161.getKey("client.fatal.error.url");
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1435)
                  {
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1165);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1165,this.onCoreRunning);
         }
      }
      ...
      private function onNavigatorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._navigator.events.addEventListener(HabboNavigatorEvent.const_375,this.onZoomToggle);
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_211).events.addEventListener(HabboFriendListTrackingEvent.const_551,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_551:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2273)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1853);
            this.var_2273 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.privateRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1361,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1024,String(true));
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_346.events.addEventListener(AdEvent.const_671,this.onRoomAdLoad);
      }
      ...
      private function onRoomAction(param1:RoomEngineEvent) : void
      {
         if(param1.type == RoomEngineEvent.const_191)
         {
            if(this.var_1724 < 1)
            {
               if(!this.var_317)
               {
                  this.var_317 = new Timer(60000,1);
                  this.var_317.addEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
                  this.var_317.start();
               }
            }
         }
         else if(param1.type == RoomEngineEvent.const_321)
         {
            if(this.var_317)
            {
               this.var_317.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_436)
               {
                  ...
                  if(this._roomEngine)
                  {
                     _loc3_ = this._roomEngine.getRoomObjectCount(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectCategoryEnum.const_28);
                     _loc4_ = this._roomEngine.getRoomObjectCount(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectCategoryEnum.const_26) + this._roomEngine.getRoomObjectCount(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectCategoryEnum.const_25);
                     _loc2_ = "Avatars: " + _loc3_ + ", Objects: " + _loc4_;
                  }
                  this.trackEventLog("Performance","fps",String(this.var_436.frameRate),_loc2_);
                  ++this.var_1724;
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_435)
         {
            this.var_435.track(param1.iconName);
         }
      }
      ...
      private function onZoomToggle(param1:HabboNavigatorEvent) : void
      {
         if(this.var_435)
         {
            this.var_435.track(param1.type);
         }
      }
      ...
      {
         if(this.var_161 != null && !Boolean(this.var_161.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++this.var_1722;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1722);
         }
         if(this.var_515 > -1 && _loc2_ - this.var_515 > 15000)
         {
            ++this.var_1723;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1723);
         }
         this.var_515 = _loc2_;
         if(this.var_271 != null)
         {
            this.var_271.update(param1,this.var_515);
         }
         if(this.var_270 != null)
         {
            this.var_270.update(param1,this.var_515);
         }
         if(this.var_436 != null)
         {
            this.var_436.trackUpdate(param1,this,this.var_515);
         }
         if(this.var_614 != null)
         {
            this.var_614.update(this.var_515);
         }
      }
   }
}
