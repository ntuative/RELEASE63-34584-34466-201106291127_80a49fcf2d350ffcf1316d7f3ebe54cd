package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_2178:String = "_INCLUDE";
      
      public static const const_2152:String = "_TEMP";
      
      private static const const_1523:String = "layout";
      
      private static const const_1066:String = "window";
      
      private static const const_1065:String = "variables";
      
      private static const const_1064:String = "filters";
      
      private static const const_687:String = "name";
      
      private static const const_1518:String = "style";
      
      private static const const_686:String = "params";
      
      private static const const_1517:String = "tags";
      ...
      private static const const_1519:String = "visible";
      
      private static const const_1522:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_5:String = "background";
      
      private static const const_1382:String = "blend";
      
      private static const const_1527:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1528:String = "treshold";
      
      private static const const_1526:String = "children";
      
      private static const const_1525:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1516:String = "height_min";
      
      private static const const_1520:String = "height_max";
      
      private static const const_685:String = "true";
      
      private static const const_193:String = "0";
      
      private static const const_1515:String = "$";
      
      private static const const_1514:String = ",";
      
      private static const const_49:String = "";
      
      private static const const_1524:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1521:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1421:Dictionary;
      
      protected var var_1420:Dictionary;
      
      protected var var_1148:Dictionary;
      
      protected var var_1703:Dictionary;
      
      protected var var_2255:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         this.var_1420 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1421,this.var_1420);
         this.var_1148 = new Dictionary();
         this.var_1703 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1148,this.var_1703);
         this.var_2255 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1521,const_49);
         return param1.replace(const_1524,const_49);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1421)
            {
               delete this.var_1421[_loc1_];
            }
            for(_loc1_ in this.var_1420)
            {
               delete this.var_1420[_loc1_];
            }
            for(_loc1_ in this.var_1148)
            {
               delete this.var_1148[_loc1_];
            }
            for(_loc1_ in this.var_1703)
            {
               delete this.var_1703[_loc1_];
            }
            this.var_2255.dispose();
            this.var_2255 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1523)
         {
            _loc8_ = param1.child(const_1065);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1064).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
            ...
            _loc4_ = param1.child(const_1066);
         ...
         if(param1.localName() == const_1066)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1421[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_687,variables,"")));
         style = uint(this.parseAttribute(xml,const_1518,variables,style));
         params = uint(this.parseAttribute(xml,const_686,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1517,variables,tag)));
         rect = new Rectangle();
         ...
         visible = this.parseAttribute(xml,const_1519,variables,visible.toString()) == const_685;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_686).length() > 0)
         {
            list = xml.child(const_686).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_687,variables,"") as String;
               if(this.var_1148[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_687)) + "\"!");
               }
               params |= this.var_1148[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_49) : const_49;
         caption = unescape(String(this.parseAttribute(xml,const_1522,variables,caption)));
         if(tag != const_49)
         {
            tags = tag.split(const_1514);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1065)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1525,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1516,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1520,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_5,variables,window.background.toString()) == const_685;
         blend = Number(this.parseAttribute(xml,const_1382,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1527,variables,window.clipping.toString()) == const_685;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1528,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_1064).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
            ...
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  if(window.x != rect.x || window.y != rect.y || window.width != rect.width || window.height != rect.height)
                  {
                     ...
                     if((params & 0) == WindowParam.const_222)
                     {
                        window.y = rect.y;
                     }
                  }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_49;
         var _loc3_:String = this.var_1420[param1.type];
