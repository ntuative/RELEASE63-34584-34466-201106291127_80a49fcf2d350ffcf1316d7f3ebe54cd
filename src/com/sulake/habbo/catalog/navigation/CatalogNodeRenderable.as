package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1724:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1694:XML;
      
      private static var var_1692:XML;
       
      
      private var var_2197:Number = 4.294967295E9;
      ...
      public function CatalogNodeRenderable(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         ...
         if(var_1694 == null)
         {
            ...
            var_1694 = _loc4_.content as XML;
         }
         if(var_1692 == null)
         {
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_2197 == 4294967295)
            {
               this.var_2197 = _loc1_.color;
            }
            _loc1_.color = const_1724;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1788;
            }
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1894;
            }
         }
      }
      ...
      {
         this.var_64 = navigator.catalog.windowManager.buildFromXML(var_1692) as IItemListWindow;
         if(this.var_64 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1694) as IWindowContainer;
         }
         else
         {
