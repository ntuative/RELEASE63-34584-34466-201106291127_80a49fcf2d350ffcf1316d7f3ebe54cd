package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_150:IBorderWindow;
      
      private var var_2325:int;
      
      private var var_2326:Boolean = true;
      
      private const const_1042:int = 5;
      
      private const const_2352:int = 3;
      
      private const const_1434:int = 11184810;
      
      private const const_1433:int = 16777215;
      
      private const const_2351:int = 2000;
      
      private const const_2353:int = 50;
      
      private const const_2354:int = 23;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_2326 = !this._widget.config.getBoolean("menu.avatar.enabled",false);
      }
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         while(_loc8_ < 5)
         {
            ...
            if(_loc7_ != null)
            {
               ...
               _loc7_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT,this.hideBadgeInfo);
            }
            _loc8_++;
         }
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = this.var_150.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = this.var_150.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         this.var_150.x = _loc5_.left - this.var_150.width;
         this.var_150.y = _loc5_.top + (_loc5_.height - this.var_150.height) / 2;
      }
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         this.createBadgeDetails();
         _loc6_ = this.var_150.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = this._widget.localizations.getBadgeName(_loc5_);
         }
         _loc6_ = this.var_150.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         this.var_150.x = _loc7_.left - this.var_150.width;
         this.var_150.y = _loc7_.top + (_loc7_.height - this.var_150.height) / 2;
      }
      ...
      private function createBadgeDetails() : void
      {
         ...
         this.var_150 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(this.var_150 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_1042;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            ...
            if(param1 == "")
            {
               ...
               _loc5_.textColor = this.const_1434;
            }
            else
            {
               _loc5_.textColor = this.const_1433;
            }
            _loc5_.enable();
         }
         else
         ...
         _loc5_.text = param1;
         _loc5_.height = Math.min(_loc5_.textHeight + this.const_1042,this.const_2353);
         _loc5_.height = Math.max(_loc5_.height,this.const_2354);
         _loc3_.height = _loc5_.height + this.const_2352;
         if(param2)
         {
            _loc5_.addEventListener(WindowKeyboardEvent.const_320,this.onMottoKeyboard);
            _loc5_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc5_.removeEventListener(WindowKeyboardEvent.const_320,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_769:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_887:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc6_ = getTimer();
            if(_loc6_ - this.var_2325 > this.const_2351 && _loc4_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2325 = _loc6_;
               _loc3_.textColor = this.const_1433;
            }
         }
         else
         {
            _loc3_.textColor = this.const_1434;
         }
      }
