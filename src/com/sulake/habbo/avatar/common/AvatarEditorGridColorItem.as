package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_1130:IPartColor;
      ...
      public function AvatarEditorGridColorItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IPartColor)
      {
         ...
         this.var_1001 = _loc6_.content as BitmapData;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_1003.width,this.var_1003.height,true,0);
            _loc5_ = this.var_1003.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_1130.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_1001.width,this.var_1001.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_1001,this.var_1001.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
         ...
         if(_loc4_)
         {
            if(this.var_1130)
            {
               switch(this.var_1130.clubLevel)
               {
                  case HabboClubLevelEnum.const_51:
                     _loc4_.visible = false;
                     break;
                  case HabboClubLevelEnum.const_34:
                     _loc4_.style = HabboIconType.const_868;
                     _loc4_.visible = true;
                     break;
                  case HabboClubLevelEnum.const_41:
                     _loc4_.style = HabboIconType.const_1003;
                     _loc4_.visible = true;
               }
            }
            else
