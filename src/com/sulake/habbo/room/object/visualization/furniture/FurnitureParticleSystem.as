package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystem
   {
      ...
      private var var_1243:Number = 1.0;
      
      private var var_664:BitmapData;
      
      private var var_817:ColorTransform;
      
      private var var_1524:ColorTransform;
      
      private var var_1916:Matrix;
      ...
      public function FurnitureParticleSystem(param1:AnimatedFurnitureVisualization)
      {
         ...
         this.var_817 = new ColorTransform();
         this.var_817.alphaMultiplier = 1;
         this.var_1524 = new ColorTransform();
         this.var_1916 = new Matrix();
      ...
      public function setAnimation(param1:int) : void
      {
         ...
         this.var_112 = this.var_1244[param1];
         this.var_1020 = false;
         this.updateCanvas();
      }
      ...
      private function updateCanvas() : void
      {
         ...
         if(this.var_1915 >= 0)
         {
            this.var_284 = this._visualization.getSprite(this.var_1915);
            if(this.var_284 && this.var_284.asset)
            {
               ...
               if(this.var_98 == null)
               {
                  ...
                  if(this.var_817.alphaMultiplier != 1)
                  {
                     this.var_664 = new BitmapData(this.var_98.width,this.var_98.height,true,4278190080);
                  }
               }
      ...
      public function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         {
            return this.var_112.y * this.var_1243;
         }
         return 0;
      }
      ...
      public function updateAnimation() : void
      {
         ...
         var _loc2_:* = 0;
         var _loc8_:int = 0;
         if(!this.var_1020 && this.var_112.hasIgnited)
         {
            this.var_1020 = true;
         }
         _loc8_ = this.var_1208 * this.var_1243;
         this.var_112.update();
         if(this.var_1020)
         {
            if(this.var_112.roomObjectSpriteId >= 0)
            ...
            {
               this.var_98.draw(this.var_664,this.var_1916,this.var_817,BlendMode.NORMAL,null,false);
            }
            for each(_loc11_ in this.var_112.particles)
            {
               _loc2_ = Number(_loc11_.y);
               _loc3_ = this.var_2587 + (_loc11_.x - _loc11_.z) * 10 / 10 * this.var_1243;
               _loc4_ = this.var_2588 - _loc8_ + (_loc2_ + (_loc11_.x + _loc11_.z) / 2) * 10 / 10 * this.var_1243;
               ...
               if(_loc6_)
               {
                  ...
                  if(_loc11_.fade && _loc11_.alphaMultiplier < 1)
                  {
                     ...
                     this.var_1524.alphaMultiplier = _loc11_.alphaMultiplier;
                     this.var_98.draw(_loc7_,this._translationMatrix,this.var_1524,BlendMode.NORMAL,null,false);
                  }
                  else
                  {
      ...
      public function parseData(param1:XML) : void
      {
         ...
         var _loc23_:* = null;
         var _loc24_:* = null;
         this.var_2616 = parseInt(param1.@size);
         this.var_1915 = !!param1.hasOwnProperty("@canvas_id") ? int(parseInt(param1.@canvas_id)) : -1;
         this.var_1208 = !!param1.hasOwnProperty("@offset_y") ? int(parseInt(param1.@offset_y)) : 10;
         this.var_1243 = this.var_2616 / 64;
         this._blend = !!param1.hasOwnProperty("@blend") ? Number(Number(param1.@blend)) : Number(1);
         this._blend = Math.min(this._blend,1);
         this.var_817.alphaMultiplier = this._blend;
