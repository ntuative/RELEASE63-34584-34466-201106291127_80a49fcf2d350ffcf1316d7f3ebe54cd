package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_383:IItemGridWindow;
      ...
      {
         if(!this.var_383.disposed)
         {
            this.var_383.destroyGridItems();
      ...
      override public function init() : Boolean
      {
         ...
         this.var_383 = _window.findChildByName("colourGrid") as IItemGridWindow;
      ...
      private function onAvailableColours(param1:CatalogWidgetColoursEvent) : void
      {
         ...
         this.var_1003 = _loc4_.content as BitmapData;
         ...
         this.select(this.var_383.getGridItemAt(param1.index) as IWindowContainer);
      }
      ...
      private function onAvailableMultiColours(param1:CatalogWidgetMultiColoursEvent) : void
      {
         ...
         for each(_loc2_ in param1.colours)
         {
            this.var_1002.push(_loc2_.slice());
         }
         _loc3_ = page.viewer.catalog.assets.getAssetByName(param1.backgroundAssetName) as BitmapDataAsset;
         this.var_642 = _loc3_.content as BitmapData;
         _loc4_ = page.viewer.catalog.assets.getAssetByName(param1.colourAssetName) as BitmapDataAsset;
         ...
         this.var_1001 = _loc5_.content as BitmapData;
         this.populateColourGrid();
         this.select(this.var_383.getGridItemAt(0) as IWindowContainer);
      }
      ...
      private function populateColourGrid() : void
      {
         ...
         var _loc12_:int = 0;
         var _loc13_:int = 0;
         Logger.log("[ColourGridCatalogWidget] Display colors: " + [this.var_1002.length,this.var_383.numGridItems]);
         this.var_383.destroyGridItems();
         this.var_238 = null;
         for each(_loc1_ in this.var_1002)
         {
            if(_loc1_.length > 0)
            {
               _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_1870) as IWindowContainer;
               ...
               this.var_383.addGridItem(_loc2_);
               ...
               if(_loc4_ != null)
               {
                  _loc4_.bitmap = new BitmapData(this.var_1003.width,this.var_1003.height,true,0);
                  _loc6_ = 255;
                  _loc7_ = 255;
                  _loc8_ = 255;
                  _loc9_ = null;
               ...
               if(_loc5_ != null)
               {
                  _loc5_.bitmap = new BitmapData(this.var_1001.width,this.var_1001.height,true,16777215);
                  _loc5_.bitmap.copyPixels(this.var_1001,this.var_1001.rect,new Point(0,0),null,null,true);
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = this.var_383.getGridItemIndex(param1.target as IWindow);
