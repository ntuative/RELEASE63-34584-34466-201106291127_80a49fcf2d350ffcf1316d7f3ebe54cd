package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_229:String = "regular";
      ...
      private static const const_1547:String = "/*";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_99[const_229],var_99[ITALIC],var_99[BOLD]];
            var_99.reset();
            var_99[const_229] = _loc5_[0];
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         {
            while(_loc5_.indexOf(const_1547) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1546) + 2,_loc5_.length);
            }
