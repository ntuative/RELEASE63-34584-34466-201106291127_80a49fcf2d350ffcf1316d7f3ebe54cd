package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1778:uint = 1;
      
      public static const const_1932:uint = 2;
       
      
      private var var_1492:IProtocolEncoder;
      
      private var var_1164:IProtocolDecoder;
      
      public function WedgieProtocol()
      {
         super();
         this.var_1492 = new WedgieEncoder();
         this.var_1164 = new WedgieDecoder();
      }
      ...
      public function getMessages(param1:ByteArray, param2:Array) : uint
      {
         ...
         while(param1.bytesAvailable)
         {
            ...
            if(_loc5_ == const_1778)
            {
               _loc4_.position = 0;
               _loc6_ = this.var_1164.getID(_loc4_);
