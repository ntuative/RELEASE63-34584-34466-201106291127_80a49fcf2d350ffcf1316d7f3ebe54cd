package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_601:UserInfoCtrl;
      
      private var var_1404:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         this.var_601 = new UserInfoCtrl(this._window,this.var_77,_loc3_.message);
         this.var_1404 = new UserInfoCtrl(this._window,this.var_77,_loc3_.message);
         this.var_601.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc3_.reporterUserId);
         ...
         {
            this.var_1404.load(_loc4_,this.var_188.reportedUserId);
         }
         else
         {
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_77.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_77,WindowTracker.const_1346,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            this.var_601 = new UserInfoCtrl(this._window,this.var_77,_loc3_.message);
            this.var_601.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
