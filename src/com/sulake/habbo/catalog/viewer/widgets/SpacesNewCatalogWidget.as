package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesNewCatalogWidget extends ItemGridCatalogWidget implements IDisposable, ICatalogWidget, IItemGrid
   {
      ...
      private var var_438:ISelectorWindow;
      ...
      public function SpacesNewCatalogWidget(param1:IWindowContainer, param2:ISessionDataManager)
      {
         ...
         super(param1,param2);
         this.var_438 = _window.findChildByName("groups") as ISelectorWindow;
         if(this.var_438)
         {
            _loc3_ = 0;
            while(_loc3_ < this.var_438.numSelectables)
            {
               _loc4_ = this.var_438.getSelectableAt(_loc3_);
      ...
      override public function init() : Boolean
      {
         ...
         this.switchCategory(this.var_118[this.var_553]);
      ...
      {
         var _loc2_:int = this.var_712[this.var_553];
         var _loc3_:Offer = this.var_219[this.var_553][_loc2_];
      ...
      public function selectIndex(param1:int) : void
      {
         ...
         {
            _loc2_ = this.var_219[this.var_553][param1];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         this.var_712[this.var_553] = (this.var_219[this.var_553] as Array).indexOf(_loc2_);
         this.updateRoomPreview();
      }
      
      private function updateRoomPreview() : void
      {
         var _loc1_:int = this.var_712[0];
         var _loc2_:int = this.var_712[1];
         var _loc3_:int = this.var_712[2];
         var _loc4_:Offer = this.var_219[0][_loc1_];
         var _loc5_:Offer = this.var_219[1][_loc2_];
         var _loc6_:Offer = this.var_219[2][_loc3_];
      ...
      private function createOfferGroups() : Boolean
      {
         ...
         {
            if(!(_loc1_.pricingModel == Offer.const_414 || _loc1_.pricingModel == Offer.const_437))
            {
               continue;
            }
            ...
            if(!(_loc2_.productType == ProductTypeEnum.const_62 || _loc2_.productType == ProductTypeEnum.const_69))
            {
               continue;
            }
            ...
            while(this.var_219.length < this._groupNames.length)
            {
               this.var_219.push(new Array());
            }
            switch(_loc4_)
            {
               case "floor":
                  (this.var_219[_loc5_] as Array).push(_loc1_);
                  break;
               case "wallpaper":
                  (this.var_219[_loc5_] as Array).push(_loc1_);
                  break;
      ...
      private function onSelectGroup(param1:WindowEvent) : void
      {
         ...
         if(_loc2_)
         {
            _loc3_ = this.var_438.getSelectableIndex(_loc2_);
      ...
      private function switchCategory(param1:String) : void
      {
         ...
         this.var_438.setSelected(this.var_438.getSelectableByName(param1));
         var _loc2_:int = -1;
         switch(param1)
         {
            case "group.walls":
         ...
         if(_loc2_ > -1)
         {
            ...
            page.replaceOffers(this.var_219[this.var_553],false);
            resetTimer();
            populateItemGrid();
            ...
            _loc3_ = this.var_712[this.var_553];
