package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1408:Dictionary = createPropertySetterTable();
      ...
      protected var var_1145:Boolean = false;
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_457,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_457 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_457,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_229);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_742 ? true : null;
         }
      ...
      {
         return new Rectangle(this.var_934 * this.maxScrollH,this.var_605 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_975,this._field.antiAliasType,PropertyStruct.const_50,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1283));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1310 ? new PropertyStruct(PropertyDefaults.const_991,this._autoSize,PropertyStruct.const_50,true,PropertyDefaults.const_1215) : PropertyDefaults.const_1854);
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_38,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_175,this._field.borderColor != 0));
         ...
         _loc1_.push(new PropertyStruct("font_face",this.defaultTextFormat.font,PropertyStruct.const_50,this.defaultTextFormat.font != _loc2_.fontFamily));
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_310,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1400 ? new PropertyStruct(PropertyDefaults.const_1337,this._field.gridFitType,PropertyStruct.const_50,true,PropertyDefaults.const_1182) : PropertyDefaults.const_1843);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_897) ? new PropertyStruct(PropertyDefaults.const_426,this._field.textColor,PropertyStruct.const_175,true) : PropertyDefaults.const_1220);
         ...
         _loc1_.push(this.var_43.left != PropertyDefaults.const_813 ? new PropertyStruct(PropertyDefaults.const_259,this.var_43.left,PropertyStruct.const_36,true) : PropertyDefaults.const_793);
         _loc1_.push(this.var_43.top != PropertyDefaults.const_834 ? new PropertyStruct(PropertyDefaults.const_297,this.var_43.top,PropertyStruct.const_36,true) : PropertyDefaults.const_929);
         _loc1_.push(this.var_43.right != PropertyDefaults.const_948 ? new PropertyStruct(PropertyDefaults.const_283,this.var_43.right,PropertyStruct.const_36,true) : PropertyDefaults.const_946);
         _loc1_.push(this.var_43.bottom != PropertyDefaults.const_936 ? new PropertyStruct(PropertyDefaults.const_287,this.var_43.bottom,PropertyStruct.const_36,true) : PropertyDefaults.const_978);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1192 ? new PropertyStruct(PropertyDefaults.const_799,this._field.mouseWheelEnabled,PropertyStruct.const_38,true) : PropertyDefaults.const_1993);
         ...
         _loc1_.push(new PropertyStruct("restrict",this._field.restrict,PropertyStruct.const_50,this._field.restrict != null));
