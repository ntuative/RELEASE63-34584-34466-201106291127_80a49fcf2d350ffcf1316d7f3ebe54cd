package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_1853:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201106291122));
         this.var_129 = new Map();
         this.var_129.add(HabboHelpViewEnum.const_1739,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_129.add(HabboHelpViewEnum.const_212,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_129.add(HabboHelpViewEnum.const_533,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_129.add(HabboHelpViewEnum.const_355,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_129.add(HabboHelpViewEnum.const_281,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_129.add(HabboHelpViewEnum.const_444,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_129.add(HabboHelpViewEnum.const_982,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_129.add(HabboHelpViewEnum.const_254,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_129.add(HabboHelpViewEnum.const_1266,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_129.add(HabboHelpViewEnum.const_1247,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_129.add(HabboHelpViewEnum.const_832,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(param1 == this.var_1853)
         {
            this.var_531 = new Array();
         }
         else if(param2)
         {
            if(this.var_531.length == 0 || param1 != this.var_378)
            {
               this.var_531.push(this.var_378);
            }
         }
         this.var_378 = param1;
         ...
         if(_loc3_ == null)
         {
            Logger.log("* No view controller found for " + this.var_378);
            return;
         }
      ...
      public function method_6(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_254:
               ...
               break;
            case CallForHelpResultEnum.const_1210:
               this.showUI(HabboHelpViewEnum.const_1247);
               break;
            case CallForHelpResultEnum.const_1239:
               this.showUI(HabboHelpViewEnum.const_1266);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_129.getValue(HabboHelpViewEnum.const_212) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_597));
      }
      ...
      {
         return this.var_129.getValue(this.var_378);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2534 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2534;
      ...
      {
         var _loc3_:* = null;
         if(this.var_378 == HabboHelpViewEnum.const_212)
         {
            return;
         }
         if(this.var_637.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_637.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_637[1],this.var_637[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_637[0],this.var_637[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_378 == HabboHelpViewEnum.const_212 || this.var_531.length == 0)
         {
            return;
         }
         if(this.var_379 == null)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT,this.onMouseOut);
