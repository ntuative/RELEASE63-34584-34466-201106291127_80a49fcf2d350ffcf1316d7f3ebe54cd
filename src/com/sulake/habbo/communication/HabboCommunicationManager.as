package com.sulake.habbo.communication
{
   ...
   public class HabboCommunicationManager extends Component implements IHabboCommunicationManager, IConnectionStateListener
   {
      ...
      private const const_2369:int = 2;
      ...
      private var var_1607:IMessageConfiguration;
      ...
      {
         this.var_1607 = new HabboMessages();
         this.var_406 = [];
         this.var_1570 = new Timer(100,1);
      ...
      {
         if(this.var_406.length == 0 || this.var_479 < 0 || this.var_479 >= this.var_406.length)
         {
            return 0;
         }
         return this.var_406[this.var_479];
      }
      ...
      private function onCoreCommunicationManagerInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            this.var_293.registerProtocolType(HabboProtocolType.const_1333,WedgieProtocol);
            this._connection = this.var_293.createConnection(HabboConnectionType.const_292,ConnectionType.const_1330);
            _loc3_ = this.var_293.getProtocolInstanceOfType(HabboProtocolType.const_1333);
            this._connection.registerMessageClasses(this.var_1607);
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(_loc8_ == null)
            {
               Core.crash(this.getKey([this._a4,_loc6_,_loc4_,_loc5_],0),Core.const_417);
               return;
            }
            _loc11_ = [];
            _loc12_ = 1;
            ...
            if(_loc7_ == null)
            {
               Core.crash(this.getKey([this._a4,_loc6_,_loc4_,_loc3_],0),Core.const_417);
               return;
            }
            this.var_406 = [];
            _loc9_ = _loc7_.split(",");
      ...
      public function initConnection(param1:String) : void
      {
         switch(param1)
         {
            case HabboConnectionType.const_292:
               if(this.var_151 == null)
               {
                  Core.crash("Tried to connect to proxy but configuration was null",Core.const_417);
                  return;
               }
               if(this._connection == null)
               {
                  Core.crash("Tried to connect to proxy but connection was null",Core.const_417);
                  return;
               }
               this.var_2773 = true;
               if(this.var_2774)
      ...
      private function nextPort() : void
      {
         ...
         if(this.var_479 >= this.var_406.length)
         {
            ...
            if(this.var_1051 > _loc1_)
            {
               ...
               this.var_2772 = true;
               Core.error("Connection failed to host and ports",true,Core.const_417);
               return;
            }
            this.var_479 = 0;
         }
         this._connection.timeout = this.var_1051 * 10000;
         this._connection.init(this.var_39 + this.getKey([[65244,65185,65191,65189,65188],[65174,65238,65184],[65171,65172]],0),this.var_406[this.var_479]);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("Communication IO Error","IOError " + param1.type + " on connect: " + param1.text + ". Port was " + this.var_406[this.var_479]);
         this.tryNextPort();
      }
      ...
      {
         this.var_1570.addEventListener(TimerEvent.TIMER,this.onTryNextPort);
         this.var_1570.start();
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("Communication Security Error","SecurityError on connect: " + param1.text + ". Port was " + this.var_406[this.var_479]);
         this.tryNextPort();
      }
      
      public function getHabboMainConnection(param1:Function) : IConnection
      {
         return !!this.var_293 ? this.var_293.queueConnection(HabboConnectionType.const_292,param1) : null;
      }
      ...
      public function addHabboConnectionMessageEvent(param1:IMessageEvent) : void
      {
         if(this.var_293)
         {
            this.var_293.addConnectionMessageEvent(HabboConnectionType.const_292,param1);
         }
      }
      ...
      public function connectionInit(param1:String, param2:int) : void
      {
         ...
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1919,String(param2));
      }
      
      public function messageReceived(param1:String, param2:String) : void
      {
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1938,String(new Date().getTime()));
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1861,param1 + " " + param2);
      ...
      {
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1782,String(new Date().getTime()));
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1972,param1 + " " + param2);
         if(this.var_158.length > 0)
         {
