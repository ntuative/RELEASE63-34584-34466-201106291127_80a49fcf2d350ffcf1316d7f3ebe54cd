package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1450:String = "increment";
      
      private static const const_1451:String = "decrement";
      
      private static const const_1050:String = "slider_track";
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_17 != null && !this.var_17.disposed)
         {
            ...
            this.var_17.removeEventListener(WindowEvent.const_584,this.onScrollableScrolled);
         }
         this.var_17 = param1;
         if(this.var_17 != null && !this.var_17.disposed)
         {
            this.var_17.addEventListener(WindowEvent.const_39,this.onScrollableResized);
            this.var_17.addEventListener(WindowEvent.const_584,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      {
         return findChildByName(const_1050) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_374)
            {
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_45 || param1.type == WindowTouchEvent.const_759)
         {
            ...
            else if(param2.name == const_1451)
            {
               if(this.var_17)
               {
                  this.var_1190 = true;
            ...
            else if(param2.name == const_1050)
            {
         ...
         if(param1.type == WindowMouseEvent.const_374)
         {
