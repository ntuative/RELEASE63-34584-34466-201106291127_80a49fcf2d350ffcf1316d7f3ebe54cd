package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function showPreview(param1:Offer, param2:Rectangle) : void
      {
         ...
         if(!this.var_255)
         {
            this.var_255 = this.createWindow("club_gift_preview") as IWindowContainer;
         }
         if(!this.var_255)
         {
            return;
         }
         var _loc4_:IBitmapWrapperWindow = this.var_255.findChildByName("image") as IBitmapWrapperWindow;
         if(!_loc4_)
         {
            return;
         }
         ...
         this.var_255.setGlobalPosition(_loc6_.subtract(new Point(this.var_255.width / 2,this.var_255.height / 2)));
         this.var_255.visible = true;
         this.var_255.activate();
      }
