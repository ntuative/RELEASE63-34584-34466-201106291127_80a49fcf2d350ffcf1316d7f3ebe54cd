package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_45:
               this.var_1551.setSelectedGridItem(this);
               this.var_1550 = true;
               break;
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT:
               ...
               {
                  this.var_1550 = false;
                  this.var_1551.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         if(!this._window || !this.var_1465)
         {
            return;
         }
         this.var_1465.color = !!this.var_1540 ? uint(const_1475) : uint(const_1474);
