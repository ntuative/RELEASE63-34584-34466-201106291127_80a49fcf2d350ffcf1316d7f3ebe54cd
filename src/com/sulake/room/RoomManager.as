package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_1828:int = 1;
      ...
      private var var_187:IRoomManagerListener;
      
      private var var_3119:IRoomContentLoader;
      
      private var var_738:IRoomObjectFactory = null;
      
      private var var_596:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1395:XML = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_739 = [];
         this.var_663 = [];
         events.addEventListener(RoomContentLoadedEvent.const_406,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_489,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_860,this.onContentLoaded);
      }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_738 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_738 == null || this.var_596 == null)
         {
            return;
         }
         this._state = const_1828;
         if(this.var_1395 != null)
         {
            _loc1_ = this.var_1395;
            this.var_1395 = null;
            this.initialize(_loc1_,this.var_187);
         }
      }
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_739.indexOf(_loc5_) < 0)
            {
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         var _loc4_:int = this.var_663.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_663[_loc4_];
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_596.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_596.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_738.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_738 != null)
         {
            return this.var_738.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_963)
         {
            return;
         }
         if(this.var_61 == null)
         {
            this._state = const_963;
            return;
         }
         if(this.var_61.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_739.indexOf(param1);
            if(_loc2_ >= 0)
            {
            ...
            if(this.var_739.length == 0)
            {
               ...
               {
                  this.var_187.roomManagerInitialized();
               }
            }
         }
         else
         {
            this._state = const_963;
            this.var_187.roomManagerInitialized(false);
         }
      }
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(_loc2_ == null)
         {
            if(this.var_187 != null)
            {
               this.var_187.contentLoaded(null,false);
            }
            return;
         }
         if(this.var_1131.indexOf(_loc2_) < 0)
         {
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         {
            _loc2_ = this.var_1131[0];
            this.var_1131.splice(0,1);
            _loc3_ = this.var_61.getVisualizationXML(_loc2_);
            if(_loc3_ == null)
            {
               if(this.var_187 != null)
               {
                  this.var_187.contentLoaded(_loc2_,false);
               }
               return;
            }
            ...
            if(this.var_187 != null)
            {
               this.var_187.contentLoaded(_loc2_,true);
            }
            if(this.var_739.length > 0)
            {
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_61 == null || this.var_596 == null)
         {
            return;
         }
         ...
         var _loc7_:IRoomObjectVisualizationData = this.var_596.getRoomObjectVisualizationData(param1,_loc5_,_loc2_);
            ...
            if(_loc9_ != null)
            {
               ...
               for each(_loc12_ in _loc11_)
               {
                  ...
                  while(_loc14_ >= 0)
                  {
                     ...
                     if(_loc15_ != null)
                     {
                        _loc16_ = this.var_596.createRoomObjectVisualization(_loc5_);
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_738.createRoomObjectLogic(_loc6_);
                              ...
                              if(this.var_187 != null)
                              {
                                 this.var_187.objectInitialized(_loc10_,_loc15_.getId(),_loc12_);
                              }
                           }
                        }
                        else
