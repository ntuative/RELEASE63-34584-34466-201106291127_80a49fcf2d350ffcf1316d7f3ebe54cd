package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1132:int = 2;
      
      private static const const_1133:int = 3;
      
      private static const const_1131:int = 42;
      
      private static const const_1134:int = 120;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_227.add(FurniModelCategory.const_35,new FurniGridView(this.var_78,FurniModelCategory.const_35,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_227.add(FurniModelCategory.const_43,new FurniGridView(this.var_78,FurniModelCategory.const_43,this._windowManager,this._assetLibrary,this._roomEngine));
         ...
         this.switchCategory(FurniModelCategory.const_35);
      ...
      private function addUnseenItemSymbols() : void
      {
         ...
         for each(_loc5_ in ["floor","wall","pets"])
         {
            ...
            _loc3_.x = _loc4_.rectangle.right - _loc3_.width - const_1121;
            _loc3_.y = _loc4_.y + const_1121;
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            case FurniModelCategory.const_43:
               ...
               this.var_494 = FurniModelCategory.const_43;
               break;
            case FurniModelCategory.const_35:
               _loc2_.setSelected(_loc2_.getSelectableByName("tab_floor"));
               this.var_494 = FurniModelCategory.const_35;
               break;
            case FurniModelCategory.const_282:
               _loc2_.setSelected(_loc2_.getSelectableByName("tab_pets"));
               this.var_494 = FurniModelCategory.const_282;
               break;
            default:
               throw new Error("Unknown item category: \"" + param1 + "\"");
         }
         this.var_78.furniCategorySwitch();
         this.showCategoryGrid(this.var_494);
         this.setViewToState();
      }
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_227.getValue(this.var_494);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_78.getCategoryContent(this.var_494);
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModelCategory.const_35,FurniModelCategory.const_43];
         var _loc4_:int = 0;
         while(_loc4_ < _loc1_.length)
         {
            _loc2_ = _loc1_[_loc4_];
            _loc3_ = this.var_227.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_227.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_227.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function method_4(param1:String, param2:int) : void
      {
         ...
         var _loc4_:IWindow = _loc3_.method_4(param2);
         if(_loc4_)
         {
            _loc4_.dispose();
         }
      ...
      public function moveItemTo(param1:GroupItem, param2:int) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_227.getValue(param1.mainCategory);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_78.getUnseenItemCount(UnseenItemCategoryEnum.const_419) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_wall");
         _loc1_.visible = this.var_78.getUnseenItemCount(UnseenItemCategoryEnum.const_439) > 0;
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_78.getGroupItemInIndex(_loc3_,this.var_494);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            ...
            if(_loc5_.category == FurniCategory.const_360)
            {
            ...
            {
               if(_loc5_.category == FurniCategory.const_223)
               {
         ...
         if(_loc5_ != null)
         {
            if(_loc5_.category == FurniCategory.const_1354)
            {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > const_1134)
         {
            _loc3_ = const_1134;
         }
         else if(_loc3_ < const_1131)
         {
            _loc3_ = const_1131;
         }
         else
         ...
         else if(param1.type == WindowEvent.const_47)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModelCategory.const_282);
            }
         }
      }
