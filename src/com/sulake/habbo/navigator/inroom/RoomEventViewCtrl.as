package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_2896:ITextWindow;
      
      private var var_2108:ITextWindow;
      
      private var var_2110:ITextWindow;
      
      private var var_1636:IButtonWindow;
      
      private var var_1634:IButtonWindow;
      
      private var var_2895:IButtonWindow;
      
      private var var_1635:IButtonWindow;
      
      private var var_1088:IDropMenuWindow;
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         this.var_2109.visible = true;
         this.var_2896.text = this._navigator.getText("roomevent_type_" + param1.eventType);
         this._eventNameInput.setText(param1.eventName);
         this.var_898.setText(param1.eventDescription);
         this.var_974.setText(this.getTagFromEvent(param1,1));
         this.var_973.setText(this.getTagFromEvent(param1,2));
         this.var_1636.visible = false;
         this.var_1634.visible = true;
         this.var_1635.visible = true;
         this.var_2108.visible = false;
         this.var_2110.visible = true;
      }
      
      private function createEvent() : void
      {
         this.var_1088.visible = true;
         this.var_2109.visible = false;
         ...
         this.var_1088.selection = 0;
         this.var_2108.visible = true;
         this.var_2110.visible = false;
      }
      ...
      {
         var _loc1_:int = this.var_1088.selection;
         return _loc1_ + 1;
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(this._window == null)
         {
            ...
            this.var_2109 = IWindowContainer(this.find("event_type_disabled_cont"));
            this.var_2896 = ITextWindow(this.find("event_type_disabled_text"));
            this.var_2108 = ITextWindow(this.find("create_caption"));
            this.var_2110 = ITextWindow(this.find("edit_caption"));
            this.var_1636 = IButtonWindow(this.find("create_button"));
            this.var_1634 = IButtonWindow(this.find("edit_button"));
            this.var_2895 = IButtonWindow(this.find("cancel_button"));
            this.var_1635 = IButtonWindow(this.find("end_button"));
            this.var_1088 = IDropMenuWindow(this.find("event_type"));
            this.prepareEventTypes();
            this.addMouseClickListener(this.var_1636,this.onCreateButtonClick);
            this.addMouseClickListener(this.var_1634,this.onEditButtonClick);
            this.addMouseClickListener(this.var_1635,this.onEndButtonClick);
            this.addMouseClickListener(this.var_2895,this.onCancelButtonClick);
            ...
            this.var_974 = new TextFieldManager(this._navigator,this.getInput("event_tag_1"),25);
            this.var_973 = new TextFieldManager(this._navigator,this.getInput("event_tag_2"),25);
