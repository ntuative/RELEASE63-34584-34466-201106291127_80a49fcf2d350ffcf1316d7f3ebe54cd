package com.sulake.habbo.ui.widget.notification
{
   ...
   public class UserNotificationView implements IDisposable
   {
      ...
      protected static const const_2038:String = "button_ok";
      
      protected static const const_2039:String = "text_title";
      ...
      public function showNotification(param1:String, param2:String) : Boolean
      {
         ...
         dialog.findChildByName(const_2039).caption = title;
         dialog.findChildByName(DESCRIPTION_NAME).caption = description;
         dialog.center();
         dialog.findChildByName(const_2038).addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,function(param1:WindowMouseEvent):void
         {
      ...
      public function hideNotification(param1:IFrameWindow) : void
      {
         ...
         if(param1 != null)
         {
            _loc2_ = this.var_619.indexOf(param1);
            if(_loc2_ > -1)
            {
