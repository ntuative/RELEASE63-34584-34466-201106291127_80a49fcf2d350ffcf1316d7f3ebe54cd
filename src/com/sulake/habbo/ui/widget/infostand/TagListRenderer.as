package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_2362:int = 5;
      ...
      private var var_1207:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1208 = 0;
         this.var_1207 = param2.rectangle.clone();
         this.var_1207.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1207.width)
         {
            return false;
         }
         if(this.var_1208 + param1.height > this.var_1207.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1207.width)
         {
            this._offsetX = 0;
            this.var_1208 += param1.height + this.const_2362;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1208);
         this._offsetX += param1.width + this.const_2361;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1539 != null && this.var_1539.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_187);
