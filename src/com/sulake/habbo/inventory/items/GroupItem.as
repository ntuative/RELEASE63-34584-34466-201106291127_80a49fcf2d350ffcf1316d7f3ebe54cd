package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private static const const_1475:int = 10275685;
      ...
      protected var var_2354:int;
      
      protected var var_1700:Boolean;
      
      protected var var_2245:Boolean;
      
      protected var var_3041:BitmapData;
      
      private var var_1484:Boolean;
      
      private const const_2084:Number = 1;
      
      private const const_2085:Number = 0.2;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2247 == FurniModelCategory.const_35)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1626));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2246);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_851)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_2085;
               _loc1_.blend = this.const_2085;
            }
            else
            {
               this._window.blend = this.const_2084;
               _loc1_.blend = this.const_2084;
            }
         }
         this.var_1465.color = !!this.var_1484 ? uint(const_1475) : uint(const_1474);
         ...
         if(_loc5_)
         {
            if(this.var_2245 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_3041;
               _loc5_.visible = true;
            }
            else
            {
