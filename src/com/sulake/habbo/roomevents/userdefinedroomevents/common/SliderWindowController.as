package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private var var_1177:Number = 1.0;
      
      private var var_618:Number = 0.0;
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1177,param1);
         this.var_959 = param1;
         if(param2)
         {
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_959);
         }
      ...
      {
         return int(this.var_1756 * (Number(param1 - this._minValue) / (this.var_1177 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1756 * (this.var_1177 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_958)
         {
            if(param1.type == WindowMouseEvent.const_55 || param1.type == WindowMouseEvent.const_262)
            {
               this.var_958 = false;
            }
         }
         if(!this.var_958 || param1.type != WindowEvent.const_429)
         {
            return;
         }
         if(this.var_618 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_618) * this.var_618;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_618 != 0)
            {
               _loc3_ = this.var_959 + this.var_618;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && this.var_769 != null)
            {
               _loc2_.bitmap = new BitmapData(this.var_769.width,this.var_769.height,true,16777215);
               _loc2_.bitmap.copyPixels(this.var_769,this.var_769.rect,new Point(0,0),null,null,true);
               _loc2_.procedure = this.sliderProcedure;
               this.var_1756 = _loc1_.width - _loc2_.width;
            }
         }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_769 = BitmapData(_loc2_.content);
      }
   }
}
