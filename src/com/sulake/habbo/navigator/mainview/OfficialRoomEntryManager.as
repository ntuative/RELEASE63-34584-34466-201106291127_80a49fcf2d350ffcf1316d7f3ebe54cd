package com.sulake.habbo.navigator.mainview
{
   ...
   public class OfficialRoomEntryManager implements IDisposable
   {
      ...
      private static const const_1704:int = 267;
      
      private static const const_1705:int = 65;
      
      private static const const_1703:int = -70;
      ...
      private var var_1228:UserCountRenderer;
      
      private var var_2975:PublicRoomThumbs;
      
      public function OfficialRoomEntryManager(param1:HabboNavigator)
      {
         this.var_2975 = new PublicRoomThumbs();
         super();
         this._navigator = param1;
         this.var_1228 = new UserCountRenderer(this._navigator);
      }
      ...
      public function createEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT,this.onCellMouseOut);
      ...
      public function refreshEntry(param1:IWindowContainer, param2:Boolean, param3:int, param4:OfficialRoomEntryData) : void
      {
         ...
         if(param2)
         {
            ...
            if(param4.type == OfficialRoomEntryData.const_1867)
            {
      ...
      private function refreshUserCount(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param2.showDetails && (param2.type == OfficialRoomEntryData.const_878 || param2.type == OfficialRoomEntryData.const_782))
         {
            _loc3_ = 3;
            _loc4_ = 34;
            _loc5_ = 13;
            this.var_1228.refreshUserCount(param2.maxUsers,param1,param2.userCount,"${navigator.usercounttooltip.users}",param1.width - _loc3_ - _loc4_,param1.height - _loc3_ - _loc5_);
         }
      }
      ...
      private function refreshCell(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         _loc3_.visible = true;
         _loc3_.width = !!param2.showDetails ? int(const_1705) : int(const_1704);
      ...
      {
         var _loc4_:String = this.var_2975.resolveRoomImageName(param2);
         ...
         param3.x = !!param2.showDetails ? int(const_1703) : 0;
      ...
      private function handleClick(param1:IWindow) : void
      {
         ...
         else if(_loc2_.tag != null)
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_258,Tabs.const_499,_loc2_.tag);
         }
