package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerCatalogWidget extends CatalogWidget implements ICatalogWidget, IRecyclerVisualization
   {
      ...
      private var var_304:CatalogObjectMover;
      ...
      private function renderSlotGraphics() : void
      {
         ...
         _loc2_ = 1;
         while(_loc2_ <= RecyclerLogic.const_227)
         {
      ...
      public function updateSlots() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < RecyclerLogic.const_227)
         {
      ...
      private function onMainContainerEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT:
               if(this.var_304 != null)
               {
                  this.var_304.resetIcon();
               }
               break;
            case WindowMouseEvent.const_185:
               if(this.var_304 != null)
               {
                  this.var_304.onMainContainerEvent(param1,param2,_loc4_);
               }
               break;
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               if(this.var_304 == null)
               {
                  this.var_304 = new CatalogObjectMover();
                  this.var_304.mainContainer = window;
                  this.var_304.roomEngine = _loc3_;
               }
         }
      }
