package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1534:String = "_TITLE";
      
      private static const const_1532:String = "_HEADER";
      
      private static const const_1531:String = "_CONTENT";
      ...
      private var var_1509:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1534) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1509 = findChildByTag(const_1532) as IHeaderWindow;
            if(!this.var_1509)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_203 = findChildByTag(const_1531) as IWindowContainer;
            if(!this.var_203)
            {
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1411,_loc2_,false);
      ...
      {
         return this.content != null && this.var_1144 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_370);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_251);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_296);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_259,_loc3_.left,PropertyStruct.const_36,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_297,_loc3_.top,PropertyStruct.const_36,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_283,0 - _loc3_.right,PropertyStruct.const_36,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_287,0 - _loc3_.bottom,PropertyStruct.const_36,_loc2_));
         return _loc1_;
      }
