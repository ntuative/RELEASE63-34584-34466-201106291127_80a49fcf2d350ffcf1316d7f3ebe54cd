package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1086:uint = 4284532064;
      
      private static const const_1085:uint = 2577770;
      ...
      private var var_668:ItemPopupCtrl;
      ...
      private var var_1034:GroupItem;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_668 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1933 = this.createMinimizedWindow();
         }
         if(!this.var_1155)
         {
            return this.var_80;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_80)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_19.ownUserAccepts ? uint(const_1086) : uint(const_1085);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_19.otherUserAccepts ? uint(const_1086) : uint(const_1085);
            }
      ...
      public function removeSelection() : void
      {
         if(this.var_1034)
         {
            this.var_1034.isSelected = false;
            this.var_1034 = null;
         }
      }
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1941)
            {
            ...
            this.var_668.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_521);
            this.var_668.show();
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT)
         {
            this.var_668.hideDelayed();
         }
      }
      ...
      private function getTraxSongFurniName(param1:GroupItem, param2:String, param3:Boolean, param4:uint = 1.0, param5:Boolean = false) : String
      {
         ...
         else if(param3)
         {
            ...
            this.var_201.push(param4);
            this.var_201.push(param1);
            this.var_201.push(param5);
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_201.length > 0)
         {
            _loc2_ = this.var_201.pop();
            _loc3_ = this.var_201.pop();
            _loc4_ = uint(this.var_201.pop());
            _loc5_ = _loc3_.peek();
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_19.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_19.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_668.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_521);
               }
            }
            else
            {
               this.var_201.push(_loc4_);
               this.var_201.push(_loc3_);
