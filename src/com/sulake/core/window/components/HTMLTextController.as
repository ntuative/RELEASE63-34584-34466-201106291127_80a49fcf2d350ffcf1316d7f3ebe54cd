package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_1056:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private var var_2012:StyleSheet = null;
      ...
      {
         this.var_869 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1297 == param2)
         {
            return;
         }
         param1.var_1297 = param2;
         param1.var_2012 = null;
         if(param1.var_1297 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1297);
            param1.var_2012 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_928.indexOf(param1) > -1)
         {
            this.var_869 = param1;
         }
      }
      ...
      {
         return this.var_869 == LinkTarget.const_30 ? defaultLinkTarget : this.var_869;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_18);
            _field.styleSheet = this.var_2012;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1236)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_869 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_780,this.var_869,PropertyStruct.const_50,true,PropertyDefaults.const_928));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1727);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_780)
            {
               this.var_869 = _loc2_.value as String;
               break;
            }
