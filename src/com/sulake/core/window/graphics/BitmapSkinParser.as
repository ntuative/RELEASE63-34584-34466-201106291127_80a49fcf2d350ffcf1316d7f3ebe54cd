package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_101:String = "UserInfoCtrl";
      
      public static const const_89:String = "active";
      
      public static const const_86:String = "focused";
      ...
      public static const const_90:String = "disabled";
         ...
         if(_loc8_.length() > 0)
         {
            ...
            switch(_loc6_.toLowerCase())
            {
               case "fixed":
                  ...
                  break;
               case "move":
                  _loc5_.var_355 = SkinLayoutEntity.const_372;
                  break;
               case "strech":
                  _loc5_.var_355 = SkinLayoutEntity.const_587;
                  break;
               case "tiled":
                  _loc5_.var_355 = SkinLayoutEntity.const_362;
                  break;
               case "center":
            ...
            {
               case "fixed":
                  _loc5_.var_357 = SkinLayoutEntity.const_568;
                  break;
               case "move":
                  _loc5_.var_357 = SkinLayoutEntity.const_372;
                  break;
               case "strech":
                  _loc5_.var_357 = SkinLayoutEntity.const_587;
                  break;
               case "tiled":
                  _loc5_.var_357 = SkinLayoutEntity.const_362;
                  break;
               case "center":
