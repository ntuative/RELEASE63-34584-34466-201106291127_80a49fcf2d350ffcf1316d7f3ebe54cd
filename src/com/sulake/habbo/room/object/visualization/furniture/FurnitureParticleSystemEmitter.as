package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1823:String = "cone";
      
      public static const const_1820:String = "plane";
      
      public static const const_1812:String = "sphere";
      ...
      private var var_1099:Number = 0.1;
      ...
      public function reset() : void
      {
         ...
         this.var_1098 = 0;
         this.var_1020 = false;
         this.init(0,0,0,this._direction,this.var_2929,this.var_1099,this.var_2927,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1360.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_1020 = true;
         if(this.var_1098 < this.var_1650)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2925)
         {
            switch(this.var_2926)
            {
               case const_1823:
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_1099,_loc6_,_loc7_,_loc9_,_loc8_);
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1360.length);
         return this.var_1360[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_1098 < this.var_1650)
         {
            if(this.age % this.var_2930 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_1098 < this.var_1650)
         {
            ...
            this.y = (2 - this.var_305) * this.y - (1 - this.var_305) * this.lastY + this.var_2130 * this.var_1099 * this.var_1099;
         ...
         for each(_loc2_ in this.var_417)
         {
            ...
            _loc2_.y = (2 - this.var_305) * _loc2_.y - (1 - this.var_305) * _loc2_.lastY + this.var_2130 * this.var_1099 * this.var_1099;
