package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_2378:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_598,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_67.getValue(InventoryCategory.const_75));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_67.getValue(InventorySubCategory.const_346));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_67.getValue(InventoryCategory.const_155));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_67.getValue(InventoryCategory.const_228));
      }
      ...
      public function get recyclerModel() : RecyclerModel
      {
         ...
         return RecyclerModel(this.var_67.getValue(InventorySubCategory.const_1336));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_67.getValue(InventoryCategory.const_131));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_67.getValue(InventoryCategory.const_459) as MarketplaceModel;
      }
      ...
      {
         return this.var_114.clubDays;
      }
      
      public function get clubPeriods() : int
      {
         return this.var_114.clubPeriods;
      }
      
      public function get clubPastPeriods() : int
      {
         return this.var_114.clubPastPeriods;
      }
      
      public function get clubHasEverBeenMember() : Boolean
      {
         return this.var_114.clubHasEverBeenMember;
      }
      
      public function get clubIsExpiring() : Boolean
      {
         return this.var_114.clubIsExpiring;
      }
      ...
      {
         this.var_114.clubPeriods = param1;
         this.var_114.clubDays = param2;
         this.var_114.clubHasEverBeenMember = param3;
         this.var_114.isVIP = param4;
         this.var_114.clubIsExpiring = param5;
      ...
      {
         this.var_416 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionPropertyUpdateEvent.const_598,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_82:
               ...
               break;
            case RoomSessionPropertyUpdateEvent.const_598:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_416 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_15 || !this._toolbar || !this._soundManager)
         {
            return;
         }
         ...
         this.var_67.add(InventoryCategory.const_459,_loc1_);
         ...
         this.var_67.add(InventoryCategory.const_75,_loc2_);
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_416);
         this.var_67.add(InventoryCategory.const_228,_loc3_);
         ...
         this.var_67.add(InventoryCategory.const_155,_loc4_);
         ...
         this.var_67.add(InventorySubCategory.const_346,_loc5_);
         ...
         this.var_67.add(InventorySubCategory.const_1336,_loc6_);
         ...
         this.var_67.add(InventoryCategory.const_131,_loc7_);
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_1109.indexOf(param1) == -1)
            {
               this.var_1109.push(param1);
            }
         }
         else
         {
            _loc3_ = this.var_1109.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_1109.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_1109.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2378);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_312));
      }
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(_loc1_ != this.var_2957)
         {
            this.var_2957 = _loc1_;
