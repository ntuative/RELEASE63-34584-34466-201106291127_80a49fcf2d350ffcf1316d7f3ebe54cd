package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_860)
         {
            this.var_860 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_860)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_861)
         {
            this.var_861 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_861)
            {
               return;
            }
