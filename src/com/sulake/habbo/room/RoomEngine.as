package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_714:String = "temporary_room";
      
      private static const const_393:int = -1;
      
      private static const const_713:String = "room";
      
      private static const const_1119:int = -2;
      
      private static const const_1647:String = "tile_cursor";
      ...
      private var var_879:IRoomObjectFactory = null;
      
      private var var_596:IRoomObjectVisualizationFactory = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_880 = new NumberBank(1000);
         this.var_1322 = new Map();
         this.var_410 = new Map();
         this.var_73 = new RoomObjectEventHandler(this);
         this.var_488 = new RoomMessageHandler(this);
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_879.release(new IIDRoomObjectFactory());
            this.var_879 = null;
         }
         if(this.var_596 != null)
         {
            this.var_596.release(new IIDRoomObjectVisualizationFactory());
            this.var_596 = null;
         }
         ...
         if(this.var_346)
         {
            this.var_346.release(new IIDHabboAdManager());
            this.var_346 = null;
         }
         if(this.var_416)
         {
         ...
         if(this.var_295 != null)
         {
            ...
            {
               _loc2_ = this.var_295.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function getRoomInstanceData(param1:int, param2:int) : RoomInstanceData
      {
         ...
         if(this.var_295 != null)
         {
            _loc4_ = this.var_295.getValue(_loc3_) as RoomInstanceData;
            if(_loc4_ == null)
            {
               _loc4_ = new RoomInstanceData(param1,param2);
               this.var_295.add(_loc3_,_loc4_);
            }
         }
         return _loc4_;
      }
      ...
      {
         this.var_1321 = false;
         if(this.var_576 && this.var_576.length > 0)
         {
      ...
      public function requestMouseCursor(param1:String, param2:int, param3:String) : void
      {
         ...
         switch(param1)
         {
            case RoomObjectFurnitureActionEvent.const_284:
      ...
      private function addBtnMouseCursorOwner(param1:int, param2:int) : void
      {
         ...
         if((param1 == RoomObjectCategoryEnum.const_26 || param1 == RoomObjectCategoryEnum.const_25) && !_loc3_.isRoomController)
         {
            return;
         }
         var _loc4_:String = param1 + "_" + param2;
         var _loc5_:int = this.var_576.indexOf(_loc4_);
         if(_loc5_ == -1)
         {
      ...
      private function removeBtnMouseCursorOwner(param1:int, param2:int) : void
      {
         ...
         var _loc4_:int = this.var_576.indexOf(_loc3_);
         if(_loc4_ > -1)
         {
      ...
      public function addFloorHole(param1:int, param2:int, param3:int) : void
      {
         ...
         if(param3 >= 0)
         {
            ...
            if(_loc5_ != null && _loc5_.getModel() != null && _loc4_ != null && _loc4_.getEventHandler() != null)
            {
               ...
               _loc9_ = _loc5_.getModel().getNumber(RoomObjectVariableEnum.const_304);
               _loc10_ = _loc5_.getModel().getNumber(RoomObjectVariableEnum.const_326);
      ...
      private function createRoomFurniture() : void
      {
         ...
         do
         {
            for each(_loc4_ in _loc8_)
            {
               ...
               while(!this.var_1072 && (_loc6_ = _loc4_.getWallItemData()) != null)
               {
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         {
            _loc5_ = this.var_295.getWithIndex(_loc3_) as RoomInstanceData;
            _loc6_ = null;
            _loc7_ = 0;
            _loc8_ = 0;
            if(_loc5_ != null)
            ...
            if(_loc6_ != null)
            {
               ...
               if(_loc11_ != null)
               {
                  if(_loc7_ != this.var_89 || _loc8_ != this.var_88 || !this.var_1073)
                  {
         ...
         if(_loc4_ != null)
         {
            if(this.var_1073)
            {
               _loc4_.screenOffsetX += this.var_1604;
               _loc4_.screenOffsetY += this.var_1602;
               this.var_1604 = 0;
               this.var_1602 = 0;
            }
         }
         ...
         if(_loc8_ != null && _loc9_ != null && _loc10_ != null)
         {
            ...
            if(_loc12_ != null)
            {
               ...
               if(_loc9_.screenWd != _loc13_ || _loc9_.screenHt != _loc14_ || _loc9_.scale != _loc8_.scale || _loc9_.geometryUpdateId != _loc8_.updateId || !Vector3d.isEqual(param4,_loc9_.targetObjectLoc) || _loc9_.isMoving)
               {
                  ...
                  _loc17_ = _loc10_.getNumber(RoomVariableEnum.const_800) - 0.5;
                  _loc18_ = _loc10_.getNumber(RoomVariableEnum.const_730) - 0.5;
                  _loc19_ = _loc10_.getNumber(RoomVariableEnum.const_983) + 0.5;
                  _loc20_ = _loc10_.getNumber(RoomVariableEnum.const_858) + 0.5;
      ...
      private function onObjectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_879 = param2 as IRoomObjectFactory;
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_596 = param2 as IRoomObjectVisualizationFactory;
         if(this.var_14 != null)
         {
            this.var_14.visualizationFactory = this.var_596;
         }
         this.initializeRoomManager();
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this._roomManager != null)
         {
            ...
            this._roomManager.addObjectUpdateCategory(RoomObjectCategoryEnum.const_28);
            this._roomManager.addObjectUpdateCategory(RoomObjectCategoryEnum.const_322);
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_488 != null)
            {
               this.var_488.connection = param1;
            }
         }
      }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_14 != null)
         {
            events.addEventListener(RoomContentLoader.const_869,this.onContentLoaderReady);
            this.var_14.initialize(events,this.var_151);
         }
         this.var_2827 = this.var_151.getKey("room.dragging.always_center","0") == "1";
         this.initializeRoomManager();
      }
      
      private function onContentLoaderReady(param1:Event) : void
      {
         if(param1 != null && param1.type == RoomContentLoader.const_869)
         {
            this.var_2828 = true;
            this.initializeRoomManager();
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_346 = param2 as IAdManager;
         this.var_346.events.addEventListener(AdEvent.const_671,this.showRoomAd);
         this.var_346.events.addEventListener(AdEvent.const_740,this.onRoomAdImageLoaded);
         this.var_346.events.addEventListener(AdEvent.const_1388,this.onRoomAdImageLoaded);
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_14.sessionDataManager = this.var_416;
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_71:
               if(this.var_488)
               {
                  this.var_488.setCurrentRoom(param1.session.roomId,param1.session.roomCategory);
               }
               break;
            case RoomSessionEvent.const_82:
               if(this.var_488)
               {
                  this.var_488.resetCurrentRoom();
      ...
      private function initializeObjectEvents() : void
      {
         if(this.var_879 != null)
         {
            this.var_879.addObjectEventListener(this.roomObjectEventHandler);
         }
      }
      
      private function initializeRoomManager() : void
      {
         if(this.var_879 == null || this.var_596 == null || this._roomManager == null || this._roomRendererFactory == null || this._communication == null || this.var_151 == null || !this.var_2828)
         {
            return;
         }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            this.var_577 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_947,0,0));
            _loc2_ = 0;
            while(_loc2_ < this.var_410.length)
            {
               _loc3_ = this.var_410.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function setIsPlayingGame(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         {
            _loc5_ = !!param3 ? 1 : 0;
            _loc4_.setNumber(RoomVariableEnum.const_1163,_loc5_);
            if(_loc5_ == 0)
            {
      ...
      public function getIsPlayingGame(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.getNumber(RoomVariableEnum.const_1163);
            if(_loc4_ > 0)
            {
               return true;
            }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         if(!this.var_577)
         {
            _loc5_ = this.var_410.remove(_loc4_);
            if(_loc5_ != null)
            {
            ...
            this.var_410.add(_loc4_,_loc5_);
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(this.isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_1180,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_1013,1,true);
            _loc12_ = parseInt(this.var_151.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_1326,_loc12_,true);
            if(this.var_14 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_393,const_713,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_1013,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_920,_loc10_,true);
         if(param2 != null)
         {
            _loc13_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_800,_loc15_);
               _loc7_.setNumber(RoomVariableEnum.const_983,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_730,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_858,_loc18_);
         ...
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         {
            ...
            if(param3 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_754,param3);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               _loc7_.setString(RoomObjectVariableEnum.const_220,param3);
            }
            if(param4 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_795,param4);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               _loc7_.setString(RoomObjectVariableEnum.const_209,param4);
            }
            if(param5 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_1014,param5);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               ...
               if(param2.doors.door.length() > 0)
               {
                  ...
                  while(_loc23_ < _loc20_.length())
                  {
                     ...
                     if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                     {
                        ...
                        _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_661,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_244);
                        _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                        if(_loc28_ == 90 || _loc28_ == 180)
                        {
                           if(_loc28_ == 90)
                           {
                              _loc7_.setNumber(RoomObjectVariableEnum.const_1010,_loc25_ - 0.5,true);
                              _loc7_.setNumber(RoomObjectVariableEnum.const_988,_loc26_,true);
                           }
                           if(_loc28_ == 180)
                           {
                              _loc7_.setNumber(RoomObjectVariableEnum.const_1010,_loc25_,true);
                              _loc7_.setNumber(RoomObjectVariableEnum.const_988,_loc26_ - 0.5,true);
                           }
                           _loc7_.setNumber(RoomObjectVariableEnum.const_1280,_loc27_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_1161,_loc28_,true);
                        }
                     }
                     _loc23_++;
                  }
         ...
         _loc7_.createRoomObject(const_1119,const_1647,RoomObjectCategoryEnum.const_322);
         if(this.var_151.getKey("avatar.widget.enabled","0") == "0")
         {
            _loc7_.createRoomObject(const_1120,const_1646,RoomObjectCategoryEnum.const_322);
         }
         return _loc7_;
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_393,RoomObjectCategoryEnum.const_85);
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null, param6:Boolean = false) : Boolean
      {
         ...
         if(_loc7_ == null)
         {
            ...
            _loc11_ = this.var_410.getValue(_loc10_);
            if(_loc11_ == null)
            {
               _loc11_ = new RoomData(param1,param2,null);
               this.var_410.add(_loc10_,_loc11_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            ...
            _loc9_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_754,param3);
         ...
         if(param4 != null)
         {
            ...
            _loc9_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_795,param4);
            _loc7_.getEventHandler().processUpdateMessage(_loc9_);
         }
         if(param5 != null)
         {
            ...
            _loc9_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_1014,param5);
            _loc7_.getEventHandler().processUpdateMessage(_loc9_);
         }
         return true;
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1899,param3,param4,param5);
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1272,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1399,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
      ...
      public function updateObjectRoomPlaneThicknesses(param1:int, param2:int, param3:Number, param4:Number) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlanePropertyUpdateMessage(RoomObjectRoomPlanePropertyUpdateMessage.const_1377,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlanePropertyUpdateMessage(RoomObjectRoomPlanePropertyUpdateMessage.const_695,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = this.var_295.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
      ...
      public function setOwnUserId(param1:int, param2:int, param3:int) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            _loc4_.targetCategory = RoomObjectCategoryEnum.const_28;
         }
      }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_1343;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_920);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1010);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_988);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1280);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1161);
      ...
      private function handleRoomDragging(param1:IRoomRenderingCanvas, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         var _loc10_:* = null;
         var _loc11_:* = null;
         var _loc8_:int = param2 - this.var_1605;
         ...
         if(param4 == MouseEvent.MOUSE_DOWN)
         {
            if(!param5 && !param6 && !param7)
            {
               this.var_1073 = true;
               this.var_881 = false;
               this.var_2829 = this.var_1605;
               this.var_2826 = this.var_1606;
            }
         }
         ...
         else if(param4 == MouseEvent.MOUSE_MOVE)
         {
            if(this.var_1073)
            {
               if(!this.var_881)
               {
                  _loc8_ = param2 - this.var_2829;
                  _loc9_ = param3 - this.var_2826;
               ...
               {
                  this.var_1604 += _loc8_;
                  this.var_1602 += _loc9_;
                  this.var_881 = true;
               }
            }
         }
            ...
            if(!this.handleRoomDragging(_loc9_,param2,param3,param4,param5,param6,param7))
            {
               if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
               {
                  ...
                  if(param4 == MouseEvent.CLICK)
                  {
                     if(events != null)
                     {
                        events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_511,this.var_89,this.var_88,-1,RoomObjectCategoryEnum.const_153));
                     }
                     _loc13_ = "null";
                  }
                  else if(param4 == MouseEvent.MOUSE_MOVE)
                  ...
                  if(this.var_73 != null)
                  {
                     _loc14_ = new RoomObjectMouseEvent(_loc13_,null,const_393,const_713);
                     this.var_73.handleRoomObjectEvent(_loc14_,this.var_89,this.var_88);
                  }
               }
            }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc6_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_89,this.var_88,this.var_1603);
         if(_loc6_ != null)
         {
            ...
            if(_loc10_ != null)
            {
               _loc10_.x = this.var_1605 - _loc5_.data.width / 2;
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_89,this.var_88,this.var_1603);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_89,this.var_88,this.var_1603);
         if(_loc1_ != null)
         {
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_73 != null)
         {
            return this.var_73.modifyRoomObject(this.var_89,this.var_88,param1,param2,param3);
         }
         return false;
      }
      ...
      public function modifyRoomObjectDataWithMap(param1:int, param2:int, param3:String, param4:Map) : Boolean
      {
         if(this.var_73 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_26)
            {
               return this.var_73.modifyRoomObjectData(this.var_89,this.var_88,param1,param2,param3,param4);
            }
         }
         return false;
      }
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_73 != null)
         {
            ...
            {
               return this.var_73.modifyWallItemData(this.var_89,this.var_88,param1,param3);
            }
         }
         return false;
      }
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(this.var_73 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_25)
            {
               return this.var_73.deleteWallItem(this.var_89,this.var_88,param1);
            }
         }
         return false;
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_1013) != 0)
         {
            return false;
         }
         if(this.var_73 != null)
         {
            return this.var_73.initializeRoomObjectInsert(this.var_89,this.var_88,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(this.var_73 != null)
         {
            this.var_73.cancelRoomObjectInsert(this.var_89,this.var_88);
         }
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_1120,RoomObjectCategoryEnum.const_322);
      }
      
      public function getTileCursor(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_1119,RoomObjectCategoryEnum.const_322);
      }
      ...
      private function addObjectFurnitureFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         {
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_270,_loc7_,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_268,param4.typeId,true);
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_434,_loc8_,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1021,1,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1196,param4.expiryTime);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1267,getTimer());
            if(param4.knownAsUsable)
            {
               _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_785,1);
            }
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_184,param1,param2,param3,RoomObjectCategoryEnum.const_26));
         }
         var _loc10_:ISelectedRoomObjectData = this.getPlacedObjectData(param1,param2);
         if(_loc10_ && Math.abs(_loc10_.id) == param3 && _loc10_.category == RoomObjectCategoryEnum.const_26)
         {
      ...
      public function changeObjectState(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         {
            _loc6_ = Number(_loc5_.getModelController().getNumber(RoomObjectVariableEnum.const_915));
            if(isNaN(_loc6_))
            {
               _loc6_ = 1;
            }
            ...
            _loc5_.getModelController().setNumber(RoomObjectVariableEnum.const_915,_loc6_);
         }
      }
      ...
      private function addObjectWallItemFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         {
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_270,_loc6_,false);
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_268,param4.typeId,true);
            _loc8_.getModelController().setString(RoomObjectVariableEnum.const_434,_loc7_,true);
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_1343,1,true);
            if(param4.knownAsUsable)
            {
               _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_785,1);
            }
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_184,param1,param2,param3,RoomObjectCategoryEnum.const_25));
         }
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1352) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_1242);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_661,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_986,_loc5_);
                  }
               }
            }
         }
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_184,param1,param2,param3,RoomObjectCategoryEnum.const_28));
         }
         return true;
      }
      ...
      public function updateObjectUserAction(param1:int, param2:int, param3:int, param4:String, param5:int, param6:String = null) : Boolean
      {
         ...
         switch(param4)
         {
            case RoomObjectVariableEnum.const_197:
            ...
            case RoomObjectVariableEnum.const_456:
               ...
               break;
            case RoomObjectVariableEnum.const_455:
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(this._roomManager != null)
         {
            ...
            if(_loc4_.disposeObject(param2,param3))
            {
               if(events != null)
               {
                  events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_395,this.var_89,this.var_88,param2,param3));
               }
            }
         }
      }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(this.var_73 != null)
         {
            this.var_73.handleRoomObjectEvent(param1,this.var_89,this.var_88);
         }
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_25:
                     _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.const_270));
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_380);
                     break;
         ...
         if(param2 != null)
         {
            ...
            if(_loc3_.length >= 3)
            {
               ...
               if(_loc7_ != null)
               {
                  _loc13_ = null;
                  _loc14_ = "undefined_1";
                  _loc13_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_661,_loc14_,_loc7_,new Vector3d(2.5,0.5,2));
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:uint = 0, param7:String = null, param8:int = -1, param9:int = -1) : ImageResult
      {
         ...
         _loc10_.id = -1;
         if(!this.var_577 || param1 == null)
         {
            return _loc10_;
         }
         var _loc11_:IRoomInstance = this._roomManager.getRoom(const_714);
         if(_loc11_ == null)
         {
            _loc11_ = this._roomManager.createRoom(const_714,null);
            if(_loc11_ == null)
            {
               return _loc10_;
            }
         }
         var _loc12_:int = this.var_880.reserveNumber();
         ...
         switch(_loc13_)
         {
            case RoomObjectCategoryEnum.const_26:
            case RoomObjectCategoryEnum.const_25:
               _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_270,int(param2));
               _loc14_.getModelController().setString(RoomObjectVariableEnum.const_380,param7);
               break;
            case RoomObjectCategoryEnum.const_28:
               ...
               {
                  _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_899,int(param2));
               }
               break;
         ...
         {
            this.var_1322.add(String(_loc12_),param5);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1372,param4,true);
         }
         else
         {
            _loc11_.disposeObject(_loc12_,_loc13_);
            this.var_880.freeNumber(_loc12_ - 1);
            _loc10_.id = 0;
         }
         _loc16_.dispose();
         return _loc10_;
      ...
      {
         return this.getRoomObjectBoundingRectangle(this.var_89,this.var_88,const_393,RoomObjectCategoryEnum.const_85,param1);
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = this._roomManager.getRoom(const_714);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1372);
               ...
               this.var_880.freeNumber(_loc10_ - 1);
               _loc13_ = this.var_1322.remove(String(_loc10_)) as IGetImageListener;
      ...
      public function objectInitialized(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc6_ != null && _loc6_.getModel() != null && _loc6_.getEventHandler() != null)
         {
            ...
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_871,_loc4_,_loc5_,param2,param3));
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(this.var_14 != null)
         {
            ...
            this.var_14.addGraphicAsset(this.var_14.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_447,param1.image,true);
            this.var_14.addGraphicAsset(this.var_14.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1327,param1.adWarningL,true);
            this.var_14.addGraphicAsset(this.var_14.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1328,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1227,RoomObjectVariableEnum.const_447,param1.clickUrl);
      ...
      public function requestRoomAdImage(param1:int, param2:int, param3:int, param4:int, param5:String, param6:String) : void
      {
         ...
         {
            this.var_346.loadRoomAdImage(param1,param2,param3,param4,param5,param6);
         }
      }
      ...
      private function onRoomAdImageLoaded(param1:AdEvent) : void
      {
         ...
         switch(param1.type)
         {
            case AdEvent.const_740:
               _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1264,param1.imageUrl,param1.clickUrl,param1.objectId,param1.image);
               break;
            case AdEvent.const_1388:
               _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1168,param1.imageUrl,param1.clickUrl,param1.objectId,param1.image);
         }
         if(_loc4_ != null)
         {
            _loc3_.getEventHandler().processUpdateMessage(_loc4_);
