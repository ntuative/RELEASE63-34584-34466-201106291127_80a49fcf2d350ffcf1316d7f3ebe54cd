package com.sulake.habbo.ui.widget.chooser
{
   ...
   public class ChooserView
   {
      ...
      public function populate(param1:Array, param2:Boolean) : void
      {
         ...
         while(_loc6_ < param1.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc5_.color = !!(_loc6_ % 2) ? uint(this.const_2106) : uint(this.const_2105);
      ...
      {
         var _loc2_:* = null;
         if(this._itemList == null || param1 < 0 || param1 > this._itemList.numListItems || param1 == this.var_1110)
         {
            return;
         }
         if(this.var_1110 != -1)
         {
            _loc2_ = this._itemList.getListItemAt(this.var_1110) as IWindowContainer;
            if(_loc2_ != null)
            {
               _loc2_.color = !!(this.var_1110 % 2) ? uint(this.const_2106) : uint(this.const_2105);
            }
         }
      ...
      public function method_4(param1:int, param2:int) : void
      {
         var _loc3_:* = null;
         ...
         this.populate(this._items,this.var_2152);
      }
