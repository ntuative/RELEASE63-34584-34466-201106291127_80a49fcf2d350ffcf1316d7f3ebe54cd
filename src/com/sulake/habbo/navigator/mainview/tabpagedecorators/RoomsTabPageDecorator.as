package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_156:IDropMenuWindow;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_156 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
            this.prepareRoomCategories();
            this.var_156.addEventListener(WindowEvent.const_47,this.onFilterSelected);
         }
         _loc3_.visible = true;
      }
      ...
      public function tabSelected() : void
      {
         if(this.var_156 != null)
         {
            this.var_156.removeEventListener(WindowEvent.const_47,this.onFilterSelected);
            this.var_156.selection = 0;
            this.var_156.addEventListener(WindowEvent.const_47,this.onFilterSelected);
         }
      }
      ...
      private function startSearch() : void
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:int = this.var_156 == null ? 0 : int(this.var_156.selection);
         Logger.log("Room filter changed: " + _loc1_);
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_231,Tabs.const_405);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_231,Tabs.const_792);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_231,Tabs.const_405,"" + _loc3_);
         }
         if(this.var_156)
         {
            this._navigator.trackNavigationDataPoint(this.var_156.enumerateSelection()[this.var_156.selection],"category.view");
         }
      }
      
      public function get filterCategory() : String
      {
         return !!this.var_156 ? this.var_156.enumerateSelection()[this.var_156.selection] : null;
      }
   }
}
