package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1615:int = HabboMusicPrioritiesEnum.const_122;
      ...
      private var var_563:IPlayListController = null;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_967,this.onJukeboxInit);
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_256,this.onJukeboxDispose);
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_923,this.onSoundMachineInit);
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_853,this.onSoundMachineDispose);
         this.var_1288 = new Timer(1000);
         this.var_1288.start();
         this.var_1288.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
         ...
         {
            this.var_345[_loc6_] = null;
            this.var_858[_loc6_] = 0;
            _loc6_++;
         }
      }
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_1989)
            {
               this.resetSongStartRequest(this._priorityPlaying);
            }
            _loc2_ = this._priorityPlaying;
            this.playSongWithHighestPriority();
            if(_loc2_ >= HabboMusicPrioritiesEnum.const_430)
            {
               this._events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_126,_loc2_,param1.id,-1));
            }
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_292)
            {
               ...
               {
                  _loc3_ = this.var_292.getWithIndex(_loc2_) as SongDataEntry;
            ...
            if(this.var_92)
            {
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_967,this.onJukeboxInit);
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_256,this.onJukeboxDispose);
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_923,this.onSoundMachineInit);
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_853,this.onSoundMachineDispose);
            }
      ...
      private function addSongStartRequest(param1:int, param2:int, param3:Number, param4:Number, param5:Number, param6:Number) : Boolean
      {
         ...
         this.var_345[param1] = _loc7_;
         this.var_858[param1] += 1;
         return true;
      }
      
      private function getSongStartRequest(param1:int) : SongStartRequestData
      {
         return this.var_345[param1];
      }
      ...
      private function getSongIdRequestedAtPriority(param1:int) : int
      {
         ...
         if(this.var_345[param1] == null)
         {
            return -1;
         }
         var _loc2_:SongStartRequestData = this.var_345[param1];
      ...
      private function getSongRequestCountAtPriority(param1:int) : int
      {
         ...
         return this.var_858[param1];
      }
      
      private function getTopRequestPriority() : int
      {
         var _loc1_:int = this.var_345.length - 1;
         while(_loc1_ >= 0)
         {
            if(this.var_345[_loc1_] != null)
            {
               return _loc1_;
            }
            _loc1_--;
      ...
      private function getSongDataEntry(param1:int) : SongDataEntry
      {
         ...
         {
            _loc2_ = this.var_292.getValue(param1) as SongDataEntry;
         }
         return _loc2_;
      }
      ...
      private function requestSong(param1:int, param2:Boolean) : void
      {
         ...
         {
            this.var_680.add(param1,param2);
      ...
      {
         if(param1 >= 0 && param1 < this.var_405.length)
         {
            return this.var_405.getKey(param1);
         }
         return -1;
      }
      ...
      public function getSongDiskInventorySongId(param1:int) : int
      {
         if(param1 >= 0 && param1 < this.var_405.length)
         {
            return this.var_405.getWithIndex(param1);
         }
         return -1;
      }
      ...
      public function samplesUnloaded(param1:Array) : void
      {
         ...
         while(_loc2_ < this.var_292.length)
         {
            ...
            if(_loc3_.id != this.var_1564 && _loc4_ != null && _loc4_.ready)
            {
      ...
      public function get samplesIdsInUse() : Array
      {
         ...
         {
            if(this.var_345[_loc2_] != null)
            {
               _loc3_ = this.var_345[_loc2_];
               _loc4_ = this.var_292.getValue(_loc3_.songId);
               if(_loc4_ != null)
               {
      ...
      private function sendNextSongRequestMessage(param1:TimerEvent) : void
      {
         ...
         this._connection.send(new GetSongInfoMessageComposer(this.var_856));
         Logger.log("Requested song info\'s : " + this.var_856);
         this.var_856 = new Array();
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               this.var_292.add(_loc6_.id,_loc10_);
               ...
               while(this.var_857.indexOf(_loc6_.id) != -1)
               {
                  this.var_857.splice(this.var_857.indexOf(_loc6_.id),1);
                  if(this.var_857.length == 0)
                  {
      ...
      private function playSongObject(param1:int, param2:int) : Boolean
      {
         ...
         this.var_1989 = this.getSongRequestCountAtPriority(param1);
         this.var_1564 = param2;
         if(this._priorityPlaying <= const_1615)
         {
            this.notifySongPlaying(_loc4_);
         }
         if(param1 > HabboMusicPrioritiesEnum.const_122)
         {
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2752 != param1.id || _loc3_ > this.var_2753 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2752 = param1.id;
      ...
      private function areSamplesRequested(param1:int) : Boolean
      {
         ...
         return this.var_680.getValue(param1);
      }
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_563 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_92,this._connection) as IPlayListController;
      }
      ...
      {
         this.disposeRoomPlaylist();
         this.var_563 = new JukeboxPlayListController(this._soundManager,this,this._events,this._connection) as IPlayListController;
