package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1678:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_731 = BitmapData(_loc7_.content);
         }
         ...
         this._thumbWidth = this.var_731.width;
         this.var_107 = this.var_731.height;
         this.var_1385 = param5;
         this.var_1125 = param6;
         this.var_265 = Math.floor(this.var_1385 / this._thumbWidth);
         this.var_29 = new BitmapData(this.var_1385,this.var_1125);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         this.var_732 = this.resolveRowCountFromList();
         if(this.var_732 == 0)
         {
            this.var_29 = new BitmapData(this.var_1385,this.var_1125);
            return;
         }
         this.var_29 = new BitmapData(Math.max(this.var_265 * this._thumbWidth,this.var_1385),Math.max(this.var_732 * this.var_107,this.var_1125),true,16777215);
         this.var_29.fillRect(this.var_29.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = this.getList();
         var _loc3_:int = 0;
         while(_loc3_ < this.var_732)
         {
            _loc4_ = 0;
            while(_loc4_ < this.var_265)
            {
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_265 && this.var_29.height < _loc3_.y * this.var_107)
         {
         ...
         _loc4_ = new Rectangle(0,0,this._thumbWidth * (this.var_265 - 1),this.var_107);
         _loc2_.copyPixels(this.var_29,_loc4_,new Point(this._thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(this._thumbWidth * (this.var_265 - 1),0,this._thumbWidth,this.var_29.height);
         _loc2_.copyPixels(this.var_29,_loc4_,new Point(0,this.var_107),null,null,true);
         _loc4_ = new Rectangle(0,this.var_107,this._thumbWidth * (this.var_265 - 1),this.var_29.height - this.var_107);
      ...
      private function getList() : Array
      {
         ...
         {
            _loc1_ = this.var_1678.getDrawableList();
         }
      ...
      private function resolveRowCountFromList() : int
      {
         ...
         return int(Math.ceil(_loc1_.length / this.var_265));
      }
      ...
      {
         var _loc2_:Point = this.resolveGridLocationFromImage(param1);
         return int(_loc2_.y * this.var_265 + _loc2_.x);
      }
      ...
      {
         var _loc2_:int = Math.floor(param1 / this.var_265);
         var _loc3_:int = param1 % this.var_265;
         return new Point(_loc3_,_loc2_);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         var _loc11_:* = null;
         var _loc12_:* = null;
         if(param1.x >= this.var_265)
         {
            return;
         }
         if(param1.y >= this.var_732)
         {
            return;
         }
         var _loc4_:int = this.var_265 - param1.x - 1;
         ...
         if(this.var_29.height < this.var_1125)
         {
            _loc12_ = new BitmapData(this.var_29.width,this.var_1125);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(this.var_731.width,this.var_731.height);
         if(param2)
         {
            _loc3_.copyPixels(this._itemBgImageSelected,this.var_731.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(this.var_731,this.var_731.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
