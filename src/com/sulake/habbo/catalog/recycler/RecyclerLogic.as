package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_687 != const_1107;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_2021 != RecyclerStatusMessageEvent.const_1308;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_687 == const_483;
      }
      ...
      public function init(param1:IRecyclerVisualization = null) : void
      {
         ...
         this.var_138 = new Array(const_227);
         if(param1 == null)
         {
            return;
         }
      ...
      public function cancel() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < const_227)
         {
            this.releaseSlot(_loc1_);
            _loc1_++;
         }
         this.var_687 = const_1107;
      }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_2021)
         {
            case RecyclerStatusMessageEvent.const_1814:
               this.var_687 = const_483;
            ...
            case RecyclerStatusMessageEvent.const_1308:
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1804:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1371:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1796:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(this.var_138.length > 0)
         {
            ...
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_227)
            {
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_138.length < const_227)
         {
            return false;
         }
         var _loc1_:int = 0;
