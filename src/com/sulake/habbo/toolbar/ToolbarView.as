package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private static const const_1443:Point = new Point(3,3);
      
      private static const const_1486:uint = 7433577;
      
      private static const const_1480:uint = 5723213;
      
      private static const const_470:String = "_hover";
      
      private static const const_472:String = "_normal";
      
      private static const const_471:int = 5;
      
      private static const const_1483:int = 600;
      
      private static const const_1485:int = 80;
      
      private static const const_1481:int = 74;
      
      private static const ICON_SPACING_NORMAL:int = 10;
      
      private static const const_1484:int = -2;
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         this._window.position = const_1443;
         ...
         for each(_loc10_ in _loc9_)
         {
            if(_loc10_)
            {
               ...
               _loc10_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT,this.onIconHoverMouseEvent);
            }
         }
         _loc9_ = new Array();
         ...
         {
            this.setIconHoverState(_loc11_,const_472);
         }
         ...
         this.var_213 = param2.buildFromXML(_loc12_.content as XML,2) as IWindowContainer;
         ...
         _loc13_.addChild(this.var_213);
         var _loc14_:ITextWindow = this.var_213.findChildByName("new_textfield") as ITextWindow;
         ...
         this.var_213.x = _loc13_.width - this.var_213.width - const_471;
         this.var_213.y = const_471;
         this.var_2516 = this.isNewItemsNotificationEnabled();
      ...
      private function checkSize(param1:Boolean = false) : void
      {
         ...
         var _loc2_:* = this._windowManager.getDesktop(2).height < const_1483;
         if(!param1 && _loc2_ == this.var_1488)
         {
            return;
         }
         this.var_1488 = _loc2_;
         var _loc3_:int = !!_loc2_ ? int(const_1481) : int(const_1485);
         var _loc4_:int = !!_loc2_ ? int(const_1484) : int(ICON_SPACING_NORMAL);
         ...
         while(_loc7_ < _loc5_.length)
         {
            ...
            _loc6_.y = const_1479 + _loc7_ * (_loc3_ + _loc4_);
            _loc7_++;
         }
         this._window.height = _loc6_.rectangle.bottom + const_1482;
      }
      ...
      private function onCatalogEvent(param1:CatalogEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case CatalogEvent.CATALOG_NEW_ITEMS_SHOW:
               if(this.var_213 != null && this.var_2516)
               {
      ...
      public function setToolbarState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case HabboToolbarEnum.const_940:
               _loc3_ = false;
               break;
            case HabboToolbarEnum.const_798:
               _loc3_ = true;
         }
      ...
      private function onIconHoverMouseEvent(param1:WindowMouseEvent) : void
      {
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               this.setIconHoverState(_loc4_,const_470);
               this.setIconBgHoverState(_loc3_,const_470);
               break;
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT:
               this.setIconHoverState(_loc4_,const_472);
               this.setIconBgHoverState(_loc3_,const_472);
         }
      }
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_470 ? this.var_1490 : this.var_1489;
         }
         else
         {
      ...
      private function setIconBgHoverState(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(param2 == const_470)
         {
            param1.color = const_1486;
         }
         else
         {
            param1.color = const_1480;
         }
      }
      ...
      public function getIconVerticalLocation(param1:String) : int
      {
         switch(param1)
         {
            case HabboToolbarIconEnum.NAVIGATOR:
               return !!this.var_1488 ? 45 : 50;
            case HabboToolbarIconEnum.QUESTS:
               return !!this.var_1488 ? 125 : 140;
            default:
               return 0;
         }
      }
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         ...
         this.var_1489 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1490)
         {
            this.var_1490.dispose();
         }
         this.var_1490 = this.addShadow(param1,new Point(4,5),4281150249);
         param1.dispose();
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindowContainer
      {
         ...
         var _loc2_:IWindowContainer = this.var_983.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
            ...
            _loc2_.x = _loc4_.width - _loc2_.width - const_471;
            _loc2_.y = const_471;
            this.var_983.add(param1,_loc2_);
         }
         return _loc2_;
      }
