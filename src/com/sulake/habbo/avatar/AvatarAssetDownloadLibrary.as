package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadLibrary extends EventDispatcher
   {
      ...
      private static var var_1742:int = 1;
      ...
      public function AvatarAssetDownloadLibrary(param1:String, param2:String, param3:String, param4:IAssetLibrary)
      {
         ...
         this._state = name_4;
         this._assets = param4;
         this.var_763 = String(param1);
         this._revision = String(param2);
         this.var_1171 = param3 + this.var_763 + ".swf";
         this.var_1171 = this.var_1171.replace("%revision%",this._revision);
         var _loc5_:AssetLibraryCollection = this._assets as AssetLibraryCollection;
         var _loc6_:IAssetLibrary = _loc5_.getAssetLibraryByUrl(this.var_763 + ".swf");
         if(_loc6_ != null)
         {
            Logger.log("[AvatarAssetDownloadLibrary] Already Downloaded by Core: " + this.var_763);
            this._state = name_5;
         }
      }
      ...
      {
         this._state = var_1742;
         var _loc1_:URLRequest = new URLRequest(this.var_1171);
      ...
      {
         Core.error("Could not load avatar asset library " + this.var_763 + " from URL " + this.var_1171,false,Core.const_1376);
      }
      ...
      {
         var _loc1_:String = this.var_763;
