package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1958:int = 16777215;
      
      public static const const_1991:int = 13421772;
      ...
      public static const const_1774:int = 13421772;
      ...
      private var var_816:Rectangle = null;
      
      private var var_548:RoomPlaneBitmapMaskParser = null;
      
      private var var_1494:String = null;
      
      private var _floorType:String = null;
      
      private var var_1495:String = null;
      
      private var var_1024:Number = NaN;
      
      private var var_1520:Number = NaN;
      
      private var var_2610:Number = NaN;
      
      private var var_1907:String = null;
      
      private var var_1241:uint = 16777215;
      
      private var var_2607:int = 255;
      
      private var var_2608:int = 255;
      ...
      private const const_2365:int = 250;
      ...
      private var var_1909:Number = 0.0;
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_816 = super.boundingRectangle;
         }
         return new Rectangle(this.var_816.x,this.var_816.y,this.var_816.width,this.var_816.height);
      }
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            if(_loc4_ != null && _loc3_ != null && _loc3_.leftSide != null && _loc3_.rightSide != null)
            {
               ...
               else if(_loc3_.type == RoomPlane.const_117)
               {
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         if(!isNaN(this.var_1024))
         {
            this._planeParser.floorThicknessMultiplier = this.var_1024;
         }
         if(!isNaN(this.var_1520))
         {
            this._planeParser.wallThicknessMultiplier = this.var_1520;
         }
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_840);
         ...
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_442)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_1737)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_76,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_442)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this._lastUpdateTime + this.const_2365 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_393.length)
            {
               _loc11_ = this.var_660[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_393[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1908)
                  {
                     ...
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2608 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2607 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1910)
         {
            this.var_1910 = param1.updateId;
            this.var_816 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != this.var_1552 || _loc3_.y != this.var_2611 || _loc3_.z != this.var_2609 || param1.scale != this.var_1909))
            {
               this.var_1552 = _loc3_.x;
               this.var_2611 = _loc3_.y;
               this.var_2609 = _loc3_.z;
               this.var_1909 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_146 != param1.getUpdateID())
         {
            ...
            if(_loc3_ != this.var_1907)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_1907 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_1020));
            if(_loc4_ != this.var_1241)
            {
               this.var_1241 = _loc4_;
               this.var_2606 = this.var_1241 & 255;
               this.var_2608 = this.var_1241 >> 8 & 255;
               this.var_2607 = this.var_1241 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1203));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_146 != param1.getUpdateID())
         {
            ...
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_775));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_924));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_146 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1309);
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1331);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this.var_1024 || _loc3_ != this.var_1520))
            {
               this.var_1024 = _loc2_;
               this.var_1520 = _loc3_;
               this.resetRoomPlanes();
               return true;
            }
         }
      ...
      private function updateFloorHoles(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_146 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1222);
            if(!isNaN(_loc2_) && _loc2_ != this.var_2610)
            {
               this.var_2610 = _loc2_;
               this.resetRoomPlanes();
               return true;
            }
         }
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < this.var_155.length)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.type == RoomPlane.const_117 && param1 != null)
               {
                  _loc5_.id = param1;
               }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_393;
         if(this.var_393.length == 0)
         {
            _loc6_ = this.var_155;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_393.length > 0;
         var _loc9_:int = 0;
               ...
               if(_loc12_ != null)
               {
                  if(_loc12_.update(param1,_loc5_))
                  {
                     if(_loc12_.visible)
                     {
                        ...
                        if(_loc12_.type != RoomPlane.const_117)
                        {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_393.push(_loc12_);
                        this.var_660.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1242;
      }
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_76 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_244)
                              {
