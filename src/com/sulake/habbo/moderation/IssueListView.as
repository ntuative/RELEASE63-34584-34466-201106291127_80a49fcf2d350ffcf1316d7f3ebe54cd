package com.sulake.habbo.moderation
{
   ...
   public class IssueListView
   {
      ...
      private var var_1789:IWindowContainer;
      
      private var var_3102:BitmapData;
      
      private var var_3101:BitmapData;
      ...
      public function IssueListView(param1:IssueManager, param2:IssueBrowser, param3:IItemListWindow, param4:String)
      {
         ...
         this.var_1789 = this.var_718.createWindow(param4) as IWindowContainer;
      }
      ...
      public function update(param1:Array) : void
      {
         ...
         if(_loc4_ < _loc5_)
         {
            ...
            {
               _loc3_ = this.var_1789.clone() as IWindowContainer;
         ...
         for each(_loc7_ in param1)
         {
            ...
            if(_loc7_ == null || this.var_1789 == null)
            {
               return;
            }
            ...
            if(_loc11_ != null)
            {
               ...
               _loc13_ = this.var_718.assets.getAssetByName(_loc12_) as BitmapDataAsset;
