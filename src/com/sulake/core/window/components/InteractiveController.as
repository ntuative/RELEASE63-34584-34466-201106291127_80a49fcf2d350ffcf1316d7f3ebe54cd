package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_555)
         {
      ...
      public static function readInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : void
      {
         ...
         for each(_loc3_ in param2)
         {
            switch(_loc3_.key)
            {
               case PropertyDefaults.const_1017:
                  if(_loc3_.value != param1.toolTipCaption)
                  {
                     param1.toolTipCaption = _loc3_.value as String;
                  }
                  break;
               case PropertyDefaults.const_1006:
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_555)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_1017,param1.toolTipCaption,PropertyStruct.const_50,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1834);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1325)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_1006,param1.toolTipDelay,PropertyStruct.const_310,true));
         }
         else
         {
      ...
      {
         this.var_1410 = param1 == null ? "null" : param1;
      }
