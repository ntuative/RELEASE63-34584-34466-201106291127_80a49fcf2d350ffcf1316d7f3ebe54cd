   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_40)
         {
            ...
            var_40["null"] = new AvatarEditorGridView(var_78,FigureData.const_235,_windowManager,_assetLibrary);
            var_40["null"] = new AvatarEditorGridView(var_78,FigureData.const_293,_windowManager,_assetLibrary);
         ...
         if(var_78 && var_168 == "")
         {
            var_78.switchCategory(FigureData.const_235);
         }
      }
