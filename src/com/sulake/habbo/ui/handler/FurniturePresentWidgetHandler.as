package com.sulake.habbo.ui.handler
{
   ...
   public class FurniturePresentWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      private static const const_1457:String = "poster";
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_1012,RoomWidgetPresentOpenMessage.const_194];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_1012:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = _loc5_.getNumber(RoomObjectVariableEnum.const_268);
      ...
      {
         return [RoomSessionPresentEvent.const_332];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         if(this._container != null && this._container.events != null && param1 != null)
         {
            switch(param1.type)
            {
               case RoomSessionPresentEvent.const_332:
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     else if(_loc2_.itemType == ProductTypeEnum.const_62)
                     {
                     ...
                     switch(_loc2_.itemType)
                     {
                        case ProductTypeEnum.const_62:
                           if(_loc3_ != null && _loc3_.name == const_117)
                           {
                           ...
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_610,0,this._container.localization.getKey("inventory.furni.item.landscape.name"),false,null);
                           }
                           else if(_loc3_ != null && _loc3_.name == const_236)
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_655,0,this._container.localization.getKey("inventory.furni.item.wallpaper.name"),false,null);
                           }
                           else
                           {
                              if(_loc3_ != null && _loc3_.name == const_1457)
                              {
                                 break;
                              }
                        ...
                        case ProductTypeEnum.const_340:
                           _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_654,0,this._container.localization.getKey("widget.furni.present.hc"),false,null);
                           break;
                        default:
