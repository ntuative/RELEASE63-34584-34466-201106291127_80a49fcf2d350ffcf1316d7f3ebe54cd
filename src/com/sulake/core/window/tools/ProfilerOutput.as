package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1583:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1584:Class = ProfilerOutput_profiler_task_xml;
       
      
      private var _disposed:Boolean = false;
      
      private var var_179:IProfiler;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_3081 = new Array();
         this.var_179 = this.profiler;
         this._windowManager = param2;
         this._windowRenderer = param3;
         var _loc4_:ByteArray = new var_1583() as ByteArray;
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_179)
         {
            this.var_179.removeStopEventListener(this.refresh);
            this.var_179 = null;
         }
         if(!this.var_179 && param1)
         {
            this.var_179 = param1;
            this.var_179.addStopEventListener(this.refresh);
         }
      }
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_642)
            {
               this.var_2014 = false;
               ILabelWindow(this._window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      {
         var _loc2_:Array = this.var_179.getProfilerAgentsInArray();
         ...
         if(this.var_2014)
         {
            this._window.findChildByName("footer").caption = "Assets - Libraries: " + this.var_179.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_179.numBitmapAssetInstances + " / " + this.var_179.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this._windowRenderer.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_179.numTrackedBitmapDataInstances + " / " + this.var_179.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1584() as ByteArray;
