package com.sulake.habbo.ui.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_1794:String = "POLL_OFFER_STATE_OK";
      
      public static const const_1011:String = "POLL_OFFER_STATE_CANCEL";
      
      public static const const_111:String = "POLL_OFFER_STATE_UNKNOWN";
      ...
      {
         if(this._state != const_111)
         {
            return;
         }
         this._state = const_1794;
         this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_815,this._id));
      }
      ...
      private function onCancel(param1:WindowEvent) : void
      {
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_504,this._id));
