package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger, IAvatarImageListener
   {
      ...
      private var var_484:Conversations;
      
      private var var_204:MessengerView;
      ...
      {
         if(this._windowManager && this._communication && this.var_161 && this._localization && this._friendList && this.var_602 && this._soundManager)
         {
            unlock();
      ...
      {
         this.var_484 = new Conversations(new ConversationsDeps(this));
         this.var_204 = new MessengerView(this);
      ...
      {
         var _loc2_:Conversation = this.var_484.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         {
            this.var_484.setSelected(_loc2_);
            this.var_204.openMessenger();
            this.var_204.refresh();
         }
      }
      
      public function getActiveConversation() : IConversation
      {
         return !!this.var_484 ? this.var_484.findSelectedConversation() : null;
      }
      
      public function setFollowingAllowed(param1:int, param2:Boolean) : void
      {
         this.var_484.setFollowingAllowedAndUpdateView(param1,param2);
      }
      
      public function setOnlineStatus(param1:int, param2:Boolean) : void
      {
         this.var_484.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      {
         return this.var_204 && this.var_204.isMessengerOpen();
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_204)
         {
            if(this.var_204.isMessengerOpen())
            {
               this.var_204.close();
            }
            else
      ...
      private function getPageParam(param1:String) : String
      {
         ...
         if(param1 == "url.prefix")
         {
            ...
            _loc2_ = this.var_161.getKey("url.prefix",_loc2_);
      ...
      private function onRoomInvite(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1229,_loc2_.senderId,this.getText("messenger.invitation") + " " + _loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      
      private function addMsg(param1:Message) : void
      {
         this.var_484.addMessageAndUpdateView(param1);
         if(!this.var_204.isMessengerOpen())
         {
            if(this._soundManager != null)
            {
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1291,_loc2_.userId,this.getInstantMessageErrorText(_loc2_.errorCode),Util.getFormattedNow());
         this.var_484.addMessageAndUpdateView(_loc3_);
      }
