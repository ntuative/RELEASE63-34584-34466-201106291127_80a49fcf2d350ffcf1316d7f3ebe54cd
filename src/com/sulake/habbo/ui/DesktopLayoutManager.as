package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private static const const_708:String = "room_view";
      
      private static const const_1616:String = "room_widget";
      ...
      public function setLayout(param1:XML, param2:IHabboWindowManager, param3:IHabboConfigurationManager) : void
      {
         ...
         while(_loc6_ < this.var_101.numChildren)
         {
            ...
            {
               _loc5_.addEventListener(WindowEvent.const_169,this.trimContainer);
            }
            _loc6_++;
         }
      }
      ...
      private function getWidgetContainer(param1:String, param2:IWindow) : IWindowContainer
      {
         ...
         if(param1 == RoomWidgetEnum.const_343)
         {
         ...
         {
            if(String(_loc3_[_loc5_]).indexOf(const_1616) == 0)
            {
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = this.var_101.getChildByTag(const_708) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = this.var_101.findChildByTag(const_708) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
