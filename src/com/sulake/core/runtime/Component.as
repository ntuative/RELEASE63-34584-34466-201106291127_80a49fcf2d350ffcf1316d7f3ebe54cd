package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      protected static const const_466:String = "_INTERNAL_EVENT_UNLOCKED";
      
      public static const COMPONENT_FLAG_NULL:uint = 0;
      
      public static const const_2169:uint = 1;
      ...
      private var var_594:InterfaceStructList;
      ...
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_594 = new InterfaceStructList();
      ...
      {
         var _loc3_:InterfaceStruct = this.var_594.getStructByInterface(param1);
         if(_loc3_ == null)
         {
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = this.var_594.getStructByInterface(param1);
         if(_loc2_ == null)
         {
         ...
         if(this.var_1538 & const_1348)
         {
            if(_loc3_ == 0)
            {
               if(this.var_594.getTotalReferenceCount() == 0)
               {
      ...
      protected final function unlock() : void
      {
         ...
         {
            this.var_1124 = false;
            this._events.dispatchEvent(new LockEvent(const_466,this));
         }
      }
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc7_:uint = this.var_594.length;
         var _loc8_:int = 0;
         while(_loc8_ < _loc7_)
         {
            _loc6_ = this.var_594.getStructByIndex(_loc8_);
